...
const int SPL_COST_SCROLL_THUNDERSTORM = 130;
...
const int NPC_TALENT_2X2WEAPONS = 6;
const int NPC_TALENT_MAGE = 7;
const int NPC_TALENT_SNEAK = 8;
const int NPC_TALENT_SHIELDD = 9;
const int NPC_TALENT_FORGE = 10;
...
const int NPC_TALENT_BOW_MAKER = 17;
const int NPC_TALENT_ARROW_BOLT = 18;
const int NPC_TALENT_C = 19;
const int NPC_TALENT_FOREIGNLANGUAGE = 20;
const int NPC_TALENT_WISPDETECTOR = 21;
