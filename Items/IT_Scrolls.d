...
instance ItSc_SumSkel(C_Item)
{
	...
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_SCROLL_SUMMONSKELETON;
	wear = WEAR_EFFECT;
	effect = "";
	description = NAME_SPL_SummonSkeleton;
	text[0] = NAME_MageScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_COST_SCROLL_SUMMONSKELETON;
	text[5] = NAME_Value;
	count[5] = value;
};
...
instance ItSc_SumGol(C_Item)
{
	...
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_SCROLL_SUMMONGOLEM;
	wear = WEAR_EFFECT;
	effect = "";
	description = NAME_SPL_SummonGolem;
	text[0] = NAME_MageScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_COST_SCROLL_SUMMONGOLEM;
	text[5] = NAME_Value;
	count[5] = value;
};
...
instance ItSc_SumDemon(C_Item)
{
	...
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_SCROLL_SUMMONDEMON;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_RED";
	description = NAME_SPL_SummonDemon;
	text[0] = NAME_MageScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_COST_SCROLL_SUMMONDEMON;
	text[5] = NAME_Value;
	count[5] = value;
};
...
instance ItSc_Firerain(C_Item)
{
	...
	spell = SPL_Firerain;
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_SCROLL_FIRERAIN;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_YELLOW";
	description = NAME_SPL_Firerain;
	text[0] = NAME_MageScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_COST_SCROLL_FIRERAIN;
...
instance ItSc_ArmyOfDarkness(C_Item)
{
	...
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_SCROLL_ARMYOFDARKNESS;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_RED";
	description = NAME_SPL_ArmyOfDarkness;
	text[0] = NAME_MageScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_COST_SCROLL_ARMYOFDARKNESS;
	text[5] = NAME_Value;
	count[5] = value;
};
