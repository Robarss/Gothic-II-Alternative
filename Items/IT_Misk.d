...
{
	name = "Roztavený Ignot";
	mainflag = ITEM_KAT_NONE;
	flags = ITEM_MULTI;
	value = VALUE_PLIERSARMR;
...
instance ITMI_SCRAPIRON(C_Item)
{
	name = "Staré rezavé železo";
	mainflag = ITEM_KAT_NONE;
	flags = ITEM_MULTI | ITEM_MISSION;
	value = 2;
	visual = "ItMi_scrap1.3ds";
	material = MAT_LEATHER;
	scemeName = "Staré železo";
	description = name;
	text[4] = "";
	text[5] = NAME_Value;
	count[5] = value;
...
instance ITMI_WOODCOOK(C_Item)
{
	name = "Lopata na pečení";
	mainflag = ITEM_KAT_NONE;
	flags = 0;
	value = 1;
	visual = "BROTSCHIEBER.3DS";
	material = MAT_METAL;
	description = name;
	text[5] = NAME_Value;
	count[5] = value;
...
instance ItMi_FireRuneBlank(C_Item)
{
	name = "Runa zkoušky ohně";
	mainflag = ITEM_KAT_NONE;
	flags = ITEM_MULTI;
	value = Value_RuneBlank;
	visual = "ItMi_RuneBlank.3DS";
	material = MAT_STONE;
	description = name;
	text[5] = "Tuhle runu jsem získal na znamení že jsem splnil zkoušku ohně.";
	count[5] = value;
};
...
instance ItMi_DoppelTabak(C_Item)
{
	...
	material = MAT_LEATHER;
	description = name;
	text[2] = "Chutná jako pořádné jablko.";
	text[5] = NAME_Value;
	count[5] = value;
};
