...
instance ItPo_Perm_Ancient(C_Item)
{
	name = NAME_Trank;
	...
	material = MAT_GLAS;
	on_state[0] = UseItPo_Perm_Ancient;
	scemeName = "POTIONFAST";
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_YELLOW";
	description = "Prastarý lektvar (doufám že mě to nezabije)";
};


func void UseItPo_Perm_Ancient()
{
...
{
	Mdl_ApplyOverlayMdsTimed(self,"HUMSPRINT_REMASTER.MDS",Time_Speed);//HUMANS_SPRINT.MDS
};
