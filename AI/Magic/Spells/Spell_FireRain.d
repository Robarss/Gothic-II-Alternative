...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_COST_SCROLL_FIRERAIN))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Firerain()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_COST_SCROLL_FIRERAIN;
	}
	else
	{
