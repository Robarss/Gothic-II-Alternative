...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_COST_SCROLL_SUMMONSKELETON))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_SummonSkeleton()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_COST_SCROLL_SUMMONSKELETON;
	}
	else
	{
