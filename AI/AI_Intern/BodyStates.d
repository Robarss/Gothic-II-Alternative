...
const string MOB_SIT = "LAVICE,ŽIDLE,ZEMĚ,TRŮN";
const string MOB_LIE = "POSTEL,LOŽE,LŮŽKO";
const string MOB_CLIMB = "LÉZT,STOUPAT,ŠPLHAT";
const string MOB_NOTINTERRUPTABLE = "DVEŘE,PÁKA,TLAČÍTKO,SPÍNAČ,KOLO,TRUHLICE,TRUHLA,BYLINA,SOCHA,PÁNEV,KOUŘ,INNOS";
