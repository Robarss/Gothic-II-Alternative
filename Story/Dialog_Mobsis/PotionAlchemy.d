...
{
	if((Npc_HasItems(self,ItPl_SwampHerb) >= 1) && (Npc_HasItems(self,ItPl_Beet) >= 2) && (Npc_HasItems(self,ItAt_SharkTeeth) >= 1) && (Npc_HasItems(self,ItFo_Addon_Rum) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
...
{
	if((Npc_HasItems(self,ItPl_SwampHerb) >= 1) && (Npc_HasItems(self,ItPl_Beet) >= 2) && (Npc_HasItems(self,ItAt_SharkTeeth) >= 1) && (Npc_HasItems(self,ItFo_Addon_Rum) >= 2) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(self,ItMi_Flask,1);
		Npc_RemoveInvItems(self,ItPl_SwampHerb,1);
		Npc_RemoveInvItems(self,ItPl_Beet,2);
...
{
	if((Npc_HasItems(self,ItPl_Speed_Herb_01) >= 1) && (Npc_HasItems(self,ItFo_Fish) >= 1) && (Npc_HasItems(self,ItFo_Addon_Rum) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(self,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Mana_Herb_01) >= 2) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
...
{
	if((Npc_HasItems(hero,ItPl_Mana_Herb_02) >= 2) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Mana_Herb_03) >= 2) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPo_Mana_01) >= 3) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Health_Herb_01) >= 2) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Health_Herb_02) >= 2) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Health_Herb_03) >= 2) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPo_Health_01) >= 3) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItAt_Sting) >= 2) && (Npc_HasItems(hero,ItPo_Mana_02) >= 1) && (Npc_HasItems(hero,ItPo_Health_01) >= 1) && (Npc_HasItems(hero,ItFo_Addon_Pfeffer_01) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Health_Herb_03) >= 1) && (Npc_HasItems(hero,ItPl_Perm_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Mana_Herb_03) >= 1) && (Npc_HasItems(hero,ItPl_Perm_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Dex_Herb_01) >= 1) && (Npc_HasItems(hero,ItPl_Perm_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
{
	if((Npc_HasItems(hero,ItPl_Strength_Herb_01) >= 1) && (Npc_HasItems(hero,ItPl_Perm_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
instance PC_ItPo_Ancient(C_Info)
{
	nr = 38;
	npc = PC_Hero;
	condition = PC_ItPo_Ancient_Condition;
	information = PC_ItPo_Ancient_Info;
	permanent = TRUE;
	description = "Prastarý lektvar (15x hlava kudlanky, 3x Srdce bažiného golema)";
};


func int PC_ItPo_Ancient_Condition()
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_PotionAlchemy) && (Knows_AncientLIXIER == TRUE) && (SpecialStart == TRUE))
	{
		return TRUE;
	};
};

func void PC_ItPo_Ancient_Info()
{
	if((Npc_HasItems(hero,ItAt_Addon_BCKopf) >= 15) && (Npc_HasItems(hero,ItAt_SwampGolemHeart) >= 3) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
		Npc_RemoveInvItems(hero,ItAt_Addon_BCKopf,15);
		Npc_RemoveInvItems(hero,ItAt_SwampGolemHeart,3);
		CreateInvItems(hero,ItPo_Perm_Ancient,1);
		Print(PRINT_AlchemySuccess);
	}
	else
	{
...
{
	if((Npc_HasItems(hero,ItPl_Speed_Herb_01) >= 1) && (Npc_HasItems(hero,ItPl_Temp_Herb) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
instance PC_ItMi_Addon_Joint_01(C_Info)
{
	...
	permanent = TRUE;
	description = "Udělat zelného novice (2 stébla trávy z bažin, 1 luční pohanka)";
};
...
{
	if((Npc_HasItems(hero,ItAt_DragonEgg_MIS) >= 10) && (Npc_HasItems(hero,ItMi_DarkPearl) >= 1) && (Npc_HasItems(hero,ItMi_Sulfur) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
...
instance PC_COOKWIN(C_Info)
{
	nr = 3;
	npc = PC_Hero;
	condition = pc_cookwin_condition;
	information = pc_cookwin_info;
	permanent = TRUE;
	description = "Víno poznání(5x Hrozen a 1 Ohnivý kořen)";
};


func int pc_cookwin_condition()
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_PotionAlchemy) && (Knows_VINELIXIER == TRUE) && (SpecialStart == TRUE))
	{
		return TRUE;
	};
};

func void pc_cookwin_info()
{
	if((Npc_HasItems(hero,itfo_kwin) >= 5) && (Npc_HasItems(hero,ItPl_Mana_Herb_03) >= 1) && (Npc_HasItems(hero,ItMi_Flask) >= 1))
	{
		Npc_RemoveInvItems(hero,ItMi_Flask,1);
		Npc_RemoveInvItems(hero,itfo_kwin,5);
		Npc_RemoveInvItems(hero,ItPl_Mana_Herb_03,1);
		CreateInvItems(hero,itfo_cookwin,1);
		Print(PRINT_AlchemySuccess);
	}
	else
	{
