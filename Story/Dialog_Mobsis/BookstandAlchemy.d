...
func void Use_BookstandALCHEMY3_S1()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(her))
	{
		...
		Doc_PrintLine(nDocID,1,"");
		Doc_PrintLines(nDocID,1,"Namíchat lektvar rychlosti je mnohem snazší, částečně i proto, že k jeho přípravě nepotřebuješ královský šťovík. Pro přípravu tohoto receptu ti postačí základní znalosti alchymie. ");
		Doc_PrintLine(nDocID,1,"");
		Doc_Show(nDocID);
