...
instance DIA_Addon_Lothar_Ornament(C_Info)
{
	...
	description = "Víš něco o kamenech, které jsou v kamenném kruhu za Lobartovou farmou?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Lothar_Ornament_15_00");	//Víš něco o kamenech, které jsou v kamenném kruhu za Lobartovou farmou?
	AI_Output(self,other,"DIA_Addon_Lothar_Ornament_01_01");	//Jistě, že ano. Zničili jsme je. Znepokojovaly blízké farmáře.
...
func void DIA_Addon_Lothar_Ornament_suche()
{
	...
	AI_Output(other,self,"DIA_Addon_Lothar_Ornament_suche_15_01");	//Mělo by to být někde u kamenného kruhu blízko Lobartovy farmy.
	AI_Output(self,other,"DIA_Addon_Lothar_Ornament_suche_01_02");	//Ano, něco tam bylo. Kámen blízko něj. Vzal jsem ho na magické runy.
	AI_Output(self,other,"DIA_Addon_Lothar_Ornament_suche_01_03");	//Dal jsem ho lordu Hagenovi. A nevím, co s ním udělal on.
};
...
func void DIA_Lothar_Regeln_Info()
{
	...
	AI_Output(self,other,"DIA_Lothar_Regeln_01_01");	//Za prvé: Ctihodný paladin lord Hagen bydlí se svými jednotkami v horní části města.
	...
	AI_Output(self,other,"DIA_Lothar_Add_01_05");	//A za třetí: Každý, kdo je obviněný z nějakého zločinu, se musí ospravedlnit před velitelem domobrany.
...
func void DIA_Addon_Lothar_MissingPeople_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lothar_MissingPeople_01_02");	//Je mrzuté, že domobrana nebyla schopna tuto záhadu vyřešit.
	...
	AI_Output(self,other,"DIA_Addon_Lothar_MissingPeople_01_04");	//Tak ve městě zbytečně neupoutávej pozornost sám na sebe, dobrá?
...
instance DIA_Lothar_ToOV(C_Info)
{
	...
	permanent = FALSE;
	description = "Jak se dostanu do horní části města?";
};
