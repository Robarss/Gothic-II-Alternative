...
func void DIA_DiegoOw_Mine_Info()
{
	...
	AI_Output(self,other,"DIA_DiegoOw_Mine_11_04");	//A to bylo moje jediné štěstí. Horníci totiž narazili na pár důlních červů. Žádný z nich nepřežil.
};
...
func void DIA_Addon_ThiefOW_TooFar_Info()
{
	...
	else if(C_DiegoTooFar(1000) == LOC_SILVESTROMINE)
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_Diego_TooFar_11_19");	//To je důl, kde jsem byl nucen pracovat, když jsem se vrátil s kolonou vězňů.
			AI_Output(self,other,"DIA_Addon_Diego_TooFar_11_20");	//Jsem si zcela jist, že tam nikdo nepřežil.
			B_Addon_Diego_WillWaitOutside();
	...
	else if(C_DiegoTooFar(1000) == LOC_GRIMESMINE)
	{
		if(Diego_GrimesVariation == 0)
		{
			...
			AI_Output(self,other,"DIA_Addon_Diego_TooFar_11_22");	//Nikdy - nechci na tom nic měnit.
...
func void DIA_Addon_ThiefOW_Nostalgie_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Diego_Nostalgie_11_02");	//Vrať se zpět, kde jsme se potkali poprvé.
