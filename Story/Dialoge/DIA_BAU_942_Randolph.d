...
func void DIA_Randolph_SchwereLuft_Info()
{
	...
	B_LogEntry(TOPIC_AkilsSLDStillthere,"Akilův statek ohrožují žoldnéři.");
	B_NpcClearObsessionByDMT(self);
};
...
instance DIA_Randolph_Baltram(C_Info)
{
	...
	permanent = FALSE;
	description = "Poslal mě Baltram. Mám tu pro něj vyzvednou nějaký balík.";
};
...
{
	AI_Output(other,self,"DIA_Randolph_Baltram_15_00");	//Poslal mě Baltram. Mám tu pro něj vyzvednou nějaký balík.
...
func void DIA_Randolph_WETTKAMPFZUENDE_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Randolph_WETTKAMPFZUENDE_06_01");	//Přímo matka všech kocovin. A já jí nemůžu zbavit. Už nebudu chlastat, přísahám.
