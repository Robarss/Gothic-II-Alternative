...
func void DIA_Addon_10008_Bandit_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_10008_Bandit_Hi_01_02");	//Jestli chceš sám sobě udělat laskavost, vyhýbej se Skinnerovi.
	AI_Output(self,other,"DIA_Addon_10008_Bandit_Hi_01_03");	//Ten hoch je nepředvídatelný. Zabil posledního chlápka, co se ho snažil vzbudit.
...
func void DIA_Addon_10008_Bandit_soup_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_10008_Bandit_soup_01_02");	//Já vařím jen masovou polévku, zde, zkus to - budeš silnější.
	B_GiveInvItems(self,other,ItFo_Addon_Meatsoup,1);
	AI_Output(self,other,"DIA_Addon_10008_Bandit_soup_01_03");	//Je důležité cvičit tvoji sílu - venku tě čeká mnoho nebezpečí.
	AI_Output(self,other,"DIA_Addon_10008_Bandit_soup_01_04");	//Jestli chceš, pomůžu ti zvednout tvoji sílu.
	Log_CreateTopic(Topic_Addon_BDT_Teacher,LOG_NOTE);
	B_LogEntry(Topic_Addon_BDT_Teacher,"Bandita u kuchařského hrnce mi může pomoci cvičit mou sílu.");
};
...
{
	AI_Output(other,self,"DIA_Addon_10008_Bandit_Teach_15_00");	//Chci se stát silnějším.
