...
func void DIA_Addon_Gaan_Ranger_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Gaan_Ranger_03_03");	//Skvěle. Rád vidím nováčky v našem spolku.
...
instance DIA_Addon_Gaan_MissingPeople(C_Info)
{
	...
	description = "Slyšel jsi něco o hledyných lidech?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Gaan_MissingPeople_15_00");	//Slyšel jsi něco o hledyných lidech?
	AI_Output(self,other,"DIA_Addon_Gaan_MissingPeople_03_01");	//Jistě. Každý dělá všechno pro to, aby je nemusel navštívit.
	AI_Output(self,other,"DIA_Addon_Gaan_MissingPeople_03_02");	//Ale já jsem v klidu, neviděl jsem tu nic podezřelého.
};
...
func void DIA_Gaan_AskTeacher_Info()
{
	...
	AI_Output(self,other,"DIA_Gaan_AskTeacher_03_02");	//Kožešiny a ostatní trofeje ti na trhu vydělají spoustu peněz.
	Log_CreateTopic(TOPIC_Teacher,LOG_NOTE);
	B_LogEntry(TOPIC_Teacher,"Gaan naučí, jak získat trofeje ze zvířat.");
};
