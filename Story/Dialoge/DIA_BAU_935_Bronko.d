...
func void DIA_Bronko_HALLO_Info()
{
	...
	Info_AddChoice(DIA_Bronko_HALLO,"Tvůj pozemek? Ty jsi tady farmářem?",DIA_Bronko_HALLO_deinland);
};

func void DIA_Bronko_HALLO_deinland()
{
	AI_Output(other,self,"DIA_Bronko_HALLO_deinland_15_00");	//Tvůj pozemek? Ty jsi tady farmářem?
...
instance DIA_Bronko_KEINBAUER(C_Info)
{
	...
	permanent = TRUE;
	description = "Ty, farmář? Nenech se vysmát. Ve skutečnosti nejsi nikdo.";
};
...
func void DIA_Bronko_FLEISSIG_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Bronko_FLEISSIG_06_02");	//Ty jsi žoldák, že jo? Měl jsem to vědět. LOG
	}
