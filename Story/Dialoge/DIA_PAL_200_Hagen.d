...
instance DIA_Addon_Lord_Hagen_Ornament(C_Info)
{
	...
	description = "Hledám kovovou ozdobu. Měla by být u kamenného kruhu blízko Lobartovy farmy.";
};
...
{
	AI_Output(other,self,"DIA_Addon_Lord_Hagen_GiveOrnament_15_00");	//Hledám kovovou ozdobu. Měla by být u kamenného kruhu blízko Lobartovy farmy.
	AI_Output(self,other,"DIA_Addon_Lord_Hagen_GiveOrnament_04_01");	//Pokud myslíš tenhle kus tady ... mysleli jsme si, že by to mohla být magicka runa, ale ta věc je úplně bezcenná.
...
instance DIA_Lord_Hagen_Khorinis(C_Info)
{
	...
	permanent = FALSE;
	description = "Proč jste přišli do Khorinisu?";
};
...
{
	AI_Output(other,self,"DIA_Lord_Hagen_Khorinis_15_00");	//Proč jste přišli do Khorinisu?
...
func void DIA_Lord_Hagen_Knight_Yes()
{
	...
	CreateInvItems(self,itsh_7shield,1);
	B_GiveInvItems(self,other,itsh_7shield,1);
...
instance DIA_Lord_Hagen_BACKINTOWN(C_Info)
{
	...
	permanent = FALSE;
	description = "Přináším novinky od Garonda. Dal mi pro tebe tenhle dopis.";
};
...
{
	AI_Output(other,self,"DIA_Lord_Hagen_RescueBennet_Innoscent_15_00");	//Věřím, že je Bennet nevinný.
...
func void DIA_Lord_Hagen_RINGEBRINGEN_Info()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_RINGEBRINGEN_04_09");	//Vezmi si. Tady máš nějaké zlato na své vybavení.
