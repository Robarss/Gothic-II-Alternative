...
func void DIA_Balthasar_HALLO_Info()
{
	...
	AI_Output(self,other,"DIA_Balthasar_HALLO_05_03");	//Ó, to vidím. Nejsem už tak mladý jako dřív, však víš. A už léta čekám na někoho, kdo by to po mně převzal.
...
func void DIA_Balthasar_WASMACHSTDU_Info()
{
	...
	AI_Output(self,other,"DIA_Balthasar_WASMACHSTDU_05_01");	//Ó, hlídám ovce a dělám to tak dlouho, co si jen pamatuju.
...
instance DIA_Addon_Balthasar_Rangerbandits(C_Info)
{
	...
	description = "Neviděls kolem projíždět nějaké bandity?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Balthasar_Rangerbandits_15_00");	//Neviděls kolem projíždět nějaké bandity?
	AI_Output(self,other,"DIA_Addon_Balthasar_Rangerbandits_05_01");	//Najisto. Jeli kolem Sekobovy farmy někam na sever do lesů.
	if(MIS_Vatras_FindTheBanditTrader == LOG_Running)
	{
		AI_Output(self,other,"DIA_Addon_Balthasar_Rangerbandits_05_02");	//Vezli mnoho a mnoho zbraní. Vypadali jako by chtěli vyhrát skřetí válku sami!
	};
	if(SC_KnowsLuciaCaughtByBandits == TRUE)
	{
		AI_Output(self,other,"DIA_Addon_Balthasar_Rangerbandits_05_03");	//A jestli mě oči nezklamaly, ti bastardi s sebou vlekli ještě nějakou mladou ženu.
