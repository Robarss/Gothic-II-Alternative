...
instance DIA_Addon_Lares_Vatras(C_Info)
{
	...
	description = "Vatras mě poslal. Říkal, že bys mi mohl pomoct.";
};
...
instance DIA_Addon_Lares_WhatAreYouGuys(C_Info)
{
	...
	description = "Co máš co dělat s Vatrasem?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Lares_WhatAreYouGuys_15_00");	//Co máš co dělat s Vatrasem?
...
func void DIA_Addon_Lares_WannaBeRanger_HowIsIt()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_WannaBeRanger_HowIsIt_09_01");	//My jsme velice odlišní od ostatních obvyklých gild, které můžeš najít v Khorinisu.
...
{
	AI_Output(self,other,"DIA_Addon_Lares_RingBack_09_07");	//Brzy bude tajné setkání v Orlanově hospodě.
...
func void DIA_Addon_Lares_RingBack_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Lares_RingBack_09_01");	//Skvělě! Můžu nyní dostat svůj akvamarínový prsten zpět?
		if(B_GiveInvItems(other,self,ItRi_Ranger_Lares_Addon,1))
		{
			AI_Output(other,self,"DIA_Addon_Lares_RingBack_15_02");	//Jistě.
	...
	AI_Output(self,other,"DIA_Addon_Lares_RingBack_09_06");	//Nyní bys určitě rád dostal nové vybavení do svých rukou, že? Dobrá, poslouchej.
	B_Lares_Geheimtreffen();
	B_LogEntry(TOPIC_Addon_RingOfWater,"Lares mě pozval na tejné setkání 'Kruhu Vody' do Orlanovy hospody.");
...
{
	AI_Output(self,other,"DIA_Addon_Lares_GetRangerArmor_09_00");	//Tak, můj mladý příteli. Dnes jsme zde přišli oslavit tvé přijetí do 'Kruhu Vody'.
	...
	AI_Output(self,other,"DIA_Addon_Lares_GetRangerArmor_09_04");	//Nyní ti také dám tvé brnění.
	...
	AI_Output(self,other,"DIA_Addon_Lares_GetRangerArmor_09_07");	//Nikdo nemluví o 'Kruhu Vody'. To je první a nejdůležitější pravidlo. Nezapoměň.
...
func void DIA_Addon_Lares_GetRangerArmor_end()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_GetRangerArmor_end_09_05");	//Adanosi, udržuj pořádek v tomto světě.
...
func void DIA_Addon_Lares_GetRangerArmor_weiter()
{
	...
	B_LogEntry(TOPIC_Addon_RingOfWater,"Dostal jsem své brnění na tajném setkání 'Kruhu Vody' v Orlanově hospodě. Měl bych nyní jít za Vatrasem pro svůj první úkol jako člen 'Kruhu'.");
};
...
{
	AI_Output(other,self,"DIA_Addon_Lares_Teleportstation_15_00");	//Už jsi někdy použil teleportační kámen?
	...
	AI_Output(self,other,"DIA_Addon_Lares_Teleportstation_09_03");	//(směje se) Měl jsem si to myslet. Je vůbec něco, co bys neudělal?
	...
	B_LogEntry(TOPIC_Addon_TeleportsNW,"Lares mi řekl, že blízko Orlanovy hospody je skrytý teleportační kámen.");
...
{
	AI_Output(other,self,"DIA_Addon_Lares_YourMission_15_00");	//Co přesně děláš tady v přístavu?
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Addon_Lares_YourMission_09_04");	//Někteří ze zmizelých lidí jsou rybáři. Dokonce jejich lodě zmizely.
		...
		AI_Output(self,other,"DIA_Addon_Lares_YourMission_09_12");	//Řekni mu, že hledám náhradu.
		B_LogEntry(TOPIC_Addon_RingOfWater,"Lares mi dal svůj akvamarínový prsten se značkou 'Kruhu'. Nasazený prsten všichni členové 'Kruhu' poznají a přijmou mě.");
		Log_CreateTopic(TOPIC_Addon_BringRangerToLares,LOG_MISSION);
		Log_SetTopicStatus(TOPIC_Addon_BringRangerToLares,LOG_Running);
		B_LogEntry(TOPIC_Addon_BringRangerToLares,"Lares nemůže opustit přístav. Měl bych prozkoumat tržiště s nasazeným akvamarínovým prstenem, abych našel za Larese náhradu.");
...
func void DIA_Addon_Lares_PeopleMissing_TellMe()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_PeopleMissing_TellMe_09_03");	//Ale brzy začali mizet další. A nezdálo se, že by za tím bylo něco jiného.
...
func void DIA_Addon_Lares_PeopleMissing_Success()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_PeopleMissing_Success_09_01");	//(překvapeně) Je to tak?
	AI_Output(other,self,"DIA_Addon_Lares_PeopleMissing_Success_15_02");	//Bývalý rudobaron RAVEN je zajal.
	AI_Output(self,other,"DIA_Addon_Lares_PeopleMissing_Success_09_03");	//Jsi si jist? Musíme je pak nějak zachránit.
	AI_Output(other,self,"DIA_Addon_Lares_PeopleMissing_Success_15_04");	//Pracuji na tom.
	AI_Output(self,other,"DIA_Addon_Lares_PeopleMissing_Success_09_05");	//V pořádku. Víš, kde mě hledat, kdybys potřeboval pomoc ...
...
func void DIA_Addon_Lares_RangerHelp_Info()
{
	...
	{
		Info_AddChoice(DIA_Addon_Lares_RangerHelp,"A co tak lepší brnění?",DIA_Addon_Lares_RangerHelp_ruestung);
	};
...
{
	AI_Output(other,self,"DIA_Addon_Lares_RangerHelp_ruestung_15_00");	//A co tak lepší brnění?
	AI_Output(self,other,"DIA_Addon_Lares_RangerHelp_ruestung_09_01");	//Hmm. Myslím, že Mateo prodává brnění, ale není zrovna levné ...
	...
	AI_Output(self,other,"DIA_Addon_Lares_RangerHelp_ruestung_09_04");	//Za Mateovým obchodem je skladiště. Ale všechno zboží bylo skonfiskováno domobranou.
	AI_Output(self,other,"DIA_Addon_Lares_RangerHelp_ruestung_09_05");	//Navštiv Zurise na tržišti, kup si od něj svitek se "spánkem" a použij ho na stráž u skladu.
	AI_Output(self,other,"DIA_Addon_Lares_RangerHelp_ruestung_09_06");	//Řekl bych, že kolem Mateova obchodu se válela pěkná zbroj.
...
func void DIA_Addon_Lares_RangerHelp_geld()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_RangerHelp_geld_09_02");	//Jen mu řekni a dostaneš peníze, které potřebuješ. Já se už o zbytek postarám. Najdeš ho po cestě k dokům u vstupu do dolní části města.
...
func void DIA_Addon_Lares_Gilde_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_09_01");	//(posměšně) Horlivá pracovní posila, že?
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_09_02");	//Dobrá, poslouchám.
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_09_03");	//Můžu zkusit domluvit žoldnéřům, kdyby ses chtěl připojit k Leemu.
	...
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_09_06");	//Které gildě dáš přednost?
...
{
	AI_Output(other,self,"DIA_Addon_Lares_Gilde_BACK_15_00");	//Musím si to ještě jednou promyslet ...
	Info_ClearChoices(DIA_Addon_Lares_Gilde);
};
...
func void DIA_Addon_Lares_Gilde_SLD()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_SLD_09_01");	//Jsem si jist, že Lee tě přivítá.
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_SLD_Add_09_01");	//Nicméně, je tam test, zda-li jsi použitelný.
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_SLD_09_02");	//Navrhnul bych si pohovořit si s Cordem na Onarově farmě.
	...
	B_LogEntry(TOPIC_Addon_RangerHelpSLD,"Lares věří, že Cord mi pomůže s přijetím na farmu.");
...
func void DIA_Lares_AboutSld_Info()
{
	...
	Info_AddChoice(DIA_Lares_AboutSld,"Řekni mi o žoldnéřích víc.",DIA_Lares_AboutSld_Sld);
...
func void DIA_Lares_OtherGuild_Info()
{
	if((other.guild == GIL_MIL) || (other.guild == GIL_PAL))
	{
		if(other.guild == GIL_MIL)
		{
			...
			AI_Output(self,other,"DIA_Lares_OtherGuild_09_01");	//(smích) To mě přetrhne - bejvalej trestanec v domobraně...
		}
		else
		{
...
func void DIA_Lares_GoNow_Info()
{
	...
	else
	{
		...
		{
			Info_AddChoice(DIA_Lares_GoNow,"Okay, vraťme Vatrasův ornament.",DIA_Lares_GoNow_Maya);
		};
...
{
	AI_Output(other,self,"DIA_Addon_Lares_GoNow_Maya_15_00");	//Okay, vraťme Vatrasův ornament.
...
func void DIA_Addon_Lares_ArrivedPortalInter1_Info()
{
	...
	Info_AddChoice(DIA_Addon_Lares_ArrivedPortalInter1,"Jistě. On byl nejvyšším Mágem vody v Novém táboře.",DIA_Addon_Lares_ArrivedPortalInter1_ja);
...
func void DIA_Addon_Lares_ArrivedPortalInter1_teil2()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_ArrivedPortalInter1_teil2_09_03");	//A toto je brnění, které jsme dostali od mágů Vody. "Kruh Vody" ho nosil ještě před válkou se skřety.
...
{
	AI_Output(self,other,"DIA_Addon_Lares_ArrivedPortalInterWeiter_09_00");	//Co se děje? Jsi v pořádku?
	if((MIS_Addon_Erol_BanditStuff == LOG_Running) && (Npc_GetDistToWP(Erol,"NW_TAVERN_TO_FOREST_03") < 1000) && (Npc_IsDead(Erol) == FALSE))
	{
		...
		AI_Output(self,other,"DIA_Addon_Lares_ArrivedPortalInterWeiter_09_02");	//(arogantně) To je fakt pěkné vědět, ale máme málo času.
	};
...
func void DIA_Addon_Lares_ArrivedPortalInter2_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_ArrivedPortalInter2_09_02");	//Jako ve zlém snu se probudily kamenné příšery a zaútočili na vše, co se ocitlo v jejich blízkosti.
...
{
	AI_Output(self,other,"DIA_Addon_Lares_ArrivedPortalInterWeiter4_09_00");	//Buď opatrný, může to být odsud nebezpečné.
...
func void DIA_Addon_Lares_ArrivedPortal_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_ArrivedPortal_09_03");	//On bude nějak ovládat zvířata. Musím se nyní vrátit.
	AI_Output(self,other,"DIA_Addon_Lares_ArrivedPortal_09_04");	//A ještě jedna rada. Nepotloukej se tady kolem a bež s tím rovnou za Saturasem.
...
func void DIA_Addon_Lares_GOFORESTPRE_ja()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_GOFORESTPRE_ja_09_01");	//Dobře můj příteli. Následuj mě. Odsud to bude ošklivé.
	AI_StopProcessInfos(self);
...
func void DIA_Addon_Lares_GOFORESTPRE_nein()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_GOFORESTPRE_nein_09_01");	//Hádám, že to tu skončilo. Dobrá, uvidíme se později.
	AI_StopProcessInfos(self);
	Npc_ExchangeRoutine(self,"Start");
...
func void DIA_Addon_Lares_PortalInterWEITER_Info()
{
	...
	{
		AI_Output(other,self,"DIA_Addon_Lares_PortalInterWEITER_15_00");	//Přestaň žvanit!
	}
...
func void DIA_Lares_TEACH_BACK()
{
	...
	{
		AI_Output(self,other,"DIA_Lares_TEACH_BACK_09_00");	//Už jsi se stal obratnějším.
	};
...
func void DIA_Lares_KnowWhereEnemy_Yes()
{
	...
	AI_Output(self,other,"DIA_Lares_KnowWhereEnemy_Yes_09_02");	//Muži činu, tak to mám rád. Ještě se uvidíme.
...
func void DIA_Lares_StillNeedYou_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Lares_StillNeedYou_09_01");	//Normálně nenechávám jen tak někoho, aby se mnou takhle jednal, ale jelikož jsi jedním z nás, nechám tě jít.
