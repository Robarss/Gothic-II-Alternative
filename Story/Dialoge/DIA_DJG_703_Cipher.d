...
instance DIA_CipherDJG_WHATNEXT(C_Info)
{
	...
	permanent = TRUE;
	description = "Močálový drak je po smrti! Co budeš dělat teď?";
};
...
func void DIA_CipherDJG_WHATNEXT_Info()
{
	...
	B_LogEntry(TOPIC_Dragonhunter,"Když je močálový drak mrtvý, chce z toho Cipher vytřískat nějaké prachy a stát se velkým 'hrdinou'. No, uvidíme.");
	AI_StopProcessInfos(self);
};
