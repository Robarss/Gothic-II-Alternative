...
func void DIA_Maleth_BanditsALIVE_Info()
{
	...
	AI_Output(self,other,"DIA_Maleth_BanditsALIVE_08_03");	//Ale jestli si myslíš, že náš té lůzy můžeš zbavit, bude ti celá farma vděčná.
...
func void DIA_Maleth_PROBLEME_schafe_probleme_geldher_auftrag()
{
	...
	AI_Output(other,self,"DIA_Maleth_PROBLEME_schafe_probleme_geldher_auftrag_15_03");	//A to je to, kvůli čemu děláš takovej kravál?
...
func void DIA_Maleth_GEHSTOCK_Info()
{
	...
	AI_Output(self,other,"DIA_Maleth_GEHSTOCK_08_05");	//SDObrá. A co tohle? Včera jsem tu viděl běžet nějaký bandity s několika měšci zlata.
