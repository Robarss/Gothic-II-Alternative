...
instance DIA_Marduk_TEACH(C_Info)
{
	...
	permanent = TRUE;
	description = "Uč mě. (vytvořit runy).";
};
...
func void DIA_Marduk_Kap3_Hello_NotYourConcern()
{
	...
	if(hero.guild == GIL_DJG)
	{
		AI_Output(self,other,"DIA_Marduk_Kap3_Hello_NotYourConcern_05_03");	//(rozzlobeně) Bývaly časy, kdy lůza neměla povolen vstup do našeho svatého kláštera. Jsi důkazem, že ty časy bývaly lepší.
