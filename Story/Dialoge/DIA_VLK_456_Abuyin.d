...
func void DIA_Abuyin_Hallo_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Abuyin_Hallo_13_01");	//No ... nesmírné jsou tajemství času a vesmíru ... ah, omluv mou nezdvořilost, synu trpělivosti. Ještě jsem tě ani nepřivítal ...
...
func void DIA_Abuyin_Mischung_Super()
{
	...
	AI_Output(self,other,"DIA_Abuyin_Mischung_Super_14_06");	//A kdyby jsi měl zájem můžu ti prodat zajímavé zbraně, některé z nich jsou z mého kraje.
...
func void DIA_Abuyin_Zukunft4_Trance()
{
	...
	AI_Output(self,other,"DIA_Abuyin_Zukunft4_Trance_13_02");	//(V transu)... chrám... leží osamocen v Adanosově říši... skrytý v mlze...
	AI_PlayAni(self,"T_HEASHOOT_2_STAND");
...
{
	B_GiveTradeInv(self);
	AI_Output(other,self,"DIA_Abuyin_TRADEII_15_00");	//Ukaž mi své zboží.
};
