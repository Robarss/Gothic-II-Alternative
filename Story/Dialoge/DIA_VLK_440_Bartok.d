...
func void DIA_Bartok_Jaeger_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Bartok_Jager_04_00");	//Nedávno jsme byli ještě oba ve městě.
...
instance DIA_Addon_Bartok_MissingPeople(C_Info)
{
	...
	description = "Kde je tvůj kamarád teď?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Bartok_MissingPeople_15_00");	//Kde je tvůj kamarád teď?
	AI_Output(self,other,"DIA_Addon_Bartok_MissingPeople_04_01");	//No, to je divný příběh.
	AI_Output(self,other,"DIA_Addon_Bartok_MissingPeople_04_02");	//Před pár dny jsme se oba potulovali kolem Coraganovi hospody a povídali si o lovu.
	AI_Output(self,other,"DIA_Addon_Bartok_MissingPeople_04_03");	//Neptej se mě, co se stalo. Byl jsem totiž dost opilý.
	AI_Output(self,other,"DIA_Addon_Bartok_MissingPeople_04_04");	//Jenom si pamtuju, že Trokar chtěl nějakou trávu z bažin? Ale nikdy se už nevrátil.
...
{
	AI_Output(other,self,"DIA_Addon_Bartok_MissingPeople_wo_15_00");	//Kde sháněl tu trávu z bažin?
	AI_Output(self,other,"DIA_Addon_Bartok_MissingPeople_wo_04_01");	//Myslím, že někde z přístavní čtvrti.
};
...
func void DIA_Addon_Bartok_MissingPeople_such()
{
	...
	AI_Output(self,other,"DIA_Addon_Bartok_MissingPeople_such_04_05");	//Nevím, jestli bych to přenesl přes srdce.
};
...
instance DIA_Bartok_TeachSneak(C_Info)
{
	...
	permanent = TRUE;
	description = B_BuildLearnString("Nauč mě, jak se plížit!",B_GetLearnCostTalent(other,NPC_TALENT_SNEAK,1));
};
