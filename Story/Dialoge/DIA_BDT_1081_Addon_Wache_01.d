...
{
	AI_Output(other,self,"DIA_Addon_Wache_01_Hi_15_00");	//Všechno v pořádku?
	AI_Output(self,other,"DIA_Addon_Wache_01_Hi_04_01");	//Šáhni na Estebana a chcípneš přesně tady.
	AI_StopProcessInfos(self);
};
