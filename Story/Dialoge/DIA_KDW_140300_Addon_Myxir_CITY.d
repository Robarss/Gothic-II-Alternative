...
func void DIA_Addon_Myxir_CITY_HelloCITY_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Myxir_CITY_HelloCITY_12_01");	//Jeden z nás tu musí zůstat, pokud Vatras odejde z města.
	VatrasAbloeseIstDa = TRUE;
	if((RavenIsDead == TRUE) && (DIA_Addon_Myxir_CITY_HelloCITY_OneTime == FALSE))
	{
		AI_Output(self,other,"DIA_Addon_Myxir_CITY_HelloCITY_12_02");	//Ještě jedna věc, co ti chci říct.
		AI_Output(self,other,"DIA_Addon_Myxir_CITY_HelloCITY_12_03");	//Byl to pravý hrdinský čin, který jsi učinil v Jharkendaru.
		AI_Output(other,self,"DIA_Addon_Myxir_CITY_HelloCITY_15_04");	//Bohužel jsem ještě nesplnil svůj úkol v Khorinisu.
