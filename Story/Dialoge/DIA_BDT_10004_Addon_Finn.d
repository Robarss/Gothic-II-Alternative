...
func void DIA_Addon_Finn_Hacke_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_Hacke_07_02");	//Jestli chceš vstoupit, musíš prvně promluvit s Estebanem.
...
func void DIA_Addon_Finn_Esteban_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_Esteban_07_02");	//(váhavě) Posílá vždy nejlepší muže do dolu. Myslím - jako ty, co ví něco o dolování.
};
...
func void DIA_Addon_Finn_Mine_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10004_Finn_Mine_07_00");	//Dobrá, šéfe. Chceš vědět, kdo nejlépe pracuje v dole? Tak tady je ...
...
func void DIA_Addon_Finn_Gold_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_Gold_07_01");	//Myslím - která žena má řetěz z rudy na krku???
...
func void DIA_Addon_Finn_ein_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Finn_ein_07_04");	//Úplnej začátečník.
	}
	...
	{
		AI_Output(self,other,"DIA_Addon_Finn_ein_07_07");	//Neskutečně dobrý kopáč.
	}
	...
	else
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_Finn_ein_07_10");	//Nyní jsi tak dobrý jako já. Blahopřeji parťáku!
			B_GivePlayerXP(XP_Ambient * 2);
			Snd_Play("LevelUP");
			Finn_Gratulation = TRUE;
		};
	};
	concatText = ConcatStrings("Těžba zlata: ",IntToString(Hero_HackChance));
...
func void DIA_Addon_Finn_Attentat_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_Attentat_07_00");	//(nedůvěřivě) Fakt?
...
func void B_Addon_Finn_TellAll()
{
	...
	Finn_TellAll = TRUE;
	B_LogEntry(Topic_Addon_Esteban,"Finn mi řekl, že Huno v době pokusu o atentát nebyl v práci. Zdá se mu to podezřelé.");
};
...
func void DIA_Addon_Finn_Again_Info()
{
	...
	if(Finn_TellAll == TRUE)
	{
		...
		Info_AddChoice(DIA_Addon_Finn_Again,"Vpořádku ... (ZPĚT)",DIA_Addon_Finn_Again_Exit);
...
{
	AI_Output(other,self,"DIA_Addon_Finn_Again_Exit_15_00");	//(uctivě) Vpořádku ...
	Info_ClearChoices(DIA_Addon_Finn_Again);
};
