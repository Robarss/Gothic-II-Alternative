...
{
	AI_Output(other,self,"DIA_Hanna_AnyNews_Yes_15_00");	//Ano, jistě, samozřejmě.
...
func void DIA_Hanna_Schuldenbuch_Info()
{
	...
	AI_Output(self,other,"DIA_Hanna_Add_17_44");	//Pokud už ji Lehmar nemá, je to dobrá věc. Stejně bych ji ale radši ukryl u sebe.
};
...
func void Hanna_Blubb()
{
	...
	AI_Output(other,self,"DIA_Hanna_Add_15_25");	//Už jsem zjistil, kde se skrývají zloději?
	...
	AI_Output(self,other,"DIA_Hanna_Add_17_35");	//Tohle jsem koupil zvlášť pro tebe.
