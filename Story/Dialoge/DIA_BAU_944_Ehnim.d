...
func void DIA_Ehnim_MoleRatFett_Info()
{
	...
	AI_Output(self,other,"DIA_Ehnim_MoleRatFett_12_04");	//Ó, nic důležitýho. Jen jsem chtěl mluvit s Vinem o jeho palírně.
...
func void DIA_Ehnim_MoleRatFett_was()
{
	...
	AI_Output(self,other,"DIA_Ehnim_MoleRatFett_was_12_01");	//Ó. Asi jsem to neměl říkat. Vino byl na to své malé tajemství vždycky hodně citlivý.
	...
	B_LogEntry(TOPIC_FoundVinosKellerei,"Podle Ehnima se Vino stále ukrývá v lesích poblíž Akilova statku. Ale mechanismus dveří je zadřený a dokud jej nenamažu krysokrtím sádlem, dovnitř se nedostanu.");
