...
{
	AI_Output(other,self,"DIA_Addon_BDT_10030_Buddler_Hi_15_00");	//Vše v pořádku?
	...
	{
		AI_Output(self,other,"DIA_Addon_BDT_10030_Buddler_Hi_08_03");	//Teďka získavame sladký zlato.
		AI_StopProcessInfos(self);
	};
};
