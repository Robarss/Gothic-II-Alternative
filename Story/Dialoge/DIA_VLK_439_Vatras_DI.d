...
func void DIA_Vatras_DI_HEAL_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Vatras_DI_HEAL_05_01");	//(zbožně) Adanosi, požehnej tomuto tělu. Je předurčeno obnovit rovnováhu tohoto světa.
...
func void DIA_Vatras_DI_PEDROTOT_Info()
{
	...
	if((MIS_Gorax_KillPedro == LOG_SUCCESS) && Npc_IsDead(Pedro_DI))
	{
		...
		AI_Output(self,other,"DIA_Vatras_DI_PEDROTOT_05_04");	//Vím o tvé odporné dohodě s hady. Jsem hluboce otřesen tím, jak jsem nakonec pochybil.
...
{
	AI_Output(self,other,"DIA_Vatras_DI_Talente_Circle_5_05_00");	//Stal jsi se mágem pátého Kruhu. Používej své vědomosti s rozvahou.
	Info_ClearChoices(DIA_Vatras_DI_Talente);
