...
func void DIA_Rengaru_Hauab_Info()
{
	...
	AI_Output(self,other,"DIA_Rengaru_Hauab_07_01");	//Nejsem si jist, jestli ti do toho něco je. Ztrať se!
	AI_StopProcessInfos(self);
};
...
{
	AI_Output(other,self,"DIA_Rengaru_GOTYOU_Anteil_15_00");	//Zasloužím si nějaký podíl na kořisti.
...
func void DIA_Rengaru_GOTYOU_WhoAreYou()
{
	...
	AI_Output(self,other,"DIA_Rengaru_GOTYOU_WhoAreYou_07_01");	//Jsem jen ubohej mizera, co se snaží vyjít s penězi, jak se dá.
	AI_Output(self,other,"DIA_Rengaru_GOTYOU_WhoAreYou_07_02");	//Co ještě můžu udělat? Ve městě o práci nezavadíš.
	AI_Output(other,self,"DIA_Rengaru_GOTYOU_WhoAreYou_15_03");	//Dobrá, to vím. Ušetři mě těch nářků!
};
...
func void DIA_Rengaru_INKNAST_Knast()
{
	...
	AI_Output(self,other,"DIA_Rengaru_INKNAST_Knast_07_02");	//(varovně) Dávej si bacha - mí kamarádi nebudou odvázaní z toho, co tady vyvádíš.
