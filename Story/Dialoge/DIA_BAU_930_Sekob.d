...
func void DIA_Sekob_Defeated_Info()
{
	...
	AI_Output(self,other,"DIA_Sekob_Defeated_01_03");	//O(naříkavě) Ale pane, já nic nemám. Jsem jen chudý ubožák, co skoro umírá hlady.
...
func void DIA_Sekob_PERM_Info()
{
	...
	else
	{
		...
		else if((Kapitel >= 5) && (MIS_bringRosiBackToSekob != LOG_SUCCESS))
		{
			...
			B_LogEntry(TOPIC_bringRosiBackToSekob,"Sekobova žena Rosi zmizela a její muž by byl rád, kdyby jí někdo pomohl k návratu.");
		}
		else
		{
