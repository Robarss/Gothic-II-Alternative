...
{
	AI_Output(self,other,"DIA_Babo_Hello_03_00");	//(ostýchavě) Ahoj, ty jsi tady také nový, co?
...
func void DIA_Babo_Wurst_Info()
{
	...
	AI_Output(self,other,"DIA_Babo_Wurst_03_03");	//Už jsi dostal stejně o jednu víc, než si zasloužíš. Konkrétně o tu, kterou jsem ti právě dal. A co je klobása mezi přáteli?
...
func void DIA_Babo_YouAndAgon_Info()
{
	...
	AI_Output(self,other,"DIA_Babo_YouAndAgon_03_01");	//Ale to víš, trošku jsme se pohádali o tom, jak se starat o ohnivé kopřivy.
...
func void DIA_Babo_Kap3_HaveYourDocs_KeepThem_JustJoke()
{
	...
	AI_Output(other,self,"DIA_Babo_Kap3_HaveYourDocs_KeepThem_JustJoke_15_04");	//To je v pořádku. Tak si užij ty svoje DOKUMENTY.
