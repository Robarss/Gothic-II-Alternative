...
func void DIA_Orlan_Wein_NEIN()
{
	...
	AI_Output(self,other,"DIA_Orlan_Wein_NEIN_05_01");	//Gorax tě snad varoval, ne? Dobrá, možná bychom na tom mohli vydělat oba. Hele - dám ti za to víno 100 zlatých.
...
func void DIA_Orlan_Wein_Nie()
{
	...
	AI_Output(self,other,"DIA_Orlan_Wein_Nie_05_01");	//Copak na tom nechceš vydělat, co? (povzdych) Dobrá, tady je zlato.
...
func void DIA_Orlan_WERBISTDU_Info()
{
	...
	AI_Output(self,other,"DIA_Orlan_WERBISTDU_05_04");	//Můžu ti to nabídnou všechno a dokonce ještě víc, pokud jsou tvé mince pravé.
};
...
func void DIA_Addon_Orlan_Greg_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Orlan_Greg_05_04");	//A pak byl jednou prostě pryč. I se svou truhlou. Už nechci nic mít s lidmi jako on.
};
...
func void DIA_Addon_Orlan_Ranger_Aqua()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Orlan_Ranger_Aqua_05_02");	//... i když se nazdáš být nejchytřejší ...
	};
...
func void DIA_Addon_Orlan_Teleportstein_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Orlan_Teleportstein_05_01");	//Zbláznil ses? Dokud mi mágové Vody neřeknou, že je to bezpečné, nepřiblížím se na 10 kroků.
...
instance DIA_Addon_Orlan_WhenRangerMeeting(C_Info)
{
	...
	description = "Slyšel jsem něco o srazu 'Kruhu' ve tvé hospodě.";
};
...
{
	AI_Output(other,self,"DIA_Addon_Orlan_WhenRangerMeeting_15_00");	//Slyšel jsem něco o srazu 'Kruhu' ve tvé hospodě.
...
func void DIA_Addon_Orlan_WhenRangerMeeting_Today()
{
	...
	AI_Output(self,other,"DIA_Addon_Orlan_WhenRangerMeeting_Today_05_02");	//Doufám, že zase přijdou pozdě.
...
func void DIA_Orlan_RUESTUNG_Info()
{
	...
	Info_AddChoice(DIA_Orlan_RUESTUNG,"Kožená zbroj. (250 zlaťáků)",DIA_Orlan_RUESTUNG_Buy);
};
...
func void DIA_Orlan_HotelZimmer_ja()
{
	...
	{
		AI_Output(self,other,"DIA_Orlan_HotelZimmer_ja_05_02");	//Nemáš 50. Nejdřív peníze, pak zábava.
	};
	Info_ClearChoices(DIA_Orlan_HotelZimmer);
};
...
func void DIA_Orlan_Perm_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Orlan_Perm_05_03");	//Snad ty černí mágové brzy odtáhnou, jinak můžu hospodu zavřít.
