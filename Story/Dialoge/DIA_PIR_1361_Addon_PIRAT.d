...
func void DIA_Addon_SawPirate_Anheuern_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_SawPirate_Anheuern_09_03");	//(Obraně) Ále né! NEDÍVEJ se na mě tak! Nechci s tím mít nic společného.
...
func void DIA_Addon_SawPirate_GoHome_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_SawPirate_GoHome_09_01");	//Tak tedy budu řezat trochu déle!
...
func void DIA_Addon_SawPirate_TooFar_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_SawPirate_GoHome_09_02");	//To mě prostě odhodí. Jednou se vrátím.
	self.aivar[AIV_PARTYMEMBER] = FALSE;
	Npc_ExchangeRoutine(self,"START");
	AI_StopProcessInfos(self);
};
