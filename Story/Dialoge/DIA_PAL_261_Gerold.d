...
instance DIA_Gerold_Deal(C_Info)
{
	...
	permanent = FALSE;
	description = "Mám tady vzkaz pro jednoho z vězňů. Můžeš mu ho předat?";
};
...
instance DIA_Gerold_SetGornFree(C_Info)
{
	...
	permanent = FALSE;
	description = "Propusť Gorna na svobodu. Je to rozkaz od velitele Garonda.";
};
...
func void DIA_Gerold_KAP4_ALLESRUHIG_Info()
{
	...
	AI_Output(self,other,"DIA_Gerold_KAP4_ALLESRUHIG_12_01");	//V pořádku, ano.
...
func void DIA_Gerold_KAP4_ALLESRUHIG_geben()
{
	...
	B_LogEntry(TOPIC_GeroldGiveFood,"Garond opět omezil příděly potravin. Radši bych měl Geroldovi dát něco k jídlu, nebo z hladu vyvede nějakou hroznou pitomost. ");
