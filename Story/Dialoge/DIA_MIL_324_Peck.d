...
instance DIA_Peck_WEAPON(C_Info)
{
	...
	permanent = TRUE;
	description = "Musím si pro zbraň.";
};
...
{
	AI_Output(other,self,"DIA_Peck_WEAPON_15_00");	//Musím si pro zbraň.
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Peck_WEAPON_12_06");	//Jestli chceš lepší zbraň, jdi na trh ke kupcům.
	};
	AI_StopProcessInfos(self);
};
