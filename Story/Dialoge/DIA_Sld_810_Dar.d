...
func void DIA_Dar_Hallo_Ja()
{
	...
	AI_Output(self,other,"DIA_Dar_Hallo_Ja_03_03");	//(kření se) Mám své zdroje.
	Info_ClearChoices(DIA_Dar_Hallo);
};
...
func void DIA_Dar_WoPaket_Info()
{
	...
	if(self.aivar[AIV_LastFightAgainstPlayer] == FIGHT_LOST)
	{
		...
		Dar_Dieb = TRUE;
		B_LogEntry(Topic_CipherPaket,"Dar se přiznal, že balík s trávou ukradl on. Prodal jej v khorinisské přístavní čtvrti, hned vedle loďařovy dílny.");
	}
	else
	{
...
func void DIA_Dar_BRINGORCELITERING_was()
{
	...
	AI_Output(self,other,"DIA_Dar_BRINGORCELITERING_was_03_01");	//Buď si vezmi peníze, nebo tenhle amulet, který jsem... no, řekněme že jsem jej před časem nějak získal.
