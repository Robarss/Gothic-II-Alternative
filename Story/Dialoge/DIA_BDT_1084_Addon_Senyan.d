...
func void B_Senyan_Erpressung()
{
	...
	B_LogEntry(Topic_Addon_Senyan,"Seynan mě poznal. Ví kdo jsem. Chce to použít pro své vlastní plány. Plánuje něco a teď chce abych si promluvil s Estebanem.");
};
...
func void DIA_Addon_BDT_1084_Senyan_Hi_bad()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_1084_Senyan_Hi_bad_12_02");	//Raven tě hledá. Jeho stráže tě hledají. Vlastně, všichni bandité ...
	...
	AI_Output(self,other,"DIA_Addon_BDT_1084_Senyan_Hi_bad_12_05");	//Tvoje bojové schopnosti jsou pozoruhodné jako tvoje chytrost. Nasadit si jedno z našich brnění a přijít k nám do tábora je jako ...
...
func void DIA_Addon_Senyan_Attentat_JA()
{
	...
	Info_ClearChoices(DIA_Addon_Senyan_Attentat);
	B_LogEntry(Topic_Addon_Senyan,"Seynan chce abych našel a zabil spiklence. Jenom pro něj získat odměnu.");
};
