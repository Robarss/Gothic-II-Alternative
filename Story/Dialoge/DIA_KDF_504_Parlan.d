...
func void DIA_Parlan_PMSchulden_Info()
{
	...
	else if(B_GetGreatestPetzCrime(self) < Parlan_LastPetzCrime)
	{
		...
		if(B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output(self,other,"DIA_Parlan_PMSchulden_05_10");	//Tvé hříchy jsou nyní odpuštěny.
...
{
	AI_Output(self,other,"DIA_Addon_Parlan_WELCOME_05_00");	//Odnes okamžitě svůj poplatek klášteru Goraxovi. Ten se o to postará.
};
...
instance DIA_Parlan_Amulett(C_Info)
{
	...
	permanent = FALSE;
	description = "Řekni mi něco o Innosově oku.";
};
...
func void DIA_Parlan_DontDisturb_Info()
{
	...
	AI_Output(self,other,"DIA_Parlan_DontDisturb_05_02");	//(rázně) Další vyrušování nebudu tolerovat!
	Parlan_DontTalkToNovice = LOG_Running;
};
...
func void DIA_Parlan_Kap3U4U5_PERM_Cellar()
{
	...
	AI_Output(self,other,"DIA_Parlan_Add_05_04");	//Vstup do sklepů je v polovině kolonády napravo.
};
