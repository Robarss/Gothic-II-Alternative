...
func void DIA_MAtteo_Paladine_Info()
{
	...
	AI_Output(self,other,"DIA_Matteo_Paladine_09_02");	//Posledně jsem mířil do horní části města, ale stráže mi zastoupily cestu a chtěly vědět, co tam pohledávám!
	AI_Output(other,self,"DIA_Matteo_Paladine_15_03");	//A?
	AI_Output(self,other,"DIA_Matteo_Paladine_09_04");	//Samozřejmě mě pak pustili dovnitř!
...
func void DIA_MAtteo_Confiscated_Info()
{
	...
	AI_Output(self,other,"DIA_Matteo_Confiscated_09_02");	//Prostě ke vchodu na dvůr postavily stráž.
...
func void B_Matteo_RegDichAb()
{
	...
	B_LogEntry(TOPIC_Matteo,"Gritta, neteř tesaře Thorbena, dluží Matteovi 100 zlaťáků. Když mu je vrátím, pomůže mi v cestě do horní čtvrti.");
};
