...
func void DIA_Addon_Franco_HI_Info()
{
	...
	if(Ramon_News == FALSE)
	{
		AI_Output(self,other,"DIA_Addon_Franco_HI_08_04");	//Ramon, strážce u brány, ti řekne, jestli potřebuje nové lidi v táboře. Promluv si s ním.
		B_LogEntry(Topic_Addon_Franco,"Mám se zaptat Ramona, strážce u brány, jestli nepotřebuje nové lidi.");
	};
};
...
func void DIA_Addon_Franco_HaiSuccess_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Franco_HaiSuccess_08_02");	//DOBRÁ, bojoval jsi proti bažinným žralokům - mohl bys být užitečný - přinejmenším víc, než většina zdejších chlapů.
...
func void DIA_Addon_Franco_Mis2_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Franco_MIS2_08_03");	//Měl pro mě získat starou kamennou desku - ale od té doby ho nikdo neviděl.
	AI_Output(self,other,"DIA_Addon_Franco_MIS2_08_04");	//Takže mi tu kamenou desku přineseš ty.
...
func void DIA_Addon_Franco_While_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Franco_While_08_03");	//(extrémě přátelsky) Tak ty chceš zlato? Jasně, řekni si, kolik? Padesát nugetů? Sto? Dám ti kolik jen uneseš ...
