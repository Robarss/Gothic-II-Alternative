...
func void DIA_Addon_RoastPirate_Francis_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_PIR_6_Francis_06_01");	//Francis? Jedná s námi jako by byl náš kapitán, který ale okamžitě zastaví, když bude Greg zpátky.
	AI_Output(self,other,"DIA_Addon_PIR_6_Francis_06_02");	//Pak by se plazil zpět pod jeho skálu jako rak.
...
func void DIA_Addon_RoastPirate_PERM_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_PIR_6_Chef_06_05");	//Jen ať bandité zaútočí. Budou nemile překvapeni.
	}
	else
	{
