...
func void DIA_Addon_Lucia_was_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lucia_was_16_02");	//Tak dobrá, alespoň na něco byli dobří ...
...
func void DIA_Addon_Lucia_Jetzt_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lucia_Jetzt_16_02");	//Již jsi hovořil s Thorusem? (omdlí) Ó bože, to je fakt chlap!
	AI_Output(self,other,"DIA_Addon_Lucia_Jetzt_16_03");	//(se smíchem) Sorry ... zpět k tvojí otázce ... Nemám žádný cíl, nechávám vše náhodě.
};
