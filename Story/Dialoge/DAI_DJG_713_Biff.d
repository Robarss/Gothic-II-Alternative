...
{
	if((DJG_BiffParty == FALSE) && Npc_KnowsInfo(other,DIA_Biff_HALLO) && Npc_KnowsInfo(other,DIA_Garond_BACKINKAP4) && (DJG_Biff_Stay == FALSE)) 
	{
		return TRUE;
	};
};
...
func void DIA_Biff_ARBEITEN_Info()
{
	...
	B_LogEntry(TOPIC_Dragonhunter,"Drakobijce Biff je žoldnéř tělem i duší. Když mu zaplatím, bojovat po mém boku.");
...
{
	AI_Output(other,self,"DIA_Biff_GELDEINTREIBEN_zuTeuer_trennen_15_00");	//Obávám se, že se budem muset rozejít.
