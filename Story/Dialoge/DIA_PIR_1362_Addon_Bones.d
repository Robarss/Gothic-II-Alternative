...
func void DIA_Addon_Bones_Teacher_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Bones_Teacher_01_11");	//Nicméně jsem si jist, že Alligator Jack nebo Samuel by ti mohli nějaký trik ukázat.
...
instance DIA_Addon_Bones_WantArmor(C_Info)
{
	...
	permanent = TRUE;
	description = "Dej mi brnění bandity.";
};
...
{
	AI_Output(other,self,"DIA_Addon_Bones_WantArmor_15_00");	//Dej mi brnění bandity.
	AI_Output(self,other,"DIA_Addon_Bones_WantArmor_01_01");	//Nejsem blázen, Greg by mi sťal hlavu.
	AI_Output(self,other,"DIA_Addon_Bones_WantArmor_01_02");	//Říkál, že bez jeho rozkazu nemůžu nikomu dát to brnění.
	if(GregIsBack == TRUE)
	{
		AI_Output(self,other,"DIA_Addon_Bones_WantArmor_01_03");	//Nemůžu ti ho dát. Aspoň dokud není zpět.
	};
	B_LogEntry(TOPIC_Addon_BDTRuestung,"Bones mi nechce dát brnění banditů bez Gregova svolení.");
};
...
instance DIA_Addon_Bones_GiveArmor(C_Info)
{
	...
	permanent = FALSE;
	description = "Gregův rozkaz je, že mi máš dát brnění.";
};
...
{
	AI_Output(other,self,"DIA_Addon_Bones_GiveArmor_15_00");	//Gregův rozkaz je, že mi máš dát brnění.
	...
	AI_Output(other,self,"DIA_Addon_Bones_GiveArmor_15_04");	//Brnění.
	...
	B_LogEntry(TOPIC_Addon_BDTRuestung,"Zdá se, že gregův rozkaz může dělat zázraky. Mám brnění banditů!");
