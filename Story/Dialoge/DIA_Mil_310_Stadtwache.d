...
func void DIA_Addon_Mil_310_Stadtwache_Constantino_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_01");	//(úskočně) Aha? Pokud je to tak, ukaž mi co neseš.
		...
		{
			AI_Output(self,other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_02");	//(souhlasně) Hmm. Vše v pořádku. Stačí. Můžeš jít dovnitř. Ale nedělej žádné problémy, jasné?
			self.aivar[AIV_PASSGATE] = TRUE;
			Stadtwache_333.aivar[AIV_PASSGATE] = TRUE;
			Mil_310_schonmalreingelassen = TRUE;
...
func void DIA_Mil_310_Stadtwache_Paladine_Info()
{
	...
	Info_AddChoice(DIA_Mil_310_Stadtwache_Paladine,"V khorinisském údolí se shromažďují síly zla!",DIA_Mil_310_Stadtwache_Paladine_EvilArmy);
...
{
	AI_Output(other,self,"DIA_Mil_310_Stadtwache_Paladine_EvilArmy_15_00");	//V khorinisském údolí se shromažďují síly zla!
	...
	Info_AddChoice(DIA_Mil_310_Stadtwache_Paladine,"Ano. Byl jsem v khorinisském údolí. Viděl jsem několik obřích draků!",DIA_Mil_310_Stadtwache_Paladine_YesDragons);
};
...
{
	AI_Output(other,self,"DIA_Mil_310_Stadtwache_Paladine_YesDragons_15_00");	//Ano. Byl jsem v khorinisském údolí. Viděl jsem několik obřích draků!
