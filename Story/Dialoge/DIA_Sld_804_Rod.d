...
func void DIA_Rod_Hello_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Rod_Hello_06_01");	//(pohrdavě) Co ode mne chceš, blbečku?
...
func void DIA_Rod_Wette_Yes()
{
	...
	if(B_GiveInvItems(other,self,ItMi_Gold,30))
	{
		...
		AI_Output(self,other,"DIA_Rod_Wette_Yes_06_03");	//(škodolibě) V pořádku, podíváme se tedy jak si silnej...
