...
func void DIA_Addon_AlligatorJack_Vorschlag_tot()
{
	...
	AI_Output(self,other,"DIA_Addon_AlligatorJack_Vorschlag_tot_12_03");	//Vůbec se k němu nedostaneš. Bandité, které shromáždil, tě stejmou dřív, než ho jen spatříš.
...
func void DIA_Addon_AlligatorJack_BDTRuestung_Info()
{
	...
	Info_AddChoice(DIA_Addon_AlligatorJack_BDTRuestung,"Máš nějaký nápad, kde bych mohl sehnat takové brnění?",DIA_Addon_AlligatorJack_BDTRuestung_wo);
...
{
	AI_Output(other,self,"DIA_Addon_AlligatorJack_BDTRuestung_wo_15_00");	//Máš nějaký nápad, kde bych mohl sehnat takové brnění?
	...
	B_LogEntry(TOPIC_Addon_BDTRuestung,"Piráti kdysi měli zbroj banditů. Aligator Jack mi nemůže říct jestli ještě existuje.");
	Info_ClearChoices(DIA_Addon_AlligatorJack_BDTRuestung);
};
...
func void DIA_Addon_AlligatorJack_WasJagen_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_AlligatorJack_WasJagen_12_01");	//Nic, obvykle jen aligatory. Ale nemůžeme je sníst.
	...
	AI_Output(self,other,"DIA_Addon_AlligatorJack_WasJagen_12_06");	//Tlusté bažinné krysy jsou jediná věc, co se dá jíst.
...
func void DIA_Addon_AlligatorJack_HuntEnd_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_AlligatorJack_PassHenry_12_10");	//U vchodu do tábora najdeš pravděpodobně Henryho. Stará se o hlídáni v případě, že by zaútočili bandité.
	...
	B_LogEntry(TOPIC_Addon_RatHunt,"Lov byl uspěšný. Zabyli jsme několik bažinných krys.");
...
func void B_AJ_Teach()
{
	...
	{
		Info_AddChoice(DIA_Addon_AlligatorJack_Teach,B_BuildLearnString("Stahování kůže plazů",B_GetLearnCostTalent(other,NPC_TALENT_TAKEANIMALTROPHY,TROPHY_ReptileSkin)),DIA_Addon_AlligatorJack_Teach_FUR);
	};
...
func void DIA_Addon_AlligatorJack_Teach_FUR()
{
	if(PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_ReptileSkin] == FALSE)
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_AlligatorJack_Teach_Fur_12_00");	//Vždy jediný řez podél břicha, nebo to zničí kvalitu.
		};
	}
	else
	{
