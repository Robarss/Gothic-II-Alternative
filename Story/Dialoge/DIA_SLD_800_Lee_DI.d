...
func void DIA_Lee_DI_Hallo_Info()
{
	...
	AI_Output(self,other,"DIA_Lee_DI_Hallo_04_01");	//Někdo musí na loď dohlížet. Zůstanu tady a postarám se o to, aby tady zůstala, až se vrátíš.
};
...
instance DIA_Lee_DI_Teach(C_Info)
{
	...
	permanent = TRUE;
	description = "Potřebuji se vycvičit.";
};
...
instance DIA_Lee_DI_UndeadDragonDead(C_Info)
{
	...
	permanent = TRUE;
	description = "Můžeme vyrazit. Nepřítel je mrtvý.";
};
...
func void DIA_Lee_DI_UndeadDragonDead_Info()
{
	...
	if((DIA_Lee_DI_UndeadDragonDead_OneTime == FALSE) && (hero.guild == GIL_DJG))
	{
		...
		AI_Output(self,other,"DIA_Lee_Add_04_26");	//A pak se konečně půjdu podívat na Krále.
