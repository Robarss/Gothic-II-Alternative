...
func void DIA_Talbin_HALLO_Info()
{
	...
	AI_Output(self,other,"DIA_Talbin_HALLO_07_02");	//No to mě podrž! Další ztracená vovečka, co? Nejdřív jsem tě měl za jednoho z těch zlejch šmejdů, co tu pořád vopruzujou.
...
func void DIA_Talbin_WASMACHTIHR_Info()
{
	...
	Info_AddChoice(DIA_Talbin_WASMACHTIHR,"Ty jsi bývalý vězeň, který byl uvržen za bariéru?",DIA_Talbin_WASMACHTIHR_strf);
};
...
{
	AI_Output(other,self,"DIA_Talbin_WASMACHTIHR_strf_15_00");	//Ty jsi bývalý vězeň, který byl uvržen za bariéru?
