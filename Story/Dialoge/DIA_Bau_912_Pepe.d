...
instance DIA_Pepe_Danger(C_Info)
{
	...
	permanent = FALSE;
	description = "Co je tak nebezpečného na pastvině?";
};
...
func void DIA_Pepe_KillWolves_Info()
{
	...
	AI_Output(self,other,"DIA_Pepe_KillWolves_03_01");	//(posměšně) Ty? A sám? Ha ha. Tomu nevěřím. To dřív uvěřil tomu, že to udělá můj chlebodárce.
