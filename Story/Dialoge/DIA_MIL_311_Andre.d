...
func void DIA_Andre_PETZMASTER_Info()
{
	...
	if(B_GetGreatestPetzCrime(self) == CRIME_MURDER)
	{
		...
		AI_Output(self,other,"DIA_Andre_PETZMASTER_08_06");	//Nemám žádný zájem na tom tě pověsil. Jsme ve válce a potřebujeme každého muže.
...
func void DIA_Addon_Andre_MartinEmpfehlung_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Andre_MartinEmpfehlung_08_01");	//(nevěřícně) Cože? Okamžitě mi ho ukaž.
	B_GiveInvItems(other,self,ItWr_Martin_MilizEmpfehlung_Addon,1);
	B_UseFakeScroll();
	AI_Output(self,other,"DIA_Addon_Andre_MartinEmpfehlung_08_02");	//(ohromeně) Já zírám! To ses musel opravdu snažit, abys na něho udělal dojem, že? Martin totiž většinou nebývá tak velkorysý v těhle věcech.
	AI_Output(self,other,"DIA_Addon_Andre_MartinEmpfehlung_08_03");	//Dobře, dobře. Tím si mě přesvědčil. Když máš podporu Martina, tak já tě budu také akceptovat. Řekni mi, až budeš připravený.
...
func void DIA_Andre_GuildOfThieves_Info()
{
	...
	B_LogEntry(TOPIC_BecomeMIL,"K městské gardě se mohu přidat i jinak, a to tak, že vypátrám a zničím khorinisský zlodějský cech.");
};
...
func void DIA_Andre_Auslieferung_Nagur()
{
	...
	AI_Output(other,self,"DIA_Andre_Auslieferung_Nagur_15_00");	//Nagur zabil Baltramova posla. Pokusil se použít mě jako nového posla, aby zachytil Akilovu zásilku.
...
func void DIA_Andre_Auslieferung_Canthar()
{
	...
	AI_Output(other,self,"DIA_Andre_Auslieferung_Canthar_15_02");	//Měl jsem jí podstrčit falešný dopis, ve kterém tvrdí, že dodává zbraně Onarovi.
...
func void DIA_Andre_JOIN_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Andre_JOIN_08_00");	//Martin za tebe ručí a dokonce tě i doporučil. To mi bude stačit.
	}
	...
	else if(Player_IsApprentice > APP_NONE)
	{
		...
		AI_Output(self,other,"DIA_Andre_JOIN_08_13");	//Pokud pro tebe bude hlasovat, nestojí nic v cestě tvému přijetí do domobrany.
...
func void DIA_Andre_JOIN_Yes()
{
	...
	AI_Output(self,other,"DIA_Andre_JOIN_Yes_08_02");	//Tady máš svou zbroj a helmu.
	B_GiveInvItems(self,other,ITAR_Mil_L,1);
	B_GiveInvItems(self,other,ITHL_HELMx22,1);
...
func void DIA_Andre_FOUND_PECK_SOMEWHERE()
{
	...
	AI_Output(self,other,"DIA_Andre_FOUND_PECK_SOMEWHERE_08_01");	//Dobrá, tak jdi za ním a vyzvedni si zbraň.
...
func void DIA_Andre_FIRSTMISSION_Info()
{
	...
	AI_Output(self,other,"DIA_Andre_FIRSTMISSION_08_05");	//Mám podezření, že za tím jsou ti žoldáci. Vsadím se, že to jsou oni, kdo to svinstvo přináší do města.
...
func void DIA_Andre_FIND_DEALER_Info()
{
	...
	AI_Output(self,other,"DIA_Andre_FIND_DEALER_08_06");	//Najdi toho dealera a nech si od něj nějakou tu trávu prodat. Nebude to snadné, ale jinak ho nemůžeme zatknout.
...
func void DIA_Andre_HILFBAUERLOBART_Info()
{
	...
	AI_Output(self,other,"DIA_Andre_HILFBAUERLOBART_08_02");	//Pokud mu pomůžeme, upevníme jeho vztahy s městem. Jdi tedy za ním a zjisti, co se děje.
...
instance DIA_Addon_Andre_MissingPeople(C_Info)
{
	...
	description = "Co je s těmi chybějícími lidmi?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Andre_MissingPeople_15_00");	//Co je s těmi chybějícími lidmi?
	...
	AI_Output(self,other,"DIA_Addon_Andre_MissingPeople_08_03");	//Dostal jsem rozkaz od lorda Hagena chránit město a jeho okolí.
	AI_Output(self,other,"DIA_Addon_Andre_MissingPeople_08_04");	//A to znamená, že budu chránit lidi, kteří jsou stále TADY.
	AI_Output(self,other,"DIA_Addon_Andre_MissingPeople_08_05");	//Hlídky domobrany jsou každou noc v ulicích. Nemůžu udělat víc.
	AI_Output(self,other,"DIA_Addon_Andre_MissingPeople_08_06");	//A TY se budeš starat o ten úkol, co jsem ti dal, rozuměls?
...
instance DIA_Addon_Andre_MissingPeople2(C_Info)
{
	...
	description = "Ohledně těch chybějících lidí ...";
};
...
{
	AI_Output(other,self,"DIA_Addon_Andre_MissingPeople2_15_00");	//Ohledně těch chybějících lidí ...
	AI_Output(self,other,"DIA_Addon_Andre_MissingPeople2_08_01");	//Klidně se o ty fámy starej. Já mám vlastních problémů dost.
	MIS_Addon_Andre_MissingPeople = LOG_Running;
};
...
instance DIA_Addon_Andre_ReturnedMissingPeople(C_Info)
{
	...
	description = "Podařilo se mi pár těch chybějících lidí zachránit.";
};
...
{
	AI_Output(other,self,"DIA_Addon_Andre_ReturnedMissingPeople_15_00");	//Podařilo se mi pár těch chybějících lidí zachránit.
	if(other.guild == GIL_MIL)
	{
		AI_Output(self,other,"DIA_Addon_Andre_ReturnedMissingPeople_08_01");	//Už mě začínalo zajímat, kde ses tak dlouho toulal!
		AI_Output(self,other,"DIA_Addon_Andre_ReturnedMissingPeople_08_02");	//Ty jsi člen domobrany! Takové věci se tě netýkají!
	...
	if(other.guild == GIL_MIL)
	{
		AI_Output(self,other,"DIA_Addon_Andre_ReturnedMissingPeople_08_07");	//Jsem na tebe hrdý! Jsem nadšený, že jsem tě sem přijal.
		AI_Output(self,other,"DIA_Addon_Andre_ReturnedMissingPeople_08_09");	//A za odměnu ti dám masivní zbroj stráže.
		CreateInvItems(other,itar_w2_tknight_grd7,1);
		AI_PrintScreen("Andre ti daruje vengardskou zbroj .",-1,YPOS_ItemTaken,FONT_ScreenSmall,2);
		B_AndreSold();
	};
	AI_Output(self,other,"DIA_Addon_Andre_ReturnedMissingPeople_08_08");	//Skvělá práce pokračuj v tom co děláš.
...
func void DIA_Andre_BennetInPrison_Info()
{
	...
	AI_Output(self,other,"DIA_Andre_BennetInPrison_Talk_08_01");	//Jistě, jak je libo. Ale pokud se pokusíš pomoci mu k útěku, skočíš tam také.
};
...
func void DIA_Andre_Cornelius_Liar_Info()
{
	...
	Info_AddChoice(DIA_Andre_Cornelius_Liar,"Ne. O tom se musí dozvědět lord Hagen.",DIA_Andre_Cornelius_Liar_No);
