...
instance DIA_Maria_Umsehen(C_Info)
{
	...
	permanent = FALSE;
	description = "Jen jsem si to chtěl tady prohlédnout.";
};
...
func void DIA_Maria_AboutOnar_Info()
{
	...
	AI_Output(self,other,"DIA_Maria_AboutOnar_17_02");	//Řekla jsem svému muži, proč ty vojáky necháš se sebou takhle zacházet?
	...
	AI_Output(self,other,"DIA_Maria_AboutOnar_17_05");	//Ale mi vlastně jsme ve válce, nebo ne?
};
