...
func void DIA_Addon_Matt_Bandits_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Matt_Bandits_10_01");	//Myslíš s vyjímkou toho, že jsou nebezpečnými vrahy a početně nás převyšují?
	...
	AI_Output(self,other,"DIA_Addon_Matt_Bandits_10_04");	//Nicméně, pochybuji že to bude, protože ti bastardi spotřebovali všechno zlato.
...
func void DIA_Addon_Matt_Francis_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Matt_Francis_10_01");	//Myslíš kromě toho, že je shnilý a neschpný?
...
func void DIA_Addon_Matt_GoHome_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Matt_GoHome_10_01");	//(zbědovaně) Potřebuji pořádný hlt grogu!
	AI_StopProcessInfos(self);
