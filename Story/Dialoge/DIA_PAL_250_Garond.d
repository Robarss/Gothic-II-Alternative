...
func void DIA_Garond_PETZMASTER_PayLater()
{
	...
	AI_Output(self,other,"DIA_Garond_PETZMASTER_PayLater_10_02");	//A varuju tě: jestli se zapleteš ještě do něčeho, tak se ta částka ještě zvýší!
...
func void DIA_Garond_Hello_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Garond_Hello_10_05");	//Vrtá mi hlavou, proč by chtěl žoldák něco takového. Co tady děláš?
	};
};
...
instance DIA_Garond_NeedProof(C_Info)
{
	...
	description = "Přicházím od lorda Hagena. Chce, abych mu donesl důkaz o přítomnosti draků.";
};
...
func void DIA_Garond_NeedProof_Info()
{
	...
	B_LogEntry(TOPIC_ScoutMine,"Velitel Garond mě pověřil dalším posláním. Už před časem vyslal tři oddíly kopáčů, kteří měli pátrat po magické rudě, ale nikdo z nich s dosud nevrátil.");
...
func void B_Garond_OreCounter3()
{
	...
	AI_Output(self,other,"B_Garond_OreCounter3_10_01");	//Moji muži jsou téměř mrtví a s tou trochou rudy, co máme, bychom nezastavili JEDINÉHO SKŘETA, NATOŽ CELOU ARMÁDU!
...
instance DIA_Garond_Pay(C_Info)
{
	...
	permanent = TRUE;
	description = "Chtěl bych vykoupit Gorna.";
};
