...
{
	AI_Output(self,other,"DIA_Addon_10023_Wache_Hi_11_00");	//Hej, kam jdeš? Zamýšlíš jít dále touto stezkou?
	AI_Output(other,self,"DIA_Addon_10023_Wache_Hi_15_01");	//Proč ne?
	AI_Output(self,other,"DIA_Addon_10023_Wache_Hi_11_02");	//Tam dole je víc otroků. Můžeš vstoupit, jestli chceš. Nebij je moc, jinak nebudou můct dále pracovat.
	AI_Output(self,other,"DIA_Addon_10023_Wache_Hi_11_03");	//Nechceme, aby tady posedávali. Musejí dolovat zlato.
	AI_Output(other,self,"DIA_Addon_10023_Wache_Hi_15_04");	//Vidím. A kdo za tím stojí?
	AI_Output(self,other,"DIA_Addon_10023_Wache_Hi_11_05");	//Je to pod přímým dohledem Bloodwyna.
	AI_Output(other,self,"DIA_Addon_10023_Wache_Hi_15_06");	//A myslím, že Raven je tu nejvyšší šéf.
	AI_Output(self,other,"DIA_Addon_10023_Wache_Hi_11_07");	//To je v pořádku. Otroci jsou vlastně jeho dar Bloodwynovi. Už je víc nepotřebuje.
...
{
	AI_Output(other,self,"DIA_Addon_10023_Wache_go_15_00");	//Osvoboď otroky!
	if(PrisonGuard_Rules == FALSE)
	{
		...
		AI_Output(self,other,"DIA_Addon_10023_Wache_go_11_02");	//Taky Thorus tady má nějakou autoritu. A co ty?
...
func void DIA_Addon_10023_Wache_go_WER()
{
	...
	AI_Output(self,other,"DIA_Addon_10023_Wache_go_WER_11_01");	//Tak ty nyní děláš Estebanovu práci? Tak to znamená, že tu nemáš žádný vliv. Vypadni!
	Info_ClearChoices(DIA_Addon_10023_Wache_go);
};
...
func void DIA_Addon_10023_Wache_go_Blood()
{
	...
	AI_Output(self,other,"DIA_Addon_10023_Wache_go_Blood_11_01");	//(odpudivě) Dej to pryč! Nechci to vidět.
	...
	else
	{
		...
		{
			AI_Output(other,self,"DIA_Addon_10023_Wache_go_Blood_15_04");	//Ale řekls, že Bloodwyn vlastní otroky.
			AI_Output(self,other,"DIA_Addon_10023_Wache_go_Blood_11_05");	//Jo. Nicméně je nemohu pustit bez Thorusova svolení.
			AI_Output(other,self,"DIA_Addon_10023_Wache_go_Blood_15_06");	//Ty jsi jeden z těch chlápků, co bez svolení neudělá ani prd, že?
			Wache_einmal = TRUE;
		}
		else
		{
			AI_Output(self,other,"DIA_Addon_10023_Wache_go_Blood_11_07");	//Chtěl jsem říct, že ...
			AI_Output(other,self,"DIA_Addon_10023_Wache_go_Blood_15_08");	//... jo, jo, vše v pořádku. Šetři slovy.
		};
		Info_ClearChoices(DIA_Addon_10023_Wache_go);
	};
};
...
{
	AI_Output(other,self,"DIA_Addon_10023_Wache_go_Thorus_15_00");	//Mluvil jsem s Thorusem. Propusť ty otroky!
	AI_Output(self,other,"DIA_Addon_10023_Wache_go_Thorus_11_01");	//Dobře, když to chce Thorus. Ale zajímalo by mě, proč to udělal ...
	AI_Output(other,self,"DIA_Addon_10023_Wache_go_Thorus_15_02");	//... ale ty nejsi placený za to, aby ses divil.
	AI_Output(self,other,"DIA_Addon_10023_Wache_go_Thorus_11_03");	//Dobrá, dobrá - tady už jsem zbytečný. Jdu si dát dobrou polévku.
	Ready_Togo = TRUE;
	AI_StopProcessInfos(self);
