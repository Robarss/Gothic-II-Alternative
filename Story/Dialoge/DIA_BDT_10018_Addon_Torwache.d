...
func void DIA_Addon_BDT_10018_Torwache_EXIT_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_EXIT_04_01");	//Víš, co ti pak řeknu ...
...
func void DIA_Addon_BDT_10018_Torwache_FirstWarn_Info()
{
	if(BDT_100018_Tells == FALSE)
	{
		...
		AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_04_02");	//Nikdo nemůže vstoupit do těchto komnat. To jasně nařídil sám Raven.
		BDT_100018_Tells = TRUE;
		Log_CreateTopic(Topic_Addon_Tempel,LOG_MISSION);
		Log_SetTopicStatus(Topic_Addon_Tempel,LOG_Running);
		B_LogEntry(Topic_Addon_Tempel,"Strážce brány chrámu mě nechce pustit. Musím vymyslet, jak se dostat dovnitř.");
	}
	else
	{
...
{
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_SecondWarn_04_00");	//Udělej ještě jeden krok a ten bude tvůj poslední!
	other.aivar[AIV_LastDistToWP] = Npc_GetDistToWP(other,BDT_10018_Checkpoint);
...
func void DIA_Addon_10018_Torwache_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_Hi_04_01");	//Ne. Není. Jenom Bloodwyn může vejít dovnitř.
	B_LogEntry(Topic_Addon_Tempel,"Jenom Bloodwyn může zůstat vevnitř chrámu. Možná bych ho mohl najít.");
};
...
instance DIA_Addon_BDT_10018_Torwache_Bloodwyn(C_Info)
{
	...
	permanent = FALSE;
	description = "Bloodwyn? Neměl by být mrtvý?";
};
...
{
	AI_Output(other,self,"DIA_Addon_BDT_10018_Torwache_Bloodwyn_15_00");	//Bloodwyn? Neměl by být mrtvý?
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_Bloodwyn_04_01");	//Je silný jako nikdy před tím. A jestli se dozví, že tady děláš problémy, nakope ti zadek!
};
...
instance DIA_Addon_BDT_10018_Torwache_Bribe(C_Info)
{
	...
	permanent = FALSE;
	description = "Dám ti tisíc zlaťáků, když mě pustíš dovnitř.";
};
...
{
	AI_Output(other,self,"DIA_Addon_BDT_10018_Torwache_Bribe_15_00");	//Dám ti tisíc zlaťáků, když mě pustíš dovnitř.
...
func void DIA_Addon_10018_Torwache_Drin_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_Drin_04_01");	//Ha! Ty fakt věříš, že bych něco takového udělal?
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_Drin_04_02");	//Možná máš vliv v táboře. Ale tvoje síla končí PŘESNĚ TADY. Chápeš?
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_Drin_04_03");	//Takže - táhni do dolu kopat zlato nebo něco podobného - ale neotravuj tady!
	MIS_BloodwynRaus = LOG_Running;
	B_LogEntry(Topic_Addon_Tempel,"Bloodwyn sedí v chrámu. Tak to nepůjdu dál. Možná bych se měl porozhlédnout v dole.");
};
...
{
	AI_Output(other,self,"DIA_Addon_BDT_10018_Torwache_kopf_15_00");	//Tady! Pořád mě chceš zastavit?
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_kopf_04_01");	//Je tohle ... je to ... Bloodwyn? ... vypadá to jako ...
	AI_Output(self,other,"DIA_Addon_BDT_10018_Torwache_kopf_04_02");	//Uh ... ano, vlastně ne. Teda myslím ... uh ... můžeš jít ...
