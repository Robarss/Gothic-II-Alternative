...
func void DIA_Milten_DI_TeachMagic_RUNES()
{
	...
	{
		AI_Output(self,other,"DIA_Milten_DI_TeachMagic_RUNES_03_01");	//Aha. Ještě pořád nejsi úplně připraven. Nejdřív se nauč vyšší kruhy, pak ti budu moct pomoci.
	};
};
...
func void DIA_Milten_DI_TeachMagic_Runen_Paladin()
{
	...
	{
		Info_AddChoice(DIA_Milten_DI_TeachMagic,B_BuildLearnString("Svatá střela",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalHolyBolt)),DIA_Milten_DI_TeachMagic_Runen_Paladin_SPL_PalHolyBolt);
	};
	if(PLAYER_TALENT_RUNES[SPL_PalMediumHeal] == FALSE)
	{
		Info_AddChoice(DIA_Milten_DI_TeachMagic,B_BuildLearnString("Střední léčení",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalMediumHeal)),DIA_Milten_DI_TeachMagic_Runen_Paladin_SPL_PalMediumHeal);
	};
