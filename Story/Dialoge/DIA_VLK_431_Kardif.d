...
func void DIA_Kardif_Hallo_Angebot()
{
	...
	Info_AddChoice(DIA_Kardif_Hallo,"Fajn, 7 zlaťáků zní rozumně.",DIA_Kardif_Hallo_Sieben);
};
...
func void DIA_Addon_Kardif_MissingPeople_Info()
{
	if(B_GiveInvItems(other,self,ItMi_Gold,Kardif_Deal))
	{
		...
		AI_Output(self,other,"DIA_Addon_Kardif_MissingPeople_14_03");	//Někteří popisovali nějaké případy v nižších čtvrtích města.
		AI_Output(self,other,"DIA_Addon_Kardif_MissingPeople_14_04");	//Víc by ti poradil asi Coragon.
		AI_Output(self,other,"DIA_Addon_Kardif_MissingPeople_14_05");	//Má krčmu v nižší čtvti města, bude-li mít čas, určitě ti něco zajímanýho poví.
		...
		B_LogEntry(TOPIC_Addon_WhoStolePeople,"Kardif si myslí, že krčmář Coragon nebo přístavní rybář Halvor by mohli o hledaných lidech vědět víc.");
...
func void DIA_Kardif_Zeichen_Info()
{
	...
	AI_Output(self,other,"DIA_Kardif_Zeichen_14_01");	//(tiše) Když budeš potřebovat nějaké šperháky, přijď za mnou, pár jich tu ještě mám. A stačí, když si řekneš o něco k pití.
