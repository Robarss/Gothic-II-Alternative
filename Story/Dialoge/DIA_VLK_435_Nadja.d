...
func void DIA_Nadja_STANDARD_Info()
{
	...
	if((SC_HearedAboutMissingPeople == TRUE) && (SCKnowsMissingPeopleAreInAddonWorld == FALSE) && (Nadja_LuciaInfo == FALSE))
	{
		...
		AI_Output(other,self,"DIA_ADDON_Nadja_STANDARD_15_03");	//OK, tak pojďme nahoru.
...
func void DIA_Addon_Nadja_LuciaInfo_wo()
{
	...
	AI_Output(self,other,"DIA_Addon_Nadja_LuciaInfo_wo_16_01");	//Často se scházela s Elvrichem, s tím učedníkem Thorbena, ve spodní části města.
	AI_Output(self,other,"DIA_Addon_Nadja_LuciaInfo_wo_16_02");	//Vsadila bych se, že s ním utekla.
	Log_CreateTopic(TOPIC_Addon_Lucia,LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_Lucia,LOG_Running);
	B_LogEntry(TOPIC_Addon_Lucia,"Ta bezstarostná slečna, Lucie, zmizela z Bromorova nevěstince přes noc. Šíří se zvěsti, že utekla s Torbenovým tesařským učedníkem Elvrichem.");
...
func void DIA_Addon_Nadja_LuciaInfo_Elvrich()
{
	...
	Info_AddChoice(DIA_Addon_Nadja_LuciaInfo,"Ještě něco?",DIA_Addon_Nadja_LuciaInfo_sonst);
};

func void DIA_Addon_Nadja_LuciaInfo_sonst()
{
	AI_Output(other,self,"DIA_Addon_Nadja_LuciaInfo_sonst_15_00");	//Ještě něco?
