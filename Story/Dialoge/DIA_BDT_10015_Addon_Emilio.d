...
func void DIA_Addon_Emilio_Attentat_Info()
{
	...
	if(Emilio_Switch == 0)
	{
		AI_Output(self,other,"DIA_Addon_Emilio_Attentat_10_01");	//(úzkustlivě) Hej, já s tím nic nemám!
		Emilio_Switch = 1;
	}
	else
	{
		AI_Output(self,other,"DIA_Addon_Emilio_Attentat_10_02");	//(úzkostlivě) PRANIC!!
		Emilio_Switch = 0;
	};
};
...
func void DIA_Addon_Emilio_Senyan_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10015_Emilio_Senyan_10_04");	//(uspěchaně) Bez problému.
...
{
	AI_Output(other,self,"DIA_Addon_Emilio_Jetzt_15_00");	//Proč teď nejsi v dole?
	AI_Output(self,other,"DIA_Addon_Emilio_Jetzt_10_01");	//Byl jsem v dole dost dlouho. Nyní si potřebuji pár dnů odpočinout.
...
instance DIA_Addon_Emilio_VonEmilio(C_Info)
{
	...
	permanent = FALSE;
	description = "Lennar mi neco o tobě řekl ...";
};
...
{
	AI_Output(other,self,"DIA_Addon_Emilio_VonEmilio_15_00");	//Lennar mi něco o tobě řekl ...
...
{
	AI_Output(other,self,"DIA_Addon_Emilio_HilfMir_15_00");	//Pomoz mi najít toho, kdo chtěl spáchat ten pokus o atentát!
	...
	Emilio_TellAll = TRUE;
	B_LogEntry(Topic_Addon_Esteban,"Emilio nakonec řekl jedno jméno - Huno.");
};
...
func void DIA_Addon_Emilio_GegenEsteban_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Emilio_GegenEsteban_10_05");	//Namísto toho nás raději nechá zatřepat bačkorama!
};
...
func void DIA_Addon_Emilio_Mine_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10015_Emilio_Mine_10_00");	//Tak, nyní jsi tu šéf ty. Dobrá, pak to udělám posvém.
...
func void DIA_Addon_Emilio_Hacker_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10004_Emilio_Hacker_10_01");	//Pracuju tvrdě. Dobře, nejdůležitější věc je, že se nestanu žrádlem pro červy.
};
