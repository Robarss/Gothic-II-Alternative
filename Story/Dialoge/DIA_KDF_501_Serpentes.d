...
{
	AI_Output(self,other,"DIA_Serpentes_GOAWAY_10_00");	//Tvoje přítomnost dokazuje nejen nedostatek úcty, ale také tvou hloupost, novici!
	AI_StopProcessInfos(self);
};
...
func void DIA_Serpentes_SUCCESS_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Serpentes_SUCCESS_10_02");	//(triumfálně) Ale teď ses sám prozradil! Byls to ty, kdo zabil Garwiga!
...
func void DIA_Serpentes_MinenAnteile_was_jaSLD()
{
	...
	Log_CreateTopic(TOPIC_MinenAnteile,LOG_MISSION);
	Log_SetTopicStatus(TOPIC_MinenAnteile,LOG_Running);
	B_LogEntry(TOPIC_MinenAnteile,"Musím před soud do kláštera přivést Salandrila, alchymistu z horní khorinisské čtvrti. Nemusí mě zajímat, co vlastně spáchal, hlavně když za to dostanu zaplaceno.");
};
...
instance DIA_Serpentes_GOTSalandril(C_Info)
{
	...
	description = "Vím, kdo vypustil ty podílové listy do oběhu.";
};
