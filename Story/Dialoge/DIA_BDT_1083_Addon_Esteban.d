...
func void DIA_Addon_Esteban_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Esteban_Hi_07_03");	//Ale chápej, zabil bych tě, kdyby jsi zkusil stejnou věc se mnou.
};
...
func void DIA_Addon_Esteban_MIS_Info()
{
	...
	AI_Output(other,self,"DIA_Addon_Esteban_MIS_15_05");	//A teď je na mě, abych našel lidi, co jsou za to odpovědní.
...
instance DIA_Addon_Esteban_Armor(C_Info)
{
	...
	permanent = FALSE;
	description = "Potřebuju lepší brnění.";
};
...
func void DIA_Addon_Esteban_Armor_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Esteban_Armor_07_01");	//Na co? Vždyť už jedno máš. To ti musí stačit.
	if(MIS_Judas == LOG_Running)
	{
