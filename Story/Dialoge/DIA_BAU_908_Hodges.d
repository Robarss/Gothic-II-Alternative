...
func void DIA_Hodges_HALLO_Info()
{
	...
	AI_Output(other,self,"DIA_Hodges_HALLO_15_02");	//Jsi strašně zaměstnaný, co?
...
func void DIA_Hodges_BennetsCrime_Info()
{
	...
	AI_Output(self,other,"DIA_Hodges_BennetsCrime_03_05");	//Však víš, Onar a město. To by dopadlo špatně.
...
instance DIA_Hodges_BennetAndSLD(C_Info)
{
	...
	permanent = FALSE;
	description = "Co na to žolnéři tady na farmě?";
};
...
func void DIA_Hodges_BennetAndSLD_Info()
{
	...
	AI_Output(self,other,"DIA_Hodges_BennetAndSLD_03_01");	//Jasně, že nevím, co maj za lubem, ale některý z nich jsou fakt vytočený.
