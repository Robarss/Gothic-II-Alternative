...
func void DIA_BDT_1088_Addon_Torwache_FirstWarn_Info()
{
	...
	else if((MIS_Send_Buddler != LOG_Running) && (MIS_Send_Buddler != LOG_SUCCESS))
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_04");	//Nerozuměls? PADEJ MI Z OČÍ!
...
{
	AI_Output(self,other,"DIA_Addon_BDT_1088_Addon_Torwache_SecondWarn_06_00");	//Dobrá, v klidu. To je tvá poslední šance. Zůstaň tu dokud se nevrátím, jinak zemřeš ...
	other.aivar[AIV_LastDistToWP] = Npc_GetDistToWP(other,BDT_1088_Checkpoint);
...
func void DIA_BDT_1088_Addon_Torwache_Attack_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_1088_Addon_Torwache_Attack_06_00");	//(vzdychá) Zdá se mi, že si ze mě děláš šprýmy. Dobře, já nejsem ...
	AI_StopProcessInfos(self);
