...
{
	AI_Output(other,self,"DIA_Addon_WispDetector_DetectItems_15_00");	//Potřebuji...
	Info_ClearChoices(DIA_Addon_WispDetector_DetectItems);
	Info_AddChoice(DIA_Addon_WispDetector_DetectItems,"Pojď za mnou.",DIA_Addon_WispDetector_DetectItems_Follow);
	...
	{
		Info_AddChoice(DIA_Addon_WispDetector_DetectItems,"... zbraně pro boj na blízko.",DIA_Addon_WispDetector_DetectItems_NF);
	};
...
{
	AI_Output(other,self,"DIA_Addon_WispDetector_DetectItems_NF_15_00");	//zbraně pro boj na blízko.
...
{
	AI_Output(other,self,"DIA_Addon_WispDetector_DetectItems_FF_15_00");	//střelné zbraně a munici.
