...
func void DIA_Borka_BUYHERB_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Borka_BUYHERB_11_01");	//Omlouvám se, pane strážník. To musí být nějaká mýlka, o žádných drogách nic nevím.
	}
	else
	{
...
func void DIA_Borka_BUYHERB_Deal()
{
	...
	AI_Output(self,other,"DIA_Borka_BUYHERB_Deal_11_01");	//...no dobře... tak tedy budeme obchodovat. Dej mi 50 zlaťáků a já ti je vyměním za drogu. A žádné smlouvání.
	Info_ClearChoices(DIA_Borka_BUYHERB);
	Borka_Deal = TRUE;
};
