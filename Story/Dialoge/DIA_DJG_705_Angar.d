...
instance DIA_AngarDJG_HALLO(C_Info)
{
	...
	description = "Neznáme se? Ty jsi Cor Angar. Býval jsi templářem v táboře v bažinách.";
};
...
func void DIA_AngarDJG_HALLO_Info()
{
	...
	AI_Output(self,other,"DIA_AngarDJG_HALLO_04_04");	//(přehlíživě) Ach, nebyl jsem jeden čas vůbec schopen usnout. Pořád jsem měl noční můry.
...
func void B_SCTellsAngarAboutMadPsi()
{
	if(Angar_KnowsMadPsi == FALSE)
	{
		...
		AI_Output(other,self,"DIA_Angar_B_SCTellsAngarAboutMadPsi_15_01");	//Tví dřívější přátelé ze starého tábora procházejí zemí v černých róbách a vypadají, že je vše, co se hýbe, neskutečně štve.
...
instance DIA_Angar_SCTellsAngarAboutMadPsi2(C_Info)
{
	...
	description = "Spáčovo bratrstvo si zotročilo zlo.";
};
