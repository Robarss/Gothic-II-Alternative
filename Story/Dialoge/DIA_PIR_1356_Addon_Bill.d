...
func void DIA_Addon_Bill_Planks_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Bill_Planks_03_03");	//Ale když se mě ptáš, možná bychom se neměli rušit.
...
func void DIA_Addon_Bill_AngusnHank_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Bill_AngusnHank_03_06");	//Nejlepší se zeptat Aligatora Jacka. Je vždy někde před táborem.
	B_LogEntry(TOPIC_Addon_SkipsGrog,"Angus a Hank měli jeskyni na východ od tábora. Aligator Jack by mohl vědět víc.");
};
