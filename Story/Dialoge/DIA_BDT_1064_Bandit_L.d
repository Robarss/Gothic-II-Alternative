...
{
	AI_Output(self,other,"DIA_Addon_Dexwache_Add_04_00");	//Je jen jedna cesta jak se dostat do našeho tábora živý - přes most.
...
{
	AI_Output(self,other,"DIA_Addon_Dexwache_Add_04_01");	//Říkáš si o jednu do držky, co? Ještě JEDEN krok a poletíš ze skály dolů.
	other.aivar[AIV_LastDistToWP] = Npc_GetDistToWP(other,Bdt_1064_Checkpoint);
...
func void DIA_Bdt_1064_BanditGuard_Attack_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Dexwache_Add_04_02");	//Dobrá, řekl sis o to ...
	AI_StopProcessInfos(self);
