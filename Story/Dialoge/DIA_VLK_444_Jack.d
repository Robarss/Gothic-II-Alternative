...
func void DIA_Jack_Harbor_Info()
{
	...
	AI_Output(self,other,"DIA_Jack_Harbor_14_01");	//Khorinisský přístav už není, co býval.
...
func void DIA_Jack_LOSFAHREN_Info()
{
	...
	if(B_CaptainConditions(self) == TRUE)
	{
		...
		AI_Output(self,other,"DIA_Jack_LOSFAHREN_14_04");	//Jestli seš si jistej, že máme opravdu všechno, běž do kapitánský kajuty a dej si dvacet. Bude se ti to hodit.
		AI_StopProcessInfos(self);
