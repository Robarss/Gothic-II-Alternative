...
{
	AI_Output(self,other,"DIA_Addon_Henry_SecondWarn_04_00");	//Přiblíž se ještě o krok blíž k táboru a nakrmím s tebou žraloky.
	other.aivar[AIV_LastDistToWP] = Npc_GetDistToWP(other,PIR_1354_Checkpoint);
...
func void DIA_Addon_Henry_WantEnter_Info()
{
	...
	if(Henry_Zoll_WhatFor == FALSE)
	{
		...
		AI_Output(self,other,"DIA_Addon_Henry_WantEnter_04_03");	//Ty seš nějak neodbytnej.
	...
	if((Hlp_IsItem(itm,ItAr_KDF_L) == TRUE) || (Hlp_IsItem(itm,ItAr_KDF_H) == TRUE) || (Hlp_IsItem(itm,ITAR_RANGER_Addon) == TRUE) || (Hlp_IsItem(itm,ITAR_Mil_L) == TRUE) || (Hlp_IsItem(itm,ItAr_MIL_M) == TRUE))
	{
		...
		AI_Output(self,other,"DIA_Addon_Henry_WantEnter_04_08");	//Menší poplatek tě určitě nezabije.
		AI_Output(self,other,"DIA_Addon_Henry_WantEnter_04_09");	//Nebo jsi ty fajnové hadry někomu ukradl?
	}
	else
	{
...
func void B_Henry_NoJoin()
{
	...
	AI_Output(self,other,"DIA_Addon_Henry_Add_04_01");	//Kapitán s polovinou chlapů z tábora odplul na moře. A on je jediný, kdo příjmá nové členy.
...
func void DIA_Addon_Henry_Tribut_Info()
{
	...
	if(MIS_Henry_FreeBDTTower == LOG_SUCCESS)
	{
		...
		AI_Output(self,other,"DIA_Addon_Henry_Tribut_Add_04_01");	//Postaral JSI se o ty spráskaný psy na věži.
...
func void DIA_Addon_Henry_Palisade_WhatFor_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Henry_Palisade_WhatFor_04_12");	//Ale jsem si jist, že je to jen výzvědná hlídka.
...
func void DIA_Addon_Henry_Palisade_Bandits_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Henry_Palisade_Bandits_04_06");	//Od té doby začali napadat každého, kdo k nim nepatří.
	...
	if(self.aivar[AIV_PASSGATE] == FALSE)
	{
		AI_Output(self,other,"DIA_Addon_Henry_Palisade_Bandits_04_11");	//(podezřívavě) Škoda že si to nemůžeš poslechnout, když teď nemáš na zaplacení cla.
		Henry_Zoll_WhatFor = TRUE;
	};
};
...
func void DIA_Addon_Henry_WhatTeach_Info()
{
	...
	if(self.aivar[AIV_PASSGATE] == FALSE)
	{
		AI_Output(self,other,"DIA_Addon_Henry_WhatTeach_Add_04_01");	//(smích) Nejrpve si splň povinnosti. Až potom ti povím něco o vylepšení boje!
