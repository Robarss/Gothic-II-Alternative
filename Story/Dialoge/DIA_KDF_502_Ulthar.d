...
func void DIA_Ulthar_GREET_Info()
{
	...
	AI_Output(self,other,"DIA_Ulthar_GREET_05_06");	//Chápu, že jsi rozčílený, ale než se rozhodneme něco podniknout, musíme vše důkladně zvážit.
...
func void DIA_Ulthar_SCHREINEVERGIFTET_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Ulthar_SCHREINEVERGIFTET_05_00");	//Ještě jedna věc. Nepřítel znesvětil některé ze svatyň podél cest, které byly zasvěcené Innosovi. Přišly o své magické požehnání.
		...
		AI_Output(self,other,"DIA_Ulthar_SCHREINEVERGIFTET_05_04");	//S pomocí svatých slov očišťování získá svatyně opět svou starou moc.
