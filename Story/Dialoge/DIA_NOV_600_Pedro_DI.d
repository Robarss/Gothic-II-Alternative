...
instance DIA_Pedro_DI_YOU(C_Info)
{
	...
	description = "Zrádce! Tak jsem tě konečně našel.";
};
...
func void DIA_Pedro_DI_YOU_Info()
{
	...
	AI_Output(self,other,"DIA_Pedro_DI_YOU_09_07");	//Skřetí plukovník mne celé dny vyslýchal. Pořád mne bil. Ušetři mne. Jsem nevinný. Musíš mi věřit.
...
func void DIA_Pedro_DI_ArrivedAtShip_Info()
{
	...
	Info_AddChoice(DIA_Pedro_DI_ArrivedAtShip,"Už jsem slyšel dost. Běž si najít místo na mé lodi. Ještě pořád mám dost práce.",DIA_Pedro_DI_ArrivedAtShip_Back);
	Info_AddChoice(DIA_Pedro_DI_ArrivedAtShip,"Jak je možné dostat se dovnitř ostrova?",DIA_Pedro_DI_ArrivedAtShip_Innere);
...
func void DIA_Pedro_DI_ArrivedAtShip_OrkOberst()
{
	...
	AI_Output(self,other,"DIA_Pedro_DI_ArrivedAtShip_OrkOberst_09_02");	//Od chvíle, co jsem sem přišel, mě vyslýchal ohledně strategického rozmístění paladinů v Khorinisu.
...
func void DIA_Pedro_DI_ArrivedAtShip_Monster()
{
	...
	AI_Output(self,other,"DIA_Pedro_DI_ArrivedAtShip_Monster_09_01");	//Během dne můžeš často vidět, jak k pobřeží míří ještěrani. Obvykle nesou nějaká ohromná vejce.
...
func void DIA_Pedro_DI_ArrivedAtShip_Innere()
{
	...
	AI_Output(self,other,"DIA_Pedro_DI_ArrivedAtShip_Innere_09_03");	//Jeden ze šamanů spustil mechanismus tak, že zatáhnul za jednu z pochodní visících na zdi v chodbě.
