...
func void DIA_Addon_Brandon_AnyNews_Info()
{
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Addon_Brandon_AnyNews_04_07");	//Nic se nezměnilo, vše je jako předtím.
	};
};
...
func void DIA_Addon_Brandon_WannaLearn_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Brandon_WannaLearn_04_03");	//To nezní špatné, tak něco dones.
...
func void DIA_Addon_Brandon_HoleGrog_Info()
{
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Addon_Brandon_HoleGrog_04_06");	//Stůj, měls to pouze zkusit!
	};
...
func void DIA_Addon_Brandon_SchnellerHering_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Brandon_GiveGrog_04_01");	//Ahh! Jde to dolů jak tekutý oheň!
...
func void DIA_Addon_Brandon_Anheuern_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Brandon_Anheuern_04_03");	//Tak máme tady konečně boj!
