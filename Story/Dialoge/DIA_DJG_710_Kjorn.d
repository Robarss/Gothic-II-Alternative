...
func void DIA_Kjorn_SellInfos_Info()
{
	...
	AI_Output(self,other,"DIA_Kjorn_SellInfos_06_03");	//Hmm... těžko říct. Ale myslím, že 50 zlatých za každou poskytnutou informaci vypadá celkem slušně.
};
...
func void DIA_Kjorn_BuyInfos_OldCamp1()
{
	...
	AI_Output(self,other,"DIA_Kjorn_BuyInfos_OldCamp1_06_02");	//Dřív, když to údolí ještě sloužilo jako vězení, měli veškerou rudu odtamtud pod palcem rudní baroni.
	KjornToldOldCamp = 1;
	Info_ClearChoices(DIA_Kjorn_BuyInfos);
};
