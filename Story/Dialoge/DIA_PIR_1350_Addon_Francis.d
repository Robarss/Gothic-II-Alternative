...
func void DIA_Addon_Francis_LetMeIn_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Francis_LetMeIn_13_03");	//Odjeď nebo nedopadneš dobře.
};
...
func void DIA_Addon_Francis_Key_2000Gold()
{
	...
	if(Npc_HasItems(other,ItMi_Gold) >= 2000)
	{
		...
		AI_Output(self,other,"DIA_Addon_Francis_Key_2000Gold_13_03");	//Ah, ruku na to, nikdo na to nepřijde.
...
func void DIA_Addon_Francis_Buch_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Francis_Buch_13_01");	//Er ... Nikdy jsem tu knížku neviděl ...
