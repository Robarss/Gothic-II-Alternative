...
func void Bloodwyn_Choices_3()
{
	...
	Info_AddChoice(DIA_Addon_Bloodwyn_Wait,"Ano, to byla jeho nějvětší chyba ...",DIA_Addon_Bloodwyn_Wait_BAD3);
};
...
func void DIA_Addon_Bloodwyn_Wait_Raven()
{
	...
	AI_Output(self,other,"DIA_Addon_Bloodwyn_Wait_Raven_04_02");	//Špinavý hajzl, kterého hledáme už celu věčnost. Co tady děláš? Měls být už dávno mrtev!
	AI_Output(other,self,"DIA_Addon_Bloodwyn_Wait_Raven_15_03");	//To není poprvé, co jsem to slyšel.
	AI_Output(self,other,"DIA_Addon_Bloodwyn_Wait_Raven_04_04");	//Všichni tito dobří-nanic zklamali ... ale ty přes mě neprojdeš. Tentokrát skončím tvou cestu!
