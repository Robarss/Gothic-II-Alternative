...
func void B_GiveTradeInv_Addon_Cronos_ADW(var C_Npc slf)
{
	...
	{
		CreateInvItems(slf,ItMW_Addon_Stab03,2);
		CreateInvItems(slf,ItMW_Addon_Stab05,2);
		...
		CreateInvItems(slf,itmw_addon_stab06,1);
	...
	if((Kapitel >= 3) && (Cronos_ADW_ItemsGiven_Chapter_3 == FALSE))
	{
		...
		CreateInvItems(slf,ItSc_ThunderBall,1);
