...
prototype MST_YOUNG_TROLL_BLACK(C_Npc)
{
	name[0] = "Mladý černý trol";
	guild = GIL_TROLL;
	aivar[AIV_MM_REAL_ID] = ID_TROLL_BLACK;
	level = 75;
	attribute[ATR_STRENGTH] = 200;
...
func void b_setvisuals_young_troll_black()
{
	Mdl_SetVisual(self,"Troll.mds");
	Mdl_SetVisualBody(self,"Troll_Black_Body",DEFAULT,DEFAULT,"",DEFAULT,DEFAULT,-1);
...
instance YOUNG_TROLL_BLACK(MST_YOUNG_TROLL_BLACK)
{
	b_setvisuals_young_troll_black();
	Npc_SetToFistMode(self);
};
