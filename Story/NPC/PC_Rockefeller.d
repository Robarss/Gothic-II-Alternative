...
instance PC_Rockefeller(Npc_Default)
{
	...
	CreateInvItems(self,ItFo_Cheese,100);
	CreateInvItems(self,ItFo_Bacon,100);
	CreateInvItems(self,ItFo_Bread,100);
	CreateInvItems(self,ItFo_Fish,100);
	CreateInvItems(self,ItFoMuttonRaw,100);
	CreateInvItems(self,ItFo_Stew,100);
	CreateInvItems(self,ItFo_FishSoup,100);
	CreateInvItems(self,ItFo_Sausage,100);
	CreateInvItems(self,ItFo_Honey,100);
	CreateInvItems(self,ItFo_Water,100);
	CreateInvItems(self,ItFo_Beer,100);
	CreateInvItems(self,ItFo_Booze,100);
	CreateInvItems(self,ItFo_Wine,100);
	CreateInvItems(self,ItFo_Milk,100);
	...
	CreateInvItems(self,ItPl_Mushroom_02,100);
	CreateInvItems(self,ItPl_Forestberry,100);
	CreateInvItems(self,ItPl_Blueplant,100);
	CreateInvItems(self,ItPl_Planeberry,100);
	...
	CreateInvItems(self,ItMiSwordraw,20);
	CreateInvItems(self,ItMiSwordrawhot,20);
	CreateInvItems(self,ItMiSwordbladehot,20);
	CreateInvItems(self,ItMiSwordblade,20);
	CreateInvItems(self,ItMi_RuneBlank,20);
	CreateInvItems(self,ItMi_Sulfur,20);
	CreateInvItems(self,ItMi_Quartz,20);
	CreateInvItems(self,ItMi_Pitch,20);
	CreateInvItems(self,ItMi_Rockcrystal,20);
	CreateInvItems(self,ItMi_Aquamarine,20);
	CreateInvItems(self,ItMi_HolyWater,20);
	CreateInvItems(self,ItMi_Coal,20);
	CreateInvItems(self,ItMi_DarkPearl,20);
	...
	CreateInvItems(self,ItAt_Meatbugflesh,20);
	CreateInvItems(self,ItAt_SheepFur,20);
	CreateInvItems(self,ItAt_WolfFur,20);
	CreateInvItems(self,ItAt_BugMandibles,20);
	CreateInvItems(self,ItAt_Claw,20);
	CreateInvItems(self,ItAt_LurkerClaw,20);
	CreateInvItems(self,ItAt_Teeth,20);
	CreateInvItems(self,ItAt_CrawlerMandibles,20);
	CreateInvItems(self,ItAt_Wing,20);
	CreateInvItems(self,ItAt_Sting,20);
	CreateInvItems(self,itat_LurkerSkin,20);
	CreateInvItems(self,ItAt_WargFur,20);
	CreateInvItems(self,ItAt_CrawlerPlate,20);
	CreateInvItems(self,ItAt_ShadowFur,20);
	CreateInvItems(self,ItAt_SharkSkin,20);
	CreateInvItems(self,ItAt_TrollFur,20);
	CreateInvItems(self,ItAt_WaranFiretongue,20);
	CreateInvItems(self,ItAt_ShadowHorn,20);
	CreateInvItems(self,ItAt_SharkTeeth,20);
	CreateInvItems(self,ItAt_TrollTooth,20);
	CreateInvItems(self,ItAt_GoblinBone,20);
	CreateInvItems(self,ItAt_SkeletonBone,20);
	CreateInvItems(self,ItAt_DemonHeart,20);
	CreateInvItems(self,ItAt_StoneGolemHeart,20);
	CreateInvItems(self,ItAt_FireGolemHeart,20);
	CreateInvItems(self,ItAt_IceGolemHeart,20);
};
