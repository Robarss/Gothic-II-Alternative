...
func void B_Video()
{
	...
	AI_Output(other,self,"Extro_Tempel_14_03");	//(fanaticky) Jsem připraven... zvol mě! Jo...
	...
	AI_Output(self,other,"OUTRO_Xardas_14_02");	//S Innosovou pomocí jsi porazit ztělěsnění zla.
	...
	AI_Output(other,self,"DIA_Addon_AddonIntro_15_00");	//(překvapeně) ... Lidé?
	AI_Output(self,other,"DIA_Addon_AddonIntro_14_01");	//(arogantně) Lidé jsou slabí.
	AI_Output(self,other,"DIA_Addon_AddonIntro_14_02");	//(arogantně) Příliš rychle padnou za oběť hněvu zla.
	AI_Output(self,other,"DIA_Addon_AddonIntro_14_03");	//Zkoušeji manipulovat se silami, kterým nelze porozumět, neřku-li je kontrolovat.
	AI_Output(self,other,"DIA_Addon_AddonIntro_14_04");	//Ti co jsou čistí a nezkažení ve své víře, již začali bojovat proti nepříteli.
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_00");	//Po pádu bariéry a zahnání Spáče se jen zvýšil beliarův hněv!
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_01");	//V písmu je stojí
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_02");	//'Mocný artefakt bude nalezen a vrácen zpět na tento svět,
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_03");	//když pán temnot povolá svého služebníka.'
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_04");	//To je zde přesně psáno.
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_05");	//Služebník Beliára se již vydal na cestu
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_06");	//při svém hledání znesvětil starobilou svatyni bohů.
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_07");	//Strážci těchto svatých míst se probudili. A jejich hněv otřesá zemí!
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_08");	//Každý mocný mág na tomto ostrově cítí toto nebezpečí
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_09");	//a někteří z nich se rozhodli této hrozbě čelit.
};
