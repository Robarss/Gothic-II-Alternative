...
func void DIA_Dragon_Undead_Hello_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_UndeadDragon_Add_20_01");	//Je pouze JEDNA věc, jenž nebyla předem dána!
	AI_Output(self,other,"DIA_Addon_UndeadDragon_Add_20_02");	//Zabil jsi jednoho z mých služebníků. Byl vyvolen nosit dráp.
	AI_Output(self,other,"DIA_Addon_UndeadDragon_Add_20_03");	//A jak vidím, nyní ho neseš ty. Zato zemřeš!
...
func void DIA_Dragon_Undead_Hello_attack()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_UndeadDragon_Add_20_04");	//Opravdu si myslíš, že mě můžeš zranit tímto drápem? (smích)
	};
