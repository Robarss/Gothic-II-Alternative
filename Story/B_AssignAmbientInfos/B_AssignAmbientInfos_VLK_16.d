...
func void DIA_VLK_16_STANDARD_Info()
{
	...
	if(Kapitel == 2)
	{
		...
		AI_Output(self,other,"DIA_VLK_16_STANDARD_16_02");	//Ráda bych věděl, jestli to náhodu není ten důvod, proč farmáři přestali chodit na trh.
	};
	if(Kapitel == 3)
	{
		if(MIS_RescueBennet == LOG_SUCCESS)
		{
			AI_Output(self,other,"DIA_VLK_16_STANDARD_16_03");	//Žoldnéř, o kterém se říkalo, že zavraždil Lothara, je nevinný. Objevily se důkazy o tom, že na něj někdo ušil boudu. Zaslechla jsem to na tržišti.
		}
		else
		{
