...
func void DIA_Dragon_Ice_Exit_Info()
{
	...
	Wld_InsertNpc(draconian2,"FP_ROAM_OW_ICEREGION_29_02");
	Wld_InsertNpc(draconian2,"FP_ROAM_OW_ICEREGION_30_01");
	Wld_InsertNpc(draconian2,"FP_ROAM_OW_BLOODFLY_05_01");
	Wld_InsertNpc(draconian2,"FP_ROAM_OW_BLOODFLY_05_01");
};
...
func void DIA_Dragon_Ice_BELIAR_Info()
{
	...
	AI_Output(other,self,"DIA_Dragon_Ice_BELIAR_15_01");	//Kterej zpropadenej bůh mohl kdy dovolit takový ohavný potvoře jako ty chodit po téhle zemi?
