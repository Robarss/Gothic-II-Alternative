...
func void DIA_Skalven_3_STANDARD_Info()
{
	...
	if(randy == 0)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_00");	//(strach) Co po mně chceš? Jdi pryč!
	};
	if(randy == 1)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_01");	//(nervózně) Nic jsem neudělal! Nech mě být!
	};
	if(randy == 2)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_02");	//(vystrašeně) Prosím, nebij mě!
	};
	AI_StopProcessInfos(self);
};
