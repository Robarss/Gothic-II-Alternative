...
{
	AI_Output(self,other,"DIA_Urshak_HOSHPAKRACHE_18_00");	//(agresivně) KHROTOK ! Já zjistil, že ty tady, když Hosh-Pak mrtvý. Ty udělal velká chyba, cizinec.
	AI_Output(other,self,"DIA_Urshak_HOSHPAKRACHE_15_01");	//Já vědět, ty budeš tady. Ty hrál na mě habaďůra.
	AI_Output(other,self,"DIA_Urshak_HOSHPAKRACHE_15_02");	//Tvá pozice být víc, než ty rád připustit. Teď ty nebýt nic, jen nástroj zla.
