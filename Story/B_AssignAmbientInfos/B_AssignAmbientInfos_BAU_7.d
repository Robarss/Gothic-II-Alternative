...
instance DIA_BAU_7_LOCATION(C_Info)
{
	...
	permanent = TRUE;
	description = "Řekni mi víc o tomhle místě.";
};
...
func void DIA_BAU_7_LOCATION_Info()
{
	...
	AI_Output(self,other,"DIA_BAU_7_LOCATION_07_02");	//A Begarova farma je na náhorní plošině na jihovýchodě. Z údolí se tam dostaneš celkem snadno - vedou tam velké kamenné schody.
};
...
func void DIA_BAU_7_STANDARD_Info()
{
	...
	if(Kapitel >= 5)
	{
		AI_Output(self,other,"DIA_BAU_7_STANDARD_07_05");	//Teď, když jsou draci mrtví, se konečně pánové paladinové uráčili odtáhnout z města. Už je na čase, aby se sem vrátila spravedlnost.
	};
};
