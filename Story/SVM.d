...
instance SVM_1(C_SVM)
{
	...
	NoLearnYoureBetter = "SVM_1_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor_sld = "SVM_1_ADDON_WRONGARMOR_SLD";	//Jak tu chodíš? Nasaď nějaké správné šaty, jo?
	addon_wrongarmor_mil = "SVM_1_ADDON_WRONGARMOR_MIL";	//Jsi voják! Oblékni se podle toho!
	addon_wrongarmor_kdf = "SVM_1_ADDON_WRONGARMOR_KDF";	//Tvoje zbroj se nehodí k našemu řádu. Změň si ji!
	addon_noarmor_bdt = "SVM_1_ADDON_ADDON_NOARMOR_BDT";	//Ty nemáš dokonce brnění. Tak si pro ně běž!
	addon_diebandit = "SVM_1_ADDON_DIEBANDIT";	//Zemři, banditskej neřáde!
	addon_dirtypirate = "SVM_1_ADDON_DIRTYPIRATE";	//Pirátskej neřáde!
};
...
instance SVM_3(C_SVM)
{
	...
	farm_crime = "SVM_3_FARM_CRIME";	//Počkej, až se to donese k Leeovi...
	...
	Smalltalk30 = "SVM_3_Smalltalk30";	//... nikdo se nesmí protivit vůli boží...
	...
	NoLearnYoureBetter = "SVM_3_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_3_Addon_WrongArmor";	//Co to máš za oděv? To se nehodí. Nechej mě na pokoji.
	addon_wrongarmor_sld = "SVM_3_ADDON_WRONGARMOR_SLD";	//Co to máš za oděv? To se nehodí. Nechej mě na pokoji.
	addon_wrongarmor_mil = "SVM_3_ADDON_WRONGARMOR_MIL";	//Co to máš za oděv? To se nehodí. Nechej mě na pokoji.
	addon_wrongarmor_kdf = "SVM_3_ADDON_WRONGARMOR_KDF";	//V našem řádu jsme si všichni rovni, proto nosíme stejné roucho. Změň si oděv!
	addon_noarmor_bdt = "SVM_3_ADDON_ADDON_NOARMOR_BDT";	//V našem řádu jsme si všichni rovni, proto nosíme stejné roucho. Změň si oděv!
	addon_diebandit = "SVM_3_ADDON_DIEBANDIT";	//POJĎ SEM, BANDITO!
	addon_dirtypirate = "SVM_3_ADDON_DIRTYPIRATE";	//POJĎ SEM, PIRÁTE!
};
...
instance SVM_4(C_SVM)
{
	...
	Weather = "SVM_4_Weather";	//Zatracený nečas!
	...
	ThenIBeatYouOutOfHere = "SVM_4_ThenIBeatYouOutOfHere";	//Mám dojem, že by některým lidem neuškodilo, kdyby poznali trochu tvrdosti.
	...
	LookingForTroubleAgain = "SVM_4_LookingForTroubleAgain";	//(agresivně) Chceš ještě nějakou další tečku?
	...
	abs_monastery = "SVM_4_ABS_MONASTERY";	//Tak jsi učinil pokání u otce Parlana.
	abs_farm = "SVM_4_ABS_FARM";	//Slyšel jsem, že Lee dal ty věci do pořádku.
	abs_good = "SVM_4_ABS_GOOD";	//Dobrá.
	sheepkiller_crime = "SVM_4_SHEEPKILLER_CRIME";	//Vraždění ovcí je už příliš! Ztrať se!
	...
	Smalltalk20 = "SVM_4_Smalltalk20";	//... nic nezmění...
	...
	addon_wrongarmor = "SVM_4_Addon_WrongArmor";	//Změň si na nějaké pořádné šaty, pak budu pokračovat v mluvení.
	addon_wrongarmor_sld = "SVM_4_ADDON_WRONGARMOR_SLD";	//Nos svoje zatracené brnění, jestli chceš mluvit se mnou!
	addon_wrongarmor_mil = "SVM_4_ADDON_WRONGARMOR_MIL";	//To ti nikdo nedal alespoň to jedno brnění? Tak si jedno sežeň.
	addon_wrongarmor_kdf = "SVM_4_ADDON_WRONGARMOR_KDF";	//Kde máš šaty? Převleč se. Pak s tebou budu mluvit.
	addon_noarmor_bdt = "SVM_4_ADDON_ADDON_NOARMOR_BDT";	//Co jsi to za chudáka? Vrať se, až si seženeš své brnění.
	addon_diebandit = "SVM_4_ADDON_DIEBANDIT";	//Další bandita!
	addon_dirtypirate = "SVM_4_ADDON_DIRTYPIRATE";	//Špinavý piráte!
};
...
instance SVM_5(C_SVM)
{
	...
	Weather = "SVM_5_Weather";	//Zatracený nečas!
	...
	Smalltalk30 = "SVM_5_Smalltalk30";	//... nikdo se nesmí protivit vůli boží...
	...
	NoLearnYoureBetter = "SVM_5_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_5_Addon_WrongArmor";	//Změň si na nějaké vhodné šaty.
	addon_wrongarmor_sld = "SVM_5_ADDON_WRONGARMOR_SLD";	//Jak mám chodit pořád dokola? Patříš k nám krátce? Pak s tebou chci mít něco společného.
	addon_wrongarmor_mil = "SVM_5_ADDON_WRONGARMOR_MIL";	//My vojáci bojujeme za krále, proto nosíme jeho zbroje, mohl bys?
	addon_wrongarmor_kdf = "SVM_5_ADDON_WRONGARMOR_KDF";	//Proč ti řád dává šatstvo, když je nenosíš? Mysli na to.
	addon_noarmor_bdt = "SVM_5_ADDON_ADDON_NOARMOR_BDT";	//Co jsi to za hejska? Vždyť ani nemáš zbroj. Odejdi.
	addon_diebandit = "SVM_5_ADDON_DIEBANDIT";	//Oh, bandita.
	addon_dirtypirate = "SVM_5_ADDON_DIRTYPIRATE";	//Já tě svážu, piráte!
};
...
instance SVM_6(C_SVM)
{
	...
	Weather = "SVM_6_Weather";	//Zatracený nečas!
	...
	NoLearnYoureBetter = "SVM_6_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_6_Addon_WrongArmor";	//V těchto hadrech děláš ze sebe směšného. Změň si je na správné!
	addon_wrongarmor_sld = "SVM_6_ADDON_WRONGARMOR_SLD";	//Ty si myslíš, že tě nepoznám? Ztrať se a změň si šaty!
	addon_wrongarmor_mil = "SVM_6_ADDON_WRONGARMOR_MIL";	//Vojáku! Co to máš za oděv? Převleč se hned!
	addon_wrongarmor_kdf = "SVM_6_ADDON_WRONGARMOR_KDF";	//Innosův služebník se neskryje. Jdi si pro své šaty.
	addon_noarmor_bdt = "SVM_6_ADDON_ADDON_NOARMOR_BDT";	//Pobíháš jako kopáč. Obleč se pořádně.
	addon_diebandit = "SVM_6_ADDON_DIEBANDIT";	//Jsi přepaden zlý hochu, BANDITA!
	addon_dirtypirate = "SVM_6_ADDON_DIRTYPIRATE";	//Vrať se na moře, PIRÁTE!
};
...
instance SVM_7(C_SVM)
{
	...
	Weather = "SVM_7_Weather";	//Zatracený nečas!
	...
	ThenIBeatYouOutOfHere = "SVM_7_ThenIBeatYouOutOfHere";	//Mám dojem, že by některým lidem neuškodilo, kdyby poznali trochu tvrdosti.
	...
	LookingForTroubleAgain = "SVM_7_LookingForTroubleAgain";	//(agresivně) Chceš ještě nějakou další tečku?
	...
	sheepkiller_crime = "SVM_7_SHEEPKILLER_CRIME";	//Vraždění ovcí je už příliš! Ztrať se!
	...
	addon_wrongarmor = "SVM_7_Addon_WrongArmor";	//Proč se převlékáš? Já nebudu mluvit s tebou takto oblečeným.
	addon_wrongarmor_sld = "SVM_7_ADDON_WRONGARMOR_SLD";	//Co zde chodíš? Nos naši zbroj!
	addon_wrongarmor_mil = "SVM_7_ADDON_WRONGARMOR_MIL";	//Toto je neplnění našeho armádního oblékacího zákona. Převleč se ihned.
	addon_wrongarmor_kdf = "SVM_7_ADDON_WRONGARMOR_KDF";	//Měl bys lépe nosit svý oděv. Do té doby se za tebe budu modlit.
	addon_noarmor_bdt = "SVM_7_ADDON_ADDON_NOARMOR_BDT";	//Co chceš? Nepatříš k nám. Nenosíš naši zbroj.
	addon_diebandit = "SVM_7_ADDON_DIEBANDIT";	//Zemři, hanebný bandito!
	addon_dirtypirate = "SVM_7_ADDON_DIRTYPIRATE";	//Zemři, ubohý piráte!
};
...
instance SVM_8(C_SVM)
{
	...
	Weather = "SVM_8_Weather";	//Zatracený nečas!
	...
	toughguy_attackwon = "SVM_8_TOUGHGUY_ATTACKWON";	//U(arogantně) Mám dojem, že už ti musí být jasné, kdo je tady ten silnější... Co chceš?
	...
	addon_wrongarmor = "SVM_8_Addon_WrongArmor";	//Nevěřím ti. Něco je špatně s tebou nebo s tvými šaty.
	addon_wrongarmor_sld = "SVM_8_ADDON_WRONGARMOR_SLD";	//Ze vzhledu, jsi se asi přidal někde jinde? Nechci s tebou nic mít.
	addon_wrongarmor_mil = "SVM_8_ADDON_WRONGARMOR_MIL";	//Musíme ukázat, že jsme zde. Proto jdi a dostaň svoji zbroj.
	addon_wrongarmor_kdf = "SVM_8_ADDON_WRONGARMOR_KDF";	//Innos chce, aby jsme nosily jeho šaty s pýchou. Jdi a změň si je.
	addon_noarmor_bdt = "SVM_8_ADDON_ADDON_NOARMOR_BDT";	//Já nehovořím s kopáči. Namáš teď zbroj!
	addon_diebandit = "SVM_8_ADDON_DIEBANDIT";	//Ty špinavý bandito!
...
instance SVM_9(C_SVM)
{
	...
	Weather = "SVM_9_Weather";	//Zatracený nečas!
	...
	Addon_DieMonster = "SVM_9_Addon_DieMonster";	//Další z těch příšer!
	Addon_DieMonster2 = "SVM_9_Addon_DieMonster2";	//Tam! Další hnusná příšera!
	...
	Addon_MonsterKilled2 = "SVM_9_Addon_MonsterKilled2";	//DALŠÍ hnusná příšera přišla!
	...
	addon_wrongarmor = "SVM_9_Addon_WrongArmor";	//Co je to za kostým? Nos něco, co se k tobě hodí.
	addon_wrongarmor_sld = "SVM_9_ADDON_WRONGARMOR_SLD";	//Jak tě mám obcházet? Nos svou zbroj!
	addon_wrongarmor_mil = "SVM_9_ADDON_WRONGARMOR_MIL";	//Pracuješ pro krále, proto také máš nosit jeho zbroj! Jdi se převléct!
	addon_wrongarmor_kdf = "SVM_9_ADDON_WRONGARMOR_KDF";	//Tvoje oblečení není vhodné k našemu řádu. Změň si šaty!
	addon_noarmor_bdt = "SVM_9_ADDON_ADDON_NOARMOR_BDT";	//Vy dokonce nemáte zbroj. Tak si pro ni běžte!
	addon_diebandit = "SVM_9_ADDON_DIEBANDIT";	//Teď to dostaneš, bandito!
	addon_dirtypirate = "SVM_9_ADDON_DIRTYPIRATE";	//Neměl jsi se zde ukazovat, piráte.
};
...
instance SVM_10(C_SVM)
{
	...
	Weather = "SVM_10_Weather";	//Zatracený nečas!
	...
	LookingForTroubleAgain = "SVM_10_LookingForTroubleAgain";	//(agresivně) Chceš další tečku do ksichtu?
	...
	sheepkiller_crime = "SVM_10_SHEEPKILLER_CRIME";	//Vraždění ovcí je už příliš! Ztrať se!
	...
	Smalltalk26 = "SVM_10_Smalltalk26";	//... prostě potřebuje víc praxe...
	...
	NoLearnYoureBetter = "SVM_10_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_10_Addon_WrongArmor";	//Co to máš za šaty? To se k tobě nehodí. Nechej mě o samotě.
	addon_wrongarmor_sld = "SVM_10_ADDON_WRONGARMOR_SLD";	//Jestli k nám patříš, měl bys nosit naše šaty. Změň si na ně.
	addon_wrongarmor_mil = "SVM_10_ADDON_WRONGARMOR_MIL";	//Jestli jsi dostal královské brnění, tak ho nos!
	addon_wrongarmor_kdf = "SVM_10_ADDON_WRONGARMOR_KDF";	//Jestli odmítáš šaty, odmítáš Innose. Jdi a mysli na to.
	addon_noarmor_bdt = "SVM_10_ADDON_ADDON_NOARMOR_BDT";	//Ty si nemůžeš dovolit brnění - proč bych s tebou měl mluvit?
...
instance SVM_11(C_SVM)
{
	...
	Weather = "SVM_11_Weather";	//Zatracený nečas!
	...
	Smalltalk30 = "SVM_11_Smalltalk30";	//... nikdo se nesmí protivit vůli boží...
	...
	NoLearnYoureBetter = "SVM_11_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_11_Addon_WrongArmor";	//Co to máš za šaty? To se k tobě nehodí. Nechej mě být.
	addon_wrongarmor_sld = "SVM_11_ADDON_WRONGARMOR_SLD";	//Nos svou zbroj, když s tebou mluvím. Teď se ztrať.
	addon_wrongarmor_mil = "SVM_11_ADDON_WRONGARMOR_MIL";	//Měl bys nosit královské brnění! Teď uhni!
	addon_wrongarmor_kdf = "SVM_11_ADDON_WRONGARMOR_KDF";	//Tvoje šaty nejsou přiměřené k našemu řádu. Změň si je!
	addon_noarmor_bdt = "SVM_11_ADDON_ADDON_NOARMOR_BDT";	//Ty nemáš zbroj. Tak pro ni vyraž!
...
instance SVM_12(C_SVM)
{
	...
	Weather = "SVM_12_Weather";	//Zatracený nečas!
	...
	Smalltalk26 = "SVM_12_Smalltalk26";	//... prostě potřebuje víc praxe...
	...
	NoLearnYoureBetter = "SVM_12_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_12_Addon_WrongArmor";	//Tvoje šaty se k tobě jednoduše nehodí. Změň si je.
	addon_wrongarmor_sld = "SVM_12_ADDON_WRONGARMOR_SLD";	//Pokud chceš se mnou mluvit, nos svou zbroj.
	addon_wrongarmor_mil = "SVM_12_ADDON_WRONGARMOR_MIL";	//Vojáci nosí královské zbroje. NIC JINÉHO! Proto si ji změň.
	addon_wrongarmor_kdf = "SVM_12_ADDON_WRONGARMOR_KDF";	//Tvoje šaty se prostě nehodí k našemu řádu. Změň si je!
	addon_noarmor_bdt = "SVM_12_ADDON_ADDON_NOARMOR_BDT";	//Nemůžeš si dovolit zbroj. Se slabochy nemluvím.
	addon_diebandit = "SVM_12_ADDON_DIEBANDIT";	//Já tě dostanu, bandito!
	addon_dirtypirate = "SVM_12_ADDON_DIRTYPIRATE";	//Já tě dostanu, piráte!
};
...
instance SVM_13(C_SVM)
{
	...
	Weather = "SVM_13_Weather";	//Zatracený nečas!
	...
	toughguy_attackwon = "SVM_13_TOUGHGUY_ATTACKWON";	//U(arogantně) Mám dojem, že už ti musí být jasné, kdo je tady ten silnější... Co chceš?
	...
	Smalltalk26 = "SVM_13_Smalltalk26";	//... prostě potřebuje víc praxe...
	...
	NoLearnYoureBetter = "SVM_13_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_13_Addon_WrongArmor";	//Co to máš za šaty? To se k tobě nehodí. Nechej mě o samotě!
	addon_wrongarmor_sld = "SVM_13_ADDON_WRONGARMOR_SLD";	//Ty nenosíš svou zbroj, jdi a dostaň ji.
	addon_wrongarmor_mil = "SVM_13_ADDON_WRONGARMOR_MIL";	//Měl by jsi být pyšný nosit královské brnění a ne pobíhat v těchto hadrech. Teď jdi!
	addon_wrongarmor_kdf = "SVM_13_ADDON_WRONGARMOR_KDF";	//Proč nenosíš zbroj našeho řádu? Jdi a mysli na to.
	addon_noarmor_bdt = "SVM_13_ADDON_ADDON_NOARMOR_BDT";	//Dokonce nemáš zbroj. Vyraž pro ni!
	addon_diebandit = "SVM_13_ADDON_DIEBANDIT";	//Špinavý bandito!
	addon_dirtypirate = "SVM_13_ADDON_DIRTYPIRATE";	//Zatracený piráte!
};
...
instance SVM_14(C_SVM)
{
	...
	Weather = "SVM_14_Weather";	//Zatracený nečas!
	...
	NoLearnYoureBetter = "SVM_14_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_14_Addon_WrongArmor";	//To šatstvo se k tobě nehodí. Jistě něco skráváš. Nechej mě na pokoji.
	addon_wrongarmor_sld = "SVM_14_ADDON_WRONGARMOR_SLD";	//Jestli chceš se mnou mluvit, musíš nosit naší zbroj.
	addon_wrongarmor_mil = "SVM_14_ADDON_WRONGARMOR_MIL";	//Buď pyšný na armádu a nepobíhej v těchto hadrech. Teď si změň šaty!
	addon_wrongarmor_kdf = "SVM_14_ADDON_WRONGARMOR_KDF";	//Tvé šaty nejsou vhodné k našemu řádu. Změň si je!
	addon_noarmor_bdt = "SVM_14_ADDON_ADDON_NOARMOR_BDT";	//Dokonce nemáš zbroj, tak vyraž na cestu!
	addon_diebandit = "SVM_14_ADDON_DIEBANDIT";	//Zemři, bandito!
	addon_dirtypirate = "SVM_14_ADDON_DIRTYPIRATE";	//Zemři, piráte!
};
...
instance SVM_15(C_SVM)
{
	...
	NoMorePicks = "SVM_15_NoMorePicks";	//Žádné další šperháky...
	...
	picklockorkeymissing = "SVM_15_PICKLOCKORKEYMISSING";	//Hm... Nemám ani klíč, ani šperhák.
	keymissing = "SVM_15_KEYMISSING";	//Tohle nemůžu bez správného klíče nikdy odemknout!
	picklockmissing = "SVM_15_PICKLOCKMISSING";	//Hodilo by se pár šperháků!
	...
	scopensirdorathbook = "SVM_15_SCOPENSIRDORATHBOOK";	//HXARAK BENDARDO! Ach. Kniha se otevřela. Uvnitř je schovaný dopis a klíč.
	scopenslastdoor = "SVM_15_SCOPENSLASTDOOR";	//KHADOSH EMEM KADAR! Otevři se!
	trade_1 = "SVM_15_Addon_TRADE_1";	//Pojďme obchodovat.
	trade_2 = "SVM_15_Addon_TRADE_2";	//Ukaž mi svoje zboží.
	trade_3 = "SVM_15_Addon_TRADE_3";	//Ukaž co máš.
	verstehe = "SVM_15_Addon_VERSTEHE";	//Vidím.
	foundtreasure = "SVM_15_Addon_FOUNDTREASURE";	//Och. Doufám, našel jsem něco.
	cantunderstandthis = "SVM_15_Addon_CANTUNDERSTANDTHIS";	//Nerozumím...
	cantreadthis = "SVM_15_Addon_CANTREADTHIS";	//To neumím číst!
	...
	attentat_addon_description = "SVM_15_ATTENTAT_ADDON_DESCRIPTION";	//Co víš o pokusu o vraždu Estebana?
	attentat_addon_description2 = "SVM_15_ATTENTAT_ADDON_DESCRIPTION2";	//O pokusu o vraždu na Estebana ...
	...
	addon_summonancientghost = "SVM_15_ADDON_SUMMONANCIENTGHOST";	//Ighoriat Thorul. Zdá se mi to, Quarhodron, starý vůdce válečné pevnosti!
	addon_ancientghost_notnear = "SVM_15_ADDON_ANCIENTGHOST_NOTNEAR";	//Mmh ... nepracuje zde.
	addon_gold_description = "SVM_15_ADDON_GOLD_DESCRIPTION";	//Co potřebuji vědět o zlatém dolu?
	Addon_ThisLittleBastard = "SVM_15_Addon_ThisLittleBastard";	//Aha. Francisova účetní kniha. Zdá se že si nechává hodně zlatých vloudit do své vlastní kapsy.
...
instance SVM_16(C_SVM)
{
	...
	Weather = "SVM_16_Weather";	//Zatracený nečas!
	...
	mona_crime = "SVM_16_MONA_CRIME";	//Zachoval sis špatně. Jdi za otcem Parlanem a kaj se.
	...
	Smalltalk17 = "SVM_16_Smalltalk17";	//... nemůžu se starat o všechno pro každého...
	...
	NoLearnYoureBetter = "SVM_16_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
	...
	addon_wrongarmor = "SVM_16_Addon_WrongArmor";	//Oblékej se pořádně. Nechci aby mě viděli s tebou, když jsi takto oblečený.
...
instance SVM_17(C_SVM)
{
	...
	Weather = "SVM_17_Weather";	//Zatracený nečas!
	...
	mona_crime = "SVM_17_MONA_CRIME";	//Zachoval sis špatně. Jdi za otcem Parlanem a kaj se.
	...
	Smalltalk04 = "SVM_17_Smalltalk04";	//... jdi pryč, neříkej mi, že...
	...
	Smalltalk17 = "SVM_17_Smalltalk17";	//... nemůžu se starat o všechno pro každého...
	...
	NoLearnYoureBetter = "SVM_17_NoLearnYoureBetter";	//Není nic, co bych tě ještě mohl naučit. Žák překonal svého učitele.
