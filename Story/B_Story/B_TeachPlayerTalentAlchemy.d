...
func int B_TeachPlayerTalentAlchemy(var C_Npc slf,var C_Npc oth,var int potion)
{
	...
	B_LogEntry(TOPIC_TalentAlchemy,"K namíchání lektvaru potřebuji prázdnou laboratorní lahvičku a nezbytné přísady. S jejich pomocí pak mohu s pomocí alchymistické kolony vytvořit potřebný elixír.");
	...
	if(potion == POTION_Perm_STR)
	{
		...
		B_LogEntry(TOPIC_TalentAlchemy,"Přísady pro ELIXÍR SÍLY: 1 dračí kořen a 1 královský šťovík.");
	};
	if(potion == POTION_Perm_DEX)
	{
		PLAYER_TALENT_ALCHEMY[POTION_Perm_DEX] = TRUE;
		B_LogEntry(TOPIC_TalentAlchemy,"Přísady pro ELIXÍR OBRATNOSTI: 1 gobliní bobule a 1 královský šťovík.");
	};
