...
func void B_ENTER_NEWWORLD_Kapitel_1()
{
    if (RavenIsDead == TRUE)
    {
        if (!Hlp_IsValidNpc(KDW_140300_Addon_Myxir_CITY))
        {
...
func void B_ENTER_NEWWORLD_Kapitel_3()
{
	if(EnterNW_Kapitel3 == FALSE)
	{
		...
		Wld_InsertNpc(DMT_DementorAmbient,"NW_CASTLEMINE_TOWER_STAND_01");
		Wld_InsertNpc(DMT_DementorAmbient,"NW_CASTLEMINE_PATH_HUT_02");
		Wld_InsertNpc(DMT_DementorAmbient,"NW_CASTLEMINE_PATH_HUT_IN");
		Wld_InsertNpc(DMT_DementorAmbient,"NW_CASTLEMINE_HUT_10");
		...
		Wld_InsertNpc(DMT_DementorAmbient,"NW_CASTLEMINE_TOWER_C");
		Wld_InsertNpc(DMT_DementorAmbient,"NW_CASTLEMINE_TOWER_B");
		Wld_InsertNpc(DMT_DementorAmbient,"NW_CASTLEMINE_TOWER_D");
		//
...
func void B_ENTER_NEWWORLD_Kapitel_5()
{
	if(EnterNW_Kapitel5 == FALSE)
	{
		...
		if(hero.guild == GIL_PAL)
		{
			...
			Wld_InsertItem(itsh_8shield,"FP_ITEM_PALFINALARMOR");
			Wld_InsertItem(itwr_armorbless,"FP_ITEM_PALFINALARMOR");
...
func void b_enter_newworld()
{
	...
	{
		EVT_TREEFALLING_01_ONETIME = FALSE;
		EVT_TREEFALLING_02_ONETIME = FALSE;
		EVT_TREEFALLING_03_ONETIME = FALSE;
		EVT_TREEFALLING_04_ONETIME = FALSE;
		EVT_TREEFALLING_05_ONETIME = FALSE;
		EVT_TREEFALLING_06_ONETIME = FALSE;
		EVT_TREEFALLING_07_ONETIME = FALSE;
		EVT_TREEFALLING_08_ONETIME = FALSE;
		EVT_TREEFALLING_09_ONETIME = FALSE;
		EVT_TREEFALLING_10_ONETIME = FALSE;
		EVT_TREEFALLING_11_ONETIME = FALSE;
		EVT_TREEFALLING_12_ONETIME = FALSE;
		EVT_TREEFALLING_13_ONETIME = FALSE;
		EVT_TREEFALLING_14_ONETIME = FALSE;
		EVT_TREEFALLING_15_ONETIME = FALSE;
		EVT_TREEFALLING_16_ONETIME = FALSE;
		EVT_TREEFALLING_17_ONETIME = FALSE;
		EVT_TREEFALLING_18_ONETIME = FALSE;
		EVT_TREEFALLING_19_ONETIME = FALSE;
		EVT_TREEFALLING_20_ONETIME = FALSE;
	};
