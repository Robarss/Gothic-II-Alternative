...
const string TOPIC_Addon_Greg_NW = "Muž se záplatou na oku";
...
const string TOPIC_Addon_MissingPeople = "Ztracení lidé";
const string TOPIC_Addon_WhoStolePeople = "Kde jsou ztracení lidé?";
const string TOPIC_Addon_BringRangerToLares = "Výpomoc za Larese";
const string TOPIC_Addon_TeleportsNW = "Teleportaèní kameny";
const string TOPIC_Addon_Stoneplates = "Kamenné desky";
const string TOPIC_Addon_RangerHelpKDF = "Snadný pøístup do kláštera";

var int TOPIC_End_RangerHelpKDF;

const string TOPIC_Addon_RangerHelpSLD = "Snadný pøístup k žoldákùm";
...
const string TOPIC_Addon_Relicts = "Uèení Jharkendaru";
const string TOPIC_Addon_RavenKDW = "Raven";
const string TOPIC_Addon_Lance = "Širší skupina Vody";

var int TOPIC_End_Lance;

const string TOPIC_Addon_HousesOfRulers = "Domy Stavitelù";
const string TOPIC_Addon_CanyonOrcs = "Skøeti v kaòonu";

var int TOPIC_END_CanyonOrcs;

const string TOPIC_Addon_BDTRuestung = "Zbroj bandity";
const string TOPIC_Addon_Quarhodron = "Síla Strážcù Smrti";
const string TOPIC_Addon_Klaue = "Beliarùv Dráp";

var int TOPIC_END_Klaue;

const string TOPIC_Addon_Kammern = "Komnaty chrámu";
const string TOPIC_Addon_Flut = "Potopené mìsto";
...
const string TOPIC_Addon_Erol = "Pøepadení obchodníci";
const string TOPIC_Addon_VatrasAbloesung = "Výpomoc za Vatrase";
const string LogText_Addon_SCKnowsMisspeapl = "Mnoho obèanù Khorinisu zmizelo. Nikdo neví, co se s nimi stalo.";
const string LogText_Addon_WilliamLeiche = "Mrtvola rybáøe leží v zøícenínách kousek na východ od tábora mágù Vody.";
const string LogText_Addon_RavensGoldmine = "Raven má dùl a nechal tam otroky kopat zlato.";
const string LogText_Addon_KDWRight = "Pouze mág Vody mùže nìkoho pøíjmout mezi Kruh Vody";
const string LogText_Addon_WilliamMissing = "William, rybáø v khorinniském pøístavu, je jedním ze zmizelých.";
const string LogText_Addon_Relicts = "V Adanosovì chrámu, vládci Jharkendaru postavili tøi komnaty smrt pøinášejících hádanek, aby zastavili jakékoliv vetøelce. Barevné desky Stavitelù jsou klíèem k nim.";
const string LogText_Addon_SkipsRumToBaltram = "Skip mi dal nìjaký rum pro Baltrama.";
const string LogText_Addon_Cavalorn_Teach = "Cavalorn mi mùže ukázat jak používat luk a jak se plížit.";
const string LogText_Addon_SaturasTeach = "Satruas mì mùže uèit magické kruhy.";
const string LogText_Addon_MyxirTeach = "Myxir mì mùže nauèit èíst pradávný jazyk Stavitelù.";
const string LogText_Addon_RiordianTeach = "Riordian mùže trénovat mou bludièku v hledání pøedmìtù.";
const string LogText_Addon_RiordianTeachAlchemy = "Riordian mì mùže uèit umìní míchání lektvarù.";
const string LogText_Addon_NefariusTeach = "Od Nefaria se mohu nauèit vyrábìt nìjaké runy.";
const string LogText_Addon_Erol_Teach = "Obchodník Erol mi mùže ukázat jak se stát silnìjším.";
const string LogText_Addon_CronosTrade = "Mág Vody Cronos má pár pøedmìtù na prodaní.";
const string LogText_Addon_VatrasTrade = "Vatras si ode mne vezme ty staré kamenné desky. Slíbil mi adekvátní odmìnu.";
const string LogText_Addon_MartinTrade = "Martin mi mùže prodat pár vìcí ze skladu paladinù.";
const string LogText_Addon_ErolTrade = "Obchodník Erol prodává zboží všeho druhu. Jeho chatrè je mezi krèmou 'U mrtvé harpyje' a Onarovou farmou.";
const string LogText_Addon_WispLearned = "Moje bludièka umí najít tyto vìci:";
const string LogText_Addon_WispLearned_NF = "Zbranì na blízko";
const string LogText_Addon_WispLearned_FF = "Støelné zbranì a støelivo";
const string LogText_Addon_WispLearned_NONE = "Zlato, klíèe a dùležité pøedmìty";
...
const string LogText_Addon_Language_1 = "Ovládl jsem jazyk rolníkù. Je to základní øeè Stavitelù.";
const string LogText_Addon_Language_2 = "Ovládl jsem øeè váleèníkù.";
const string LogText_Addon_Language_3 = "Ovládl jsem øeè knìžstva.";
const string TOPIC_Bronkoeingeschuechtert = "Líný farmáø";
const string TOPIC_BalthasarsSchafe = "Zakázaná pastvina";
const string TOPIC_AkilsSLDStillthere = "Chudý farmáø";

var int TOPIC_END_AkilsSLDStillthere;

const string TOPIC_Wettsaufen = "Až do dna!";
const string TOPIC_GaanSchnaubi = "Ufunìná potvora";
...
const string TOPIC_SekobDMT = "Vyhoštìný farmáø";
...
const string TOPIC_FerrosSword = "Ferrosùv meè";
...
const string TOPIC_BrutusMeatbugs = "Strašlivá stvoøení ";
...
const string TOPIC_bringRosiBackToSekob = "Sekob ztratil svou ženu";
