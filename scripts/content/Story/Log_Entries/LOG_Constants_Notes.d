...
const string TOPIC_COOK = "Vaøení v Khorinisu.";
const string TOPIC_COOKJ = "Vaøení v jakendaru.";
const string TOPIC_COOKHU = "Vaøení v hornickém udolí.";
const string TOPIC_SKINHUN = "Výroba loveckých zbrojí v Khorinisu.";
const string TOPIC_BOWHUNT = "Výroba Støelných zbraní.";
const string TOPIC_ARROW = "Výroba Støeliva.";
