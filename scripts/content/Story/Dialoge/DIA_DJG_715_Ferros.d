...
func void DIA_DJG_715_Ferros_OldCamp_Info()
{
	...
	B_LogEntry(TOPIC_FerrosSword,"Kdesi u skøetù ztratil Ferros svùj meè - to bylo poøádnì hloupé.");
};
...
func void DIA_DJG_715_Ferros_OldCamp_Yes()
{
	...
	B_LogEntry(TOPIC_FerrosSword,"Ferros svùj meè nejspíš ztratil na vysokém útesu na jihu - tam, kde si skøeti rozbili své stany.");
	Info_ClearChoices(DIA_DJG_715_Ferros_OldCamp);
};
...
func void B_Ferros_FerrosAnySword_Yes2()
{
	...
	B_LogEntry(TOPIC_Teacher,"Ferros mi pomùže vylepšit sílu a obratnost.");
};
