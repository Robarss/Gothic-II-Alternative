...
instance DIA_Addon_Scatty_teach(C_Info)
{
	...
	permanent = TRUE;
	description = "Nauèit se dolovat zlato (Stojí: 2 VB - 10 procent)";
};
...
func void DIA_Addon_Scatty_teach_Info()
{
	...
	if(other.lp >= 1)
	{
		...
		AI_Output(self,other,"DIA_Addon_Scatty_teach_01_02");	//Každý kopáè má své vlastní triky jak ze skály získat nìjaké pìkné nugety.
		AI_Output(self,other,"DIA_Addon_Scatty_teach_01_03");	//A právì tyto triky odlišují dobré a špatné kopáèe.
