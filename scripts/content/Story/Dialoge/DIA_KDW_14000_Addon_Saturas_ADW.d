...
func void DIA_Addon_Saturas_AdanosZorn_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Saturas_AdanosZorn_14_03");	//Rhademes, syn vojevùdce Quarhodrona, znesvìtil chrám.
...
instance DIA_Addon_Saturas_BeliarsWeapon(C_Info)
{
	...
	description = "Našel jsem 'Beliarùv dráp'.";
};
...
func void DIA_Addon_Saturas_BeliarsWeapon_Info()
{
	...
	AI_Output(other,self,"DIA_Addon_Saturas_BeliarsWeapon_15_00");	//Našel jsem 'Beliarùv dráp'.
