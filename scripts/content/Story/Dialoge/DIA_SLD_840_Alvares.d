...
func void DIA_Alvares_HAUAB_Info()
{
	...
	B_LogEntry(TOPIC_AkilsSLDStillthere,"Akilovu farmu ohroûujÌ ûoldnÈ¯i.");
	AI_StopProcessInfos(self);
};
...
func void DIA_Alvares_ATTACK_Info()
{
	...
	Info_AddChoice(DIA_Alvares_ATTACK,"Chci se k v·m ûoldnÈ¯um p¯idat.",DIA_Alvares_ATTACK_Soeldner);
...
func void DIA_Alvares_ATTACK_Aerger()
{
	...
	AI_Output(self,other,"DIA_Alvares_ATTACK_Aerger_11_01");	//Ale my zase m·me problÈmy moc r·di. Urazili jsme pÏkn˝ kus cesty, jenom abysme nÏjakÈ vyvolali.
