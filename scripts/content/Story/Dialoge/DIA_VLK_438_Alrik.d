...
{
	AI_Output(other,self,"DIA_Alrik_SellWhat_15_00");	//NevÌö kde bych mohl koupit takovÌ oblek jako m·ö ty ?
	AI_Output(self,other,"DIA_Alrik_SellWhat_09_01");	//Ano a to p¯Ìmo u mÏ.
};
...
instance DIA_ALRIK_LEATHER(C_Info)
{
	...
	permanent = TRUE;
	description = "Koupit Vystuûenou tuniku. (500 zlaù·k˘)";
};
...
{
	AI_Output(other,self,"DIA_Alrik_LEATHER_15_00");	//DÌky za dobr˝ obchod.
	if(B_GiveInvItems(other,self,ItMi_Gold,500))
	{
		AI_Output(self,other,"DIA_Alrik_LEATHER_09_01");	//Bude se ti moc lÌbit.
		CreateInvItems(other,itar_geralt_addon,1);
		AI_PrintScreen("Zbroj od Alrika zÌsk·na.",-1,YPOS_ItemTaken,FONT_ScreenSmall,2);
		ALRIK_LEATHERBOUGHT = TRUE;
	}
	else
	{
		AI_Output(self,other,"DIA_Alrik_LEATHER_09_02");	//OdÏv m· svou cenu - a opravdu za to stojÌ. Takûe se vraù, aû d·ö dohromady dost zlata.
	};
};
