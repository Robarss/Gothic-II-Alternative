...
func void DIA_Addon_Quarhodron_Hello_erdbeben()
{
	...
	AI_Output(self,other,"DIA_Addon_Quarhodron_Hello_erdbeben_11_02");	//Adanosùv hnìv pøišel na Jharkendar, aby ztrestal bezvìrce.
...
{
	AI_Output(other,self,"DIA_Addon_Quarhodron_Hello_raven_15_00");	//Nìkdo vstoupil do Adanosova chrámu.
...
{
	AI_Output(other,self,"DIA_Addon_Quarhodron_Hello_tempel_15_00");	//Udìl mi vstup do Adanosova chrámu.
...
{
	AI_Output(other,self,"DIA_Addon_Quarhodron_Hello_schwert_15_00");	//Co se skrývá v Adanosovì chrámu?
...
{
	AI_Output(other,self,"DIA_Addon_Quarhodron_GibMirKey_15_00");	//Slyš, nìkdo se dostal svou vlastní mocí do Adansoova chrámu.
	...
	AI_Output(self,other,"DIA_Addon_Quarhodron_GibMirKey_11_02");	//To nemùže být pravda! Nejvyšší knìz KHARDIMON a JÁ jsme jediní v JHARKENDARU, kteøí ví, jak otevøít portál v Adanosovì chrámu.
