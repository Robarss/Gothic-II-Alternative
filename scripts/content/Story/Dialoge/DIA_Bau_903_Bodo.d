...
func void DIA_Bodo_Hallo_Info()
{
	...
	if(other.guild == GIL_NONE)
	{
		...
		AI_Output(self,other,"DIA_Bodo_Hallo_12_02");	//Kr·l si myslÌ, ûe m˘ûe jednoduöe odjet s ËÌmkoli. Ale my uû mu nic ned·me.
	};
...
func void DIA_Bodo_Cipher_Info()
{
	...
	AI_Output(self,other,"DIA_Bodo_Cipher_12_04");	//PoslednÌ dobou jsem na nÏj byl obzv·öù mil˝, protoûe vypadal, ûe slÌznul po¯·dnou pecku.
