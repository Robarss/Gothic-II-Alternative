...
{
	AI_Output(self,other,"DIA_Horas_EXIT_01_00");	//Nechù nad tebou Innos bdÌ.
...
{
	AI_Output(self,other,"DIA_Horas_Hello_01_00");	//Innos tÏ doprov·zej. Co pro tebe mohu udÏlat, poutnÌËe?
};
...
{
	AI_Output(other,self,"DIA_Horas_Job_15_00");	//Co tady dÏl·ö a co my muûeö nabÌdnout?
	AI_Output(self,other,"DIA_Horas_Job_01_01");	//Jsem ohniv˝ m·g. KnÏz naöeho boha Innose.
	AI_Output(self,other,"DIA_Horas_Job_01_02");	//A za nÏjak˝ ten drobn˝ ode mÏ takÈ m˘ûeö dostat mnohÈ uûiteËnÈ vÏci.
	Log_CreateTopic(TOPIC_CityTrader,LOG_NOTE);
	B_LogEntry(TOPIC_CityTrader,"Cestou do p¯ÌstaviötÏ m·g Horas prod·v· uûiteËnÈ magickÈ p¯edmÏty.");
};
...
{
	B_GiveTradeInv(self);
	AI_Output(other,self,"DIA_Horas_Trade_15_00");	//Ukaû mi svÈ zboûÌ.
};
