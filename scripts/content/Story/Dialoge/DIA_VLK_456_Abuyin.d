...
func void DIA_Abuyin_Mischung_Super()
{
	...
	AI_Output(self,other,"DIA_Abuyin_Mischung_Super_14_06");	//A kdyby jsi mìl zájem mùu ti prodat zajímavé zbranì, nìkteré z nich jsou z mého kraje.
...
func void DIA_Abuyin_Zukunft4_Trance()
{
	...
	AI_Output(self,other,"DIA_Abuyin_Zukunft4_Trance_13_02");	//(V transu)... chrám... leí osamocen v Adanosovì øíši... skrytı v mlze...
	AI_PlayAni(self,"T_HEASHOOT_2_STAND");
...
{
	B_GiveTradeInv(self);
	AI_Output(other,self,"DIA_Abuyin_TRADEII_15_00");	//Uka mi své zboí.
};
