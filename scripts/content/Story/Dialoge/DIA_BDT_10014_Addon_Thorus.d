...
func void DIA_Addon_Thorus_Speech_Info()
{
	...
	if(RavenIsDead == FALSE)
	{
		AI_Output(self,other,"DIA_Addon_Thorus_Speech_12_02");	//Teï jsi odstranil z cesty Bloodwyna. Ptám se sám sebe: Kdo další. Raven? Nebo já?
...
func void DIA_Addon_Thorus_Answer_Info()
{
	...
	{
		B_LogEntry(TOPIC_Addon_Sklaven,"Teï si promluvím ještì jednou se 'Strážcem otrokù', potom mùže Patrick a jeho hoši zmizet.");
	}
	else
	{
		B_LogEntry(TOPIC_Addon_Sklaven,"Poté co jsem promluvil se 'Strážcem otrokù', Patrick a jeho chlapi mùžou zmizet.");
	};
};
