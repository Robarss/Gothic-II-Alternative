...
func void DIA_Addon_Myxir_GeistTafel_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Myxir_GeistTafel_12_03");	//(zdrcenı) Oh Adanosi!
	...
	AI_Output(self,other,"DIA_Addon_Myxir_GeistTafel_12_08");	//Hrob váleèníka Quarhodrona leí na západì údolí.
	...
	Info_AddChoice(DIA_Addon_Myxir_GeistTafel,"Bratrstvo Spáèe neøíkalo jenom li.",DIA_Addon_Myxir_GeistTafel_psi);
};
...
{
	AI_Output(other,self,"DIA_Addon_Myxir_GeistTafel_psi_15_00");	//Bratrstvo Spáèe neøíkalo jenom li. A navíc jejich mysl ovládal Spáè.
	AI_Output(self,other,"DIA_Addon_Myxir_GeistTafel_psi_12_01");	//To nebyly jenom jejich li, to je nepravdìpodobné, byla to jejich víra.
	AI_Output(self,other,"DIA_Addon_Myxir_GeistTafel_psi_12_02");	//Slova byla spíše nepochopitelná, ne-li pøesvìdèivá. Byli ovlivnìní nadmìrnım pouíváním trávy z bain, kterou kouøili.
	AI_Output(self,other,"DIA_Addon_Myxir_GeistTafel_psi_12_03");	//Ovšem ten, kdo psal tyto kamenné desky, psal vše rozvánì a dopodrobna. A to mì pøesvìdèilo o tom, e je to pravda.
};
...
func void DIA_Addon_Myxir_GeistTafel_wie()
{
	...
	AI_Output(self,other,"DIA_Addon_Myxir_GeistTafel_wie_12_01");	//Najdi Quarhodronùv hrob na západì údolí.
