...
func void DIA_Randolph_SchwereLuft_Info()
{
	...
	B_LogEntry(TOPIC_AkilsSLDStillthere,"Akil˘v statek ohroûujÌ ûoldnÈ¯i.");
	B_NpcClearObsessionByDMT(self);
};
...
instance DIA_Randolph_Baltram(C_Info)
{
	...
	permanent = FALSE;
	description = "Poslal mÏ Baltram. M·m tu pro nÏj vyzvednou nÏjak˝ balÌk.";
};
...
{
	AI_Output(other,self,"DIA_Randolph_Baltram_15_00");	//Poslal mÏ Baltram. M·m tu pro nÏj vyzvednou nÏjak˝ balÌk.
...
func void DIA_Randolph_TAVERNE_Info()
{
	...
	AI_Output(self,other,"DIA_Randolph_TAVERNE_06_01");	//Jo, p¯esnÏ tak. Ale teÔ uû ne.
...
func void DIA_Randolph_WETTKAMPFZUENDE_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Randolph_WETTKAMPFZUENDE_06_01");	//P¯Ìmo matka vöech kocovin. A j· jÌ nem˘ûu zbavit. Uû nebudu chlastat, p¯Ìsah·m.
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Randolph_WETTKAMPFZUENDE_06_05");	//Vypad· to, ûe Rukhar nevstane zrovna brzo.
	};
	B_NpcClearObsessionByDMT(self);
};
...
instance DIA_Randolph_SAGITTAHEAL(C_Info)
{
	...
	description = "Tady. To by mÏlo zmÌrnit abstinenËnÌ p¯Ìznaky.";
};
