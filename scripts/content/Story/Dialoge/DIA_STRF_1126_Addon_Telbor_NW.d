...
func void DIA_Addon_Telbor_NW_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Telbor_NW_Hi_12_01");	//Hej, mùj zachránce! Ale teï se musím dát zase dohromady.
	if(!Npc_IsDead(Egill) && !Npc_IsDead(Ehnim))
	{
		AI_Output(self,other,"DIA_Addon_Telbor_NW_Hi_12_02");	//Hlavnì když teï dìlám s tìmito dvìma šílenými bratry. Chlape, myslíš, že to bylo opravdu tak špatné u tìch banditù?
	};
};
