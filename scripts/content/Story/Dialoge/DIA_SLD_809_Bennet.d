...
func void dia_bennet_melting_info()
{
	...
	if(hero.lp >= 15)
	{
		...
		AI_Output(self,other,"DIA_Bennet_LEA_12_01");	//Nejdøív rozehøej vıheò a potom vlo zbranì a nech je roztavit.
		AI_Output(self,other,"DIA_Bennet_LEA_12_02");	//Z rezavé zbranì se dá udìlat jedena surová ocel a u skøetích to samé, ale musíš poèkat dıl ne se roztavı.
		AI_Output(self,other,"DIA_Bennet_LEA_12_04");	//A je to, nejlepší je surová elezná ruda z té  se dá vyrobit mnohem víc surové ocele ale to zjistíš sám.
