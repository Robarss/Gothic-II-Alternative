...
{
	AI_Output(self,other,"B_Thorben_GetBlessings_06_00");	//Tak to jdi za Vatrasem, Adanosovým knìzem, a nech se od nìj požehnat.
	if((other.guild != GIL_KDF) && (other.guild != GIL_NOV) && (other.guild != GIL_PAL))
	{
	...
	B_LogEntry(TOPIC_Thorben,"Thorben se za mì pøimluví teprve tehdy, až si vyprosím požehnání od Adanosova a Innosova knìze.");
};
