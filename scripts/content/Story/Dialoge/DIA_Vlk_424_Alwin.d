...
instance DIA_ALWIN_JOB(C_Info)
{
	...
	permanent = FALSE;
	description = "M˘ûu si od tebe koupit nÏjakÈ maso?";
};
...
{
	AI_Output(other,self,"DIA_Alwin_Job_15_00");	//M˘ûu si od tebe koupit nÏjakÈ maso?
	AI_Output(self,other,"DIA_Alwin_Job_01_01");	//Ano pokud m·ö ËÌm platit nenÌ problem.
	AI_Output(self,other,"DIA_Alwin_Job_01_02");	//Tady najdeö jen to nejËerstvÏjöÌ zboûÌ.
	Log_CreateTopic(TOPIC_CityTrader,LOG_NOTE);
	B_LogEntry(TOPIC_CityTrader,"Cestou do p¯ÌstaviötÏ Alwin prod·v· maso.");
};
...
{
	B_GiveTradeInv(self);
	AI_Output(other,self,"DIA_Alwin_Trade_15_00");	//Ukaû mi svÈ zboûÌ.
};
