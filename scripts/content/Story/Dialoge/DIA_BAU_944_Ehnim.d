...
func void DIA_Ehnim_FELDARBEIT_Info()
{
	...
	AI_Output(self,other,"DIA_Ehnim_FELDARBEIT_12_02");	//MÏl by ses jen mÌt na pozoru p¯ed polnÌmi ök˘dci. Utrhnou ti ruku, ani nemrkneö.
};
...
func void DIA_Ehnim_MoleRatFett_Info()
{
	...
	AI_Output(self,other,"DIA_Ehnim_MoleRatFett_12_04");	//”, nic d˘leûit˝ho. Jen jsem chtÏl mluvit s Vinem o jeho palÌrnÏ.
...
{
	AI_Output(other,self,"DIA_Ehnim_MoleRatFett_was_15_00");	//PalÌrna? Jak· palÌrna?
	AI_Output(self,other,"DIA_Ehnim_MoleRatFett_was_12_01");	//”. Asi jsem to nemÏl ¯Ìkat. Vino byl na to svÈ malÈ tajemstvÌ vûdycky hodnÏ citliv˝.
	...
	B_LogEntry(TOPIC_FoundVinosKellerei,"Podle Ehnima se Vino st·le ukr˝v· v lesÌch poblÌû Akilova statku. Ale mechanismus dve¯Ì je zad¯en˝ a dokud jej nenamaûu krysokrtÌm s·dlem, dovnit¯ se nedostanu.");
...
func void DIA_Ehnim_MoleRatFett_was_Fett()
{
	...
	AI_Output(self,other,"DIA_Ehnim_MoleRatFett_was_Fett_12_01");	//Jo, jasnÏ. NejlepöÌ, co se tu d· sehnat. KrysokrtÌ s·dlo. P¯Ìöern· vÏc, to ti povÌm. Taky se pouûÌv· na promaz·nÌ lodnÌch dÏl.
