...
func void DIA_Pyrokar_FOUNDINNOSEYE_was_vatras()
{
	...
	AI_Output(self,other,"DIA_Pyrokar_FOUNDINNOSEYE_was_vatras_11_02");	//Vatras je Adanosùv sluebník. Vìdomosti toho vodního mága nám pøinesou trochu svìtla do tohoto temného èasu.
...
instance DIA_PYROKAR_ARMORBL(C_Info)
{
	...
	description = "Našel jsem tuhle stránku ale nemùu jí pøeèíst.";
};
...
{
	AI_Output(other,self,"DIA_Pyrokar_ARMORBL_15_00");	//Našel jsem tuhle stránku ale nemùu jí pøeèíst.
	AI_Output(self,other,"DIA_Pyrokar_ARMORBL_15_01");	//Neuvìøitelné jaké máš štìstí, tohle je prastará modlidba na posvìcení zbroje.
	AI_Output(self,other,"DIA_Pyrokar_ARMORBL_11_02");	//Je to napsané ve starem textu a schodou náhod jsem jeden s posledních na ostrovì kdo to pøeète.
	AI_Output(self,other,"DIA_Pyrokar_ARMORBL_11_03");	//jinak bys musel cestovat a na pevninu do klášteru v nordmaru.
	AI_Output(other,self,"DIA_Pyrokar_ARMORBL_15_04");	//Take muu posvìtit i zbroj, a jak to udìlám?
	AI_Output(self,other,"DIA_Pyrokar_ARMORBL_11_05");	//Pøeloím ti ten text a podle nìj se pomodli u svatynì.
	AI_Output(self,other,"DIA_Pyrokar_ARMORBL_11_06");	//Hlavnì nezapomen polívat pøi modlitbì svìcennou vodou paladinskou zbroj.
	AI_Output(self,other,"DIA_Pyrokar_ARMORBL_11_07");	//Takové pocty se dostalo málo paladinùm, a tímto poehnání innose se staneš nejmocnìjším paladinem kterého znám, hodnì štìstí.
