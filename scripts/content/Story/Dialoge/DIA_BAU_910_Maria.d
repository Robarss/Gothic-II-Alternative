...
instance DIA_Maria_Umsehen(C_Info)
{
	...
	permanent = FALSE;
	description = "Jen jsem si to chtÏl tady prohlÈdnout.";
};
...
instance DIA_Maria_BringPlate(C_Info)
{
	...
	permanent = FALSE;
	description = "M·m u sebe zlat˝ talÌ¯. NenÌ n·hodou tv˘j?";
};
...
func void DIA_Maria_BringPlate_Info()
{
	...
	AI_Output(other,self,"DIA_Maria_BringPlate_15_00");	//M·m u sebe zlat˝ talÌ¯. NenÌ n·hodou tv˘j?
...
instance DIA_Maria_AboutOnar(C_Info)
{
	...
	permanent = FALSE;
	description = "ÿekni mi nÏco o Onarovi.";
};
...
func void DIA_Maria_AboutOnar_Info()
{
	...
	AI_Output(self,other,"DIA_Maria_AboutOnar_17_02");	//ÿekla jsem svÈmu muûi, proË ty voj·ky nech·ö se sebou takhle zach·zet?
	...
	AI_Output(self,other,"DIA_Maria_AboutOnar_17_05");	//Ale mi vlastnÏ jsme ve v·lce, nebo ne?
};
