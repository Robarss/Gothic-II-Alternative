...
func void DIA_Ramirez_Success_Info()
{
	...
	AI_Output(self,other,"DIA_Ramirez_Success_14_02");	//Tady, ty penÌze si v·ûnÏ zaslouûÌö a jeötÏ ti d·m tuhle zbroj takhle se budeö lÌp pohybovat.
	CreateInvItems(other,itar_wma_assn,1);
	AI_PrintScreen("Ramirez ti daruje zlodÏjsou zbroj.",-1,YPOS_ItemTaken,FONT_ScreenSmall,2);
...
{
	B_GiveTradeInv(self);
	AI_Output(other,self,"DIA_Ramirez_TRADEI_15_00");	//Ukaû mi svÈ zboûÌ.
};
