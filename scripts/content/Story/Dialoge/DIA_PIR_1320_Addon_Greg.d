...
instance DIA_ADDON_GREG_SELLWHAT(C_Info)
{
	...
	permanent = FALSE;
	description = "Nemìl bys pro mì lepší zbroj?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Greg_SellWhat_15_00");	//Nemìl bys pro mì lepší zbroj?
	AI_Output(self,other,"DIA_Addon_Greg_SellWhat_09_01");	//Ano ale ne zadarmo jestli chceš nìco lepšího tak za 600 zlatıch, nejsem charita.
};
...
instance DIA_ADDON_GREG_LEATHER(C_Info)
{
	...
	permanent = TRUE;
	description = "Koupit Piratskou zbroj (600 zlaákù)";
};
...
func void dia_addon_greg_leather_info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Greg_LEATHER_09_01");	//Díky za dobrı obchod.
	...
	{
		AI_Output(self,other,"DIA_Addon_Greg_LEATHER_09_02");	//Odìv má svou cenu - a opravdu za to stojí. Take se vra, a dáš dohromady dost zlata.
	};
};
