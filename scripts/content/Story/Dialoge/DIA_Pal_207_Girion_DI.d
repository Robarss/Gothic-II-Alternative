...
instance DIA_GIRION_DI_TEACH2(C_Info)
{
	...
	permanent = TRUE;
	description = "(Boj ze ötÌtem. Poûadavek: 35% jednoruËnÌch zbranÌ, cena: 5 VB)";
};
...
func void dia_girion_di_teach2_info()
{
	...
	if((other.lp >= 5) && (hero.aivar[REAL_TALENT_1H] >= 35))
	{
		...
		PrintScreen("NauËil ses: Boj se ötÌtem",-1,-1,FONT_Screen,3);
	}
	else
	{
...
instance DIA_GIRION_DI_TEACH3(C_Info)
{
	...
	permanent = TRUE;
	description = "(Boj ze ötÌtem. Poûadavek: 65% jednoruËnÌch zbranÌ, cena: 10 VB)";
};
...
func void dia_girion_di_teach3_info()
{
	...
	if((other.lp >= 10) && (hero.aivar[REAL_TALENT_1H] >= 65))
	{
		...
		PrintScreen("NauËil ses: PokroËil˝ boj se ötÌtem",-1,-1,FONT_Screen,3);
	}
	else
	{
		B_Say(self,other,"$NOLEARNNOPOINTS");
...
instance DIA_GIRION_DI_TEACH4(C_Info)
{
	...
	permanent = TRUE;
	description = "(Boj ze ötÌtem. Poûadavek: 90% jednoruËnÌch zbranÌ, cena: 15 VB)";
};
...
func void dia_girion_di_teach4_info()
{
	...
	if((other.lp >= 15) && (hero.aivar[REAL_TALENT_1H] >= 90))
	{
		...
		PrintScreen("NauËil ses: Mistrovsky boj se ötÌtem",-1,-1,FONT_Screen,3);
	}
	else
	{
		B_Say(self,other,"$NOLEARNNOPOINTS");
