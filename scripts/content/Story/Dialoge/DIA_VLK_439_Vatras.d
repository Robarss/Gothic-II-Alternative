...
func void DIA_Vatras_GREET_Info()
{
	...
	AI_Output(self,other,"DIA_Vatras_GREET_05_02");	//Jsem Vatras, sluebník Adanosùv, stráce boské i pozemské rovnováhy.
...
func void DIA_Vatras_INFLUENCE_Info()
{
	...
	AI_Output(self,other,"DIA_Vatras_INFLUENCE_REPEAT_05_11");	//Jdi s Adanosovım poehnáním, synu!
	Snd_Play("LevelUp");
...
func void DIA_Vatras_Spende_Info()
{
	...
	AI_Output(self,other,"DIA_Vatras_Spende_05_01");	//Darem Adanosovu chrámu smyješ èást høíchù, které jsi moná spáchal, synu.
...
func void DIA_Vatras_Spende_50()
{
	...
	AI_Output(self,other,"DIA_Vatras_Spende_50_05_01");	//Dìkuji ti ve jménu Adanose, synu. Tvé zlato bude rozdìleno mezi potøebné.
...
func void DIA_Vatras_Spende_100()
{
	...
	AI_Output(self,other,"DIA_Vatras_Spende_100_05_01");	//Za tento šlechetnı èin ti ve jménu Adanose ehnám!
	Snd_Play("LevelUp");
...
func void DIA_Vatras_CanTeach_Info()
{
	...
	AI_Output(self,other,"DIA_Vatras_CanTeach_05_01");	//Pouze vyvolenım Innose nebo Adanose je dovoleno pouívat runovou magii.
...
{
	AI_Output(other,self,"DIA_Vatras_GODS_ADANOS_15_00");	//Øekni mi nìco o Adanosovi.
	...
	AI_Output(self,other,"DIA_Vatras_GODS_ADANOS_05_03");	//Jeho knìí jsou vodní mágové, stejnì jako já jsem sluebníkem a knìzem Adanosovım.
	Info_ClearChoices(DIA_Vatras_GODS);
	Info_AddChoice(DIA_Vatras_GODS,Dialog_Back,DIA_Vatras_GODS_BACK);
	Info_AddChoice(DIA_Vatras_GODS,"Øekni mi nìco o Innosovi.",DIA_Vatras_GODS_INNOS);
	Info_AddChoice(DIA_Vatras_GODS,"Øekni mi nìco o Adanovi.",DIA_Vatras_GODS_ADANOS);
...
func void DIA_Vatras_HEAL_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Vatras_HEAL_05_01");	//(zbonì) Adanosi poehnej tomuto tìlu. Zbav ho jeho zranìní a posil ho novım ivotem.
...
func void DIA_Vatras_INNOSEYEKAPUTT_Auge_Stein_Wer()
{
	...
	AI_Output(self,other,"DIA_Vatras_INNOSEYEKAPUTT_Auge_Stein_Wer_05_01");	//Adanose bych mìl zastupovat já sám.
