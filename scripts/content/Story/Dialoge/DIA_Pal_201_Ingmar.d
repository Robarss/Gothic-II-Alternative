...
func void dia_ingmar_sellwhat_info()
{
	...
	AI_Output(self,other,"DIA_Ingmar_SellWhat_09_01");	//U mì, mùžu ti jí vylepšit jen potøebuji tvojí KOMPLETNÍ rytíøskou zbroj a zlato ale u tebe to je zdarma protože muži jako ty se nám hodí.
};
...
{
	AI_Output(other,self,"DIA_Ingmar_LEATHER_15_00");	//Vylepši my rytíøskou zbroj.
	...
	{
		AI_Output(self,other,"DIA_Ingmar_LEATHER_09_02");	//Bez KOMPLETNÍ rytíøské zbroje ti jí nevylepším.
	};
};
