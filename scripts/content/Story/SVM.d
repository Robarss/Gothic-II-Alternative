...
instance SVM_1(C_SVM)
{
	...
	Weather = "SVM_1_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_1_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	ShitNoGold = "SVM_1_ShitNoGold";	//Ten mizera u sebe nemá ádné zlato.
	...
	StopMagic = "SVM_1_StopMagic";	//Nepøibliuj se ke mnì s tím magickım svinstvem!
	...
	sheepkiller_crime = "SVM_1_SHEEPKILLER_CRIME";	//Takhle vradit naše ovce! Vypadni, vole!
	...
	mil_city_crime = "SVM_1_MIL_CITY_CRIME";	//Jsi ostudou mìstskıch stráí! Lord Andre tì ještì nauèí zpùsobùm!
	...
	Smalltalk01 = "SVM_1_Smalltalk01";	//... vánì si myslíš...
	Smalltalk02 = "SVM_1_Smalltalk02";	//... všechno je moné...
	...
	Smalltalk07 = "SVM_1_Smalltalk07";	//... drbalo se tam o všem moném...
	...
	Smalltalk20 = "SVM_1_Smalltalk20";	//... u to nemùe nic zmìnit...
	...
	Smalltalk29 = "SVM_1_Smalltalk29";	//... vdycky jsem konal ve jménu Innose...
	Smalltalk30 = "SVM_1_Smalltalk30";	//... nikdo se nesmí protivit vùli boí...
	...
	NoLearnYoureBetter = "SVM_1_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_1_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_1_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_1_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_1_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_1_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_1_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_1_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_1_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_1_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	...
	addon_wrongarmor_sld = "SVM_1_ADDON_WRONGARMOR_SLD";	//Jak tu chodíš? Nasaï nìjaké správné šaty, jo?
	addon_wrongarmor_mil = "SVM_1_ADDON_WRONGARMOR_MIL";	//Jsi voják! Oblékni se podle toho!
	addon_wrongarmor_kdf = "SVM_1_ADDON_WRONGARMOR_KDF";	//Tvoje zbroj se nehodí k našemu øádu. Zmìò si ji!
	addon_noarmor_bdt = "SVM_1_ADDON_ADDON_NOARMOR_BDT";	//Ty nemáš dokonce brnìní. Tak si pro nì bì!
	addon_diebandit = "SVM_1_ADDON_DIEBANDIT";	//Zemøi, banditskej neøáde!
	addon_dirtypirate = "SVM_1_ADDON_DIRTYPIRATE";	//Pirátskej neøáde!
};
...
instance SVM_3(C_SVM)
{
	...
	Weather = "SVM_3_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_3_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	EnemyKilled = "SVM_3_EnemyKilled";	//Zaslouil sis to, nièemo!
	...
	RunCoward = "SVM_3_RunCoward";	//(køièí) Jo! Utíkej, jak nejrychleji mùeš!
	...
	ISaidStopMagic = "SVM_3_ISaidStopMagic";	//Chceš napráskat? Okamitì s tím pøestaò!!!
	...
	sheepkiller_crime = "SVM_3_SHEEPKILLER_CRIME";	//Takhle vradit naše ovce!
	...
	mil_city_crime = "SVM_3_MIL_CITY_CRIME";	//Jsi ostudou mìstskıch stráí! Poèkej, a se o tom dozví lord Andre!
	...
	farm_crime = "SVM_3_FARM_CRIME";	//Poèkej, a se to donese k Leeovi...
	...
	Smalltalk01 = "SVM_3_Smalltalk01";	//... vánì si myslíš...
	Smalltalk02 = "SVM_3_Smalltalk02";	//... všechno je moné...
	...
	Smalltalk07 = "SVM_3_Smalltalk07";	//... drbalo se tam o všem moném...
	...
	Smalltalk20 = "SVM_3_Smalltalk20";	//... u to nemùe nic zmìnit...
	...
	Smalltalk29 = "SVM_3_Smalltalk29";	//... vdycky jsem konal ve jménu Innose...
	Smalltalk30 = "SVM_3_Smalltalk30";	//... nikdo se nesmí protivit vùli boí...
	...
	NoLearnYoureBetter = "SVM_3_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_3_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_3_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_3_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_3_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_3_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_3_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_3_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_3_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_3_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_3_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_3_Aargh_1";	//Aargh
	Aargh_2 = "SVM_3_Aargh_2";	//Aargh
	Aargh_3 = "SVM_3_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_3_Addon_WrongArmor";	//Co to máš za odìv? To se nehodí. Nechej mì na pokoji.
	addon_wrongarmor_sld = "SVM_3_ADDON_WRONGARMOR_SLD";	//Co to máš za odìv? To se nehodí. Nechej mì na pokoji.
	addon_wrongarmor_mil = "SVM_3_ADDON_WRONGARMOR_MIL";	//Co to máš za odìv? To se nehodí. Nechej mì na pokoji.
	addon_wrongarmor_kdf = "SVM_3_ADDON_WRONGARMOR_KDF";	//V našem øádu jsme si všichni rovni, proto nosíme stejné roucho. Zmìò si odìv!
	addon_noarmor_bdt = "SVM_3_ADDON_ADDON_NOARMOR_BDT";	//V našem øádu jsme si všichni rovni, proto nosíme stejné roucho. Zmìò si odìv!
	addon_diebandit = "SVM_3_ADDON_DIEBANDIT";	//POJÏ SEM, BANDITO!
	addon_dirtypirate = "SVM_3_ADDON_DIRTYPIRATE";	//POJÏ SEM, PIRÁTE!
};
...
instance SVM_4(C_SVM)
{
	...
	Weather = "SVM_4_Weather";	//Zatracenı neèas!
	...
	SheepKillerMonster = "SVM_4_SheepKillerMonster";	//Ta obluda vradí naše ovce!
	...
	ThenIBeatYouOutOfHere = "SVM_4_ThenIBeatYouOutOfHere";	//Mám dojem, e by nìkterım lidem neuškodilo, kdyby poznali trochu tvrdosti.
	...
	EnemyKilled = "SVM_4_EnemyKilled";	//Takovej hloupej bastard...
	MonsterKilled = "SVM_4_MonsterKilled";	//Dobrá, to na tebe bylo trochu moc, co, ty mizerná bestie!
	ThiefDown = "SVM_4_ThiefDown";	//Okamitì dej ty svı špinavı pracky pryè z mejch vìcí, jasnı?
	RumfummlerDown = "SVM_4_rumfummlerDown";	//Hlídej si ty svoje ukoptìnı prsty!
	SheepAttackerDown = "SVM_4_SheepAttackerDown";	//Okamitì dej ty svoje umounìnı pracky pryè od našich ovcí!
	...
	LookingForTroubleAgain = "SVM_4_LookingForTroubleAgain";	//(agresivnì) Chceš ještì nìjakou další teèku?
	StopMagic = "SVM_4_StopMagic";	//Pøestaò s tím magickım svinstvem!
	ISaidStopMagic = "SVM_4_ISaidStopMagic";	//Chceš napráskat? Okamitì s tím pøestaò!!!
	...
	abs_monastery = "SVM_4_ABS_MONASTERY";	//Tak jsi uèinil pokání u otce Parlana.
	abs_farm = "SVM_4_ABS_FARM";	//Slyšel jsem, e Lee dal ty vìci do poøádku.
	abs_good = "SVM_4_ABS_GOOD";	//Dobrá.
	sheepkiller_crime = "SVM_4_SHEEPKILLER_CRIME";	//Vradìní ovcí je u pøíliš! Ztra se!
	...
	mil_city_crime = "SVM_4_MIL_CITY_CRIME";	//Jak se nìkdo jako ty mohl dostat k mìstskım stráím? Lord Andre ti to ještì spoèítá!
	...
	Smalltalk01 = "SVM_4_Smalltalk01";	//... vánì je to tak...
	...
	Smalltalk07 = "SVM_4_Smalltalk07";	//... u mì nemùe nic pøekvapit...
	Smalltalk08 = "SVM_4_Smalltalk08";	//... to vánì není mùj problém...
	...
	Smalltalk13 = "SVM_4_Smalltalk13";	//... pokud to sám nevidí, nemùu mu nijak pomoct...
	...
	Smalltalk20 = "SVM_4_Smalltalk20";	//... nic nezmìní...
	...
	Smalltalk25 = "SVM_4_Smalltalk25";	//... situace je váná, tak mi neøíkej, e...
	Smalltalk26 = "SVM_4_Smalltalk26";	//... ještì ani nevìdìl, jak poøádnì dret meè...
	Smalltalk27 = "SVM_4_Smalltalk27";	//... jo, vánì øekl, e...
	...
	NoLearnYoureBetter = "SVM_4_NoLearnYoureBetter";	//U tì nemùu nauèit nic dalšího. ák pøekonal svého uèitele.
	...
	markt = "SVM_4_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_4_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_4_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_4_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_4_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_4_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_4_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_4_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_4_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_4_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_4_Aargh_1";	//Aargh
	Aargh_2 = "SVM_4_Aargh_2";	//Aargh
	Aargh_3 = "SVM_4_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_4_Addon_WrongArmor";	//Zmìò si na nìjaké poøádné šaty, pak budu pokraèovat v mluvení.
	addon_wrongarmor_sld = "SVM_4_ADDON_WRONGARMOR_SLD";	//Nos svoje zatracené brnìní, jestli chceš mluvit se mnou!
	addon_wrongarmor_mil = "SVM_4_ADDON_WRONGARMOR_MIL";	//To ti nikdo nedal alespoò to jedno brnìní? Tak si jedno seeò.
	addon_wrongarmor_kdf = "SVM_4_ADDON_WRONGARMOR_KDF";	//Kde máš šaty? Pøevleè se. Pak s tebou budu mluvit.
	addon_noarmor_bdt = "SVM_4_ADDON_ADDON_NOARMOR_BDT";	//Co jsi to za chudáka? Vra se, a si seeneš své brnìní.
	addon_diebandit = "SVM_4_ADDON_DIEBANDIT";	//Další bandita!
	addon_dirtypirate = "SVM_4_ADDON_DIRTYPIRATE";	//Špinavı piráte!
};
...
instance SVM_5(C_SVM)
{
	...
	Weather = "SVM_5_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_5_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	StopMagic = "SVM_5_StopMagic";	//Nepøibliuj se ke mnì s tím magickım svinstvem!
	...
	OhMyGodItsAFight = "SVM_5_OhMyGodItsAFight";	//(vystrašenì) Ale vdy si navzájem vytluèou mozek z hlavy.
	...
	sheepkiller_crime = "SVM_5_SHEEPKILLER_CRIME";	//Takhle vradit naše ovce! Vypadni, vole!
	...
	mil_city_crime = "SVM_5_MIL_CITY_CRIME";	//Jsi ostudou mìstskıch stráí! Lord Andre tì ještì nauèí zpùsobùm!
	...
	Smalltalk01 = "SVM_5_Smalltalk01";	//... vánì si myslíš...
	Smalltalk02 = "SVM_5_Smalltalk02";	//... všechno je moné...
	...
	Smalltalk07 = "SVM_5_Smalltalk07";	//... drbalo se tam o všem moném...
	...
	Smalltalk20 = "SVM_5_Smalltalk20";	//... u to nemùe nic zmìnit...
	...
	Smalltalk29 = "SVM_5_Smalltalk29";	//... vdycky jsem konal ve jménu Innose...
	Smalltalk30 = "SVM_5_Smalltalk30";	//... nikdo se nesmí protivit vùli boí...
	...
	NoLearnYoureBetter = "SVM_5_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_5_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_5_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_5_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_5_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_5_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_5_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_5_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_5_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_5_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_5_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_5_Aargh_1";	//Aargh
	Aargh_2 = "SVM_5_Aargh_2";	//Aargh
	Aargh_3 = "SVM_5_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_5_Addon_WrongArmor";	//Zmìò si na nìjaké vhodné šaty.
	addon_wrongarmor_sld = "SVM_5_ADDON_WRONGARMOR_SLD";	//Jak mám chodit poøád dokola? Patøíš k nám krátce? Pak s tebou chci mít nìco spoleèného.
	addon_wrongarmor_mil = "SVM_5_ADDON_WRONGARMOR_MIL";	//My vojáci bojujeme za krále, proto nosíme jeho zbroje, mohl bys?
	addon_wrongarmor_kdf = "SVM_5_ADDON_WRONGARMOR_KDF";	//Proè ti øád dává šatstvo, kdy je nenosíš? Mysli na to.
	addon_noarmor_bdt = "SVM_5_ADDON_ADDON_NOARMOR_BDT";	//Co jsi to za hejska? Vdy ani nemáš zbroj. Odejdi.
	addon_diebandit = "SVM_5_ADDON_DIEBANDIT";	//Oh, bandita.
	addon_dirtypirate = "SVM_5_ADDON_DIRTYPIRATE";	//Já tì sváu, piráte!
};
...
instance SVM_6(C_SVM)
{
	...
	Weather = "SVM_6_Weather";	//Zatracenı neèas!
	...
	SheepAttackerDown = "SVM_6_SheepAttackerDown";	//A u se k našim ovcím nepøibliuj!
	KillMurderer = "SVM_6_KillMurderer";	//Chcípni, grázle!
	StupidBeastKilled = "SVM_6_StupidBeastKilled";	//To je ale zatracenì hnusná zrùda!
	NeverHitMeAgain = "SVM_6_NeverHitMeAgain";	//Neopovauj se na mì znovu zaútoèit!
	...
	OhMyGodItsAFight = "SVM_6_OhMyGodItsAFight";	//(vydìšenì) Ó, mùj boe...
	...
	sheepkiller_crime = "SVM_6_SHEEPKILLER_CRIME";	//Ty vradíš ovce? Pøedpokládám, e se ti nepodaøilo najít nikoho bezbrannìjšího?
	...
	mil_city_crime = "SVM_6_MIL_CITY_CRIME";	//Vánì se chceš stát èlenem mìstskıch stráí? Lord Andre tì v tom nehodlá podpoøit!
	city_crime = "SVM_6_CITY_CRIME";	//Zajdi za lordem Andrem, dokud mùeš.
	mona_crime = "SVM_6_MONA_CRIME";	//Zajdi za otcem Parlanem. Pomùe ti odèinit tvé høíchy!
	...
	Smalltalk13 = "SVM_6_Smalltalk13";	//... vánì si nezaslouil, aby...
	...
	Smalltalk25 = "SVM_6_Smalltalk25";	//... bìel, jako by mu byl v patách samotnı Beliar...
	...
	Smalltalk29 = "SVM_6_Smalltalk29";	//... protoe je to vùle Innosova...
	...
	NoLearnYoureBetter = "SVM_6_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_6_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_6_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_6_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_6_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_6_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_6_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_6_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_6_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_6_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_6_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_6_Aargh_1";	//Aargh
	Aargh_2 = "SVM_6_Aargh_2";	//Aargh
	Aargh_3 = "SVM_6_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_6_Addon_WrongArmor";	//V tìchto hadrech dìláš ze sebe smìšného. Zmìò si je na správné!
	addon_wrongarmor_sld = "SVM_6_ADDON_WRONGARMOR_SLD";	//Ty si myslíš, e tì nepoznám? Ztra se a zmìò si šaty!
	addon_wrongarmor_mil = "SVM_6_ADDON_WRONGARMOR_MIL";	//Vojáku! Co to máš za odìv? Pøevleè se hned!
	addon_wrongarmor_kdf = "SVM_6_ADDON_WRONGARMOR_KDF";	//Innosùv sluebník se neskryje. Jdi si pro své šaty.
	addon_noarmor_bdt = "SVM_6_ADDON_ADDON_NOARMOR_BDT";	//Pobíháš jako kopáè. Obleè se poøádnì.
	addon_diebandit = "SVM_6_ADDON_DIEBANDIT";	//Jsi pøepaden zlı hochu, BANDITA!
	addon_dirtypirate = "SVM_6_ADDON_DIRTYPIRATE";	//Vra se na moøe, PIRÁTE!
};
...
instance SVM_7(C_SVM)
{
	...
	Weather = "SVM_7_Weather";	//Zatracenı neèas!
	...
	SheepKillerMonster = "SVM_7_SheepKillerMonster";	//Ta obluda vradí naše ovce!
	...
	ThenIBeatYouOutOfHere = "SVM_7_ThenIBeatYouOutOfHere";	//Mám dojem, e by nìkterım lidem neuškodilo, kdyby poznali trochu tvrdosti.
	...
	EnemyKilled = "SVM_7_EnemyKilled";	//Takovej hloupej bastard...
	MonsterKilled = "SVM_7_MonsterKilled";	//Dobrá, to na tebe bylo trochu moc, co, ty mizerná bestie!
	ThiefDown = "SVM_7_ThiefDown";	//Okamitì dej ty svı špinavı pracky pryè z mejch vìcí, jasnı?
	RumfummlerDown = "SVM_7_rumfummlerDown";	//Hlídej si ty svoje ukoptìnı prsty!
	SheepAttackerDown = "SVM_7_SheepAttackerDown";	//Okamitì dej ty svoje umounìnı pracky pryè od našich ovcí!
	...
	LookingForTroubleAgain = "SVM_7_LookingForTroubleAgain";	//(agresivnì) Chceš ještì nìjakou další teèku?
	StopMagic = "SVM_7_StopMagic";	//Pøestaò s tím magickım svinstvem!
	ISaidStopMagic = "SVM_7_ISaidStopMagic";	//Chceš napráskat? Okamitì s tím pøestaò!!!
	...
	sheepkiller_crime = "SVM_7_SHEEPKILLER_CRIME";	//Vradìní ovcí je u pøíliš! Ztra se!
	...
	mil_city_crime = "SVM_7_MIL_CITY_CRIME";	//Jak se nìkdo jako ty mohl dostat k mìstskım stráím? Lord Andre ti to ještì spoèítá!
	...
	Smalltalk01 = "SVM_7_Smalltalk01";	//... vánì je to tak...
	...
	Smalltalk07 = "SVM_7_Smalltalk07";	//... u mì nemùe nic pøekvapit...
	Smalltalk08 = "SVM_7_Smalltalk08";	//... to vánì není mùj problém...
	...
	Smalltalk13 = "SVM_7_Smalltalk13";	//... pokud to sám nevidí, nemùu mu nijak pomoct...
	...
	Smalltalk25 = "SVM_7_Smalltalk25";	//... situace je váná, tak mi neøíkej, e...
	Smalltalk26 = "SVM_7_Smalltalk26";	//... ještì ani nevìdìl, jak poøádnì dret meè...
	Smalltalk27 = "SVM_7_Smalltalk27";	//... jo, vánì øekl, e...
	...
	NoLearnYoureBetter = "SVM_7_NoLearnYoureBetter";	//U tì nemùu nauèit nic dalšího. ák pøekonal svého uèitele.
	...
	markt = "SVM_7_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_7_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_7_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_7_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_7_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_7_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_7_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_7_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_7_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_7_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_7_Aargh_1";	//Aargh
	Aargh_2 = "SVM_7_Aargh_2";	//Aargh
	Aargh_3 = "SVM_7_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_7_Addon_WrongArmor";	//Proè se pøevlékáš? Já nebudu mluvit s tebou takto obleèenım.
	addon_wrongarmor_sld = "SVM_7_ADDON_WRONGARMOR_SLD";	//Co zde chodíš? Nos naši zbroj!
	addon_wrongarmor_mil = "SVM_7_ADDON_WRONGARMOR_MIL";	//Toto je neplnìní našeho armádního oblékacího zákona. Pøevleè se ihned.
	addon_wrongarmor_kdf = "SVM_7_ADDON_WRONGARMOR_KDF";	//Mìl bys lépe nosit svı odìv. Do té doby se za tebe budu modlit.
	addon_noarmor_bdt = "SVM_7_ADDON_ADDON_NOARMOR_BDT";	//Co chceš? Nepatøíš k nám. Nenosíš naši zbroj.
	addon_diebandit = "SVM_7_ADDON_DIEBANDIT";	//Zemøi, hanebnı bandito!
	addon_dirtypirate = "SVM_7_ADDON_DIRTYPIRATE";	//Zemøi, ubohı piráte!
};
...
instance SVM_8(C_SVM)
{
	...
	Weather = "SVM_8_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_8_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	EnemyKilled = "SVM_8_EnemyKilled";	//Zaslouil sis to, nièemo!
	...
	RunCoward = "SVM_8_RunCoward";	//(køièí) Jo! Utíkej, jak nejrychleji mùeš!
	...
	ISaidStopMagic = "SVM_8_ISaidStopMagic";	//Chceš napráskat? Okamitì s tím pøestaò!!!
	...
	NextTimeYoureInForIt = "SVM_8_NextTimeYoureInForIt";	//(pro sebe) Dobrá, pøíštì se ukáe.
	OhMyHead = "SVM_8_OhMyHead";	//(pro sebe) No nazdar, moje hlava...
	TheresAFight = "SVM_8_TheresAFight";	//(nedoèkavì) Aaa, boj!
	OhMyGodItsAFight = "SVM_8_OhMyGodItsAFight";	//(vystrašenì) Boínku, boj!
	GoodVictory = "SVM_8_GoodVictory";	//(zlı smích) Tak jsi mu to ukázal!
	NotBad = "SVM_8_NotBad";	//(souhlasnì) To nebylo špatné.
	OhMyGodHesDown = "SVM_8_OhMyGodHesDown";	//(pro sebe) Mùj boe! Taková krutost...
	...
	sheepkiller_crime = "SVM_8_SHEEPKILLER_CRIME";	//Takhle vradit naše ovce!
	...
	mil_city_crime = "SVM_8_MIL_CITY_CRIME";	//Jsi ostudou mìstskıch stráí! Poèkej, a se o tom dozví lord Andre!
	...
	toughguy_attackwon = "SVM_8_TOUGHGUY_ATTACKWON";	//U(arogantnì) Mám dojem, e u ti musí bıt jasné, kdo je tady ten silnìjší... Co chceš?
	...
	Smalltalk01 = "SVM_8_Smalltalk01";	//... vánì je to tak...
	...
	Smalltalk07 = "SVM_8_Smalltalk07";	//... u mì nemùe nic pøekvapit...
	Smalltalk08 = "SVM_8_Smalltalk08";	//... to vánì není mùj problém...
	...
	Smalltalk13 = "SVM_8_Smalltalk13";	//... pokud to sám nevidí, nemùu mu nijak pomoct...
	...
	Smalltalk25 = "SVM_8_Smalltalk25";	//... situace je váná, tak mi neøíkej, e...
	Smalltalk26 = "SVM_8_Smalltalk26";	//... ještì ani nevìdìl, jak poøádnì dret meè...
	Smalltalk27 = "SVM_8_Smalltalk27";	//... jo, vánì øekl, e...
	...
	NoLearnYoureBetter = "SVM_8_NoLearnYoureBetter";	//U tì nemùu nauèit nic dalšího. ák pøekonal svého uèitele.
	...
	markt = "SVM_8_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_8_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_8_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_8_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_8_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_8_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_8_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_8_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_8_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_8_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_8_Aargh_1";	//Aargh
	Aargh_2 = "SVM_8_Aargh_2";	//Aargh
	Aargh_3 = "SVM_8_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_8_Addon_WrongArmor";	//Nevìøím ti. Nìco je špatnì s tebou nebo s tvımi šaty.
	addon_wrongarmor_sld = "SVM_8_ADDON_WRONGARMOR_SLD";	//Ze vzhledu, jsi se asi pøidal nìkde jinde? Nechci s tebou nic mít.
	addon_wrongarmor_mil = "SVM_8_ADDON_WRONGARMOR_MIL";	//Musíme ukázat, e jsme zde. Proto jdi a dostaò svoji zbroj.
	addon_wrongarmor_kdf = "SVM_8_ADDON_WRONGARMOR_KDF";	//Innos chce, aby jsme nosily jeho šaty s pıchou. Jdi a zmìò si je.
	addon_noarmor_bdt = "SVM_8_ADDON_ADDON_NOARMOR_BDT";	//Já nehovoøím s kopáèi. Namáš teï zbroj!
	addon_diebandit = "SVM_8_ADDON_DIEBANDIT";	//Ty špinavı bandito!
...
instance SVM_9(C_SVM)
{
	...
	Weather = "SVM_9_Weather";	//Zatracenı neèas!
	...
	Addon_DieMonster = "SVM_9_Addon_DieMonster";	//Další z tìch pøíšer!
	Addon_DieMonster2 = "SVM_9_Addon_DieMonster2";	//Tam! Další hnusná pøíšera!
	...
	Addon_MonsterKilled = "SVM_9_Addon_MonsterKilled";	//Pokud jde o tebe, hovado!
	Addon_MonsterKilled2 = "SVM_9_Addon_MonsterKilled2";	//DALŠÍ hnusná pøíšera pøišla!
	...
	SheepAttackerDown = "SVM_9_SheepAttackerDown";	//A u se k našim ovcím nepøibliuj!
	KillMurderer = "SVM_9_KillMurderer";	//Chcípni, grázle!
	StupidBeastKilled = "SVM_9_StupidBeastKilled";	//Ta je ale zatracenì tupá stvùra!
	NeverHitMeAgain = "SVM_9_NeverHitMeAgain";	//Neopovauj se na mì znovu zaútoèit!
	...
	OhMyGodItsAFight = "SVM_9_OhMyGodItsAFight";	//(vydìšenì) Ó mùj boe...
	...
	abs_farm = "SVM_9_ABS_FARM";	//Tak ses setkal s Leem a urovnal tu záleitost.
	abs_good = "SVM_9_ABS_GOOD";	//Dobrá.
	sheepkiller_crime = "SVM_9_SHEEPKILLER_CRIME";	//Ty vradíš ovce? Pøedpokládám, e se ti nepodaøilo najít nikoho bezbrannìjšího?
	...
	mil_city_crime = "SVM_9_MIL_CITY_CRIME";	//Vánì se chceš stát èlenem mìstskıch stráí? Lord Andre tì v tom nehodlá podpoøit!
	city_crime = "SVM_9_CITY_CRIME";	//Zajdi za lordem Andrem, dokud mùeš.
	mona_crime = "SVM_9_MONA_CRIME";	//Zajdi za otcem Parlanem. Pomùe ti odèinit tvé høíchy!
	...
	Smalltalk01 = "SVM_9_Smalltalk01";	//... nemùu tomu uvìøit...
	Smalltalk02 = "SVM_9_Smalltalk02";	//... nebyl bych si tak jistı...
	Smalltalk03 = "SVM_9_Smalltalk03";	//... ale on ví, e všichni...
	Smalltalk04 = "SVM_9_Smalltalk04";	//... stìí vím, komu mám vìøit...
	...
	Smalltalk13 = "SVM_9_Smalltalk13";	//... vánì si nezaslouil, aby...
	...
	Smalltalk22 = "SVM_9_Smalltalk22";	//... mùeme leda èekat, co se stane...
	Smalltalk23 = "SVM_9_Smalltalk23";	//... vìdìl jsem, e nás èekají problémy...
	Smalltalk24 = "SVM_9_Smalltalk24";	//... tak proè mì neposlouchal...
	Smalltalk25 = "SVM_9_Smalltalk25";	//... bìel, jako by mu byl v patách samotnı Beliar...
	...
	Smalltalk29 = "SVM_9_Smalltalk29";	//... protoe je to vùle Innosova...
	Smalltalk30 = "SVM_9_Smalltalk30";	//... jeho skutky byly jen...
	NoLearnNoPoints = "SVM_9_NoLearnNoPoints";	//Vra se, a získáš víc zkušeností.
	NoLearnOverPersonalMAX = "SVM_9_NoLearnOverPersonalMAX";	//Chceš po mnì víc, ne tì mùu nauèit.
	...
	markt = "SVM_9_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_9_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_9_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš od kovárny dostat na chrámové námìstí.
	...
	tempel_2_markt = "SVM_9_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_9_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_9_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_9_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_9_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_9_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_9_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_9_Aargh_1";	//Aargh
	Aargh_2 = "SVM_9_Aargh_2";	//Aargh
	Aargh_3 = "SVM_9_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_9_Addon_WrongArmor";	//Co je to za kostım? Nos nìco, co se k tobì hodí.
	addon_wrongarmor_sld = "SVM_9_ADDON_WRONGARMOR_SLD";	//Jak tì mám obcházet? Nos svou zbroj!
	addon_wrongarmor_mil = "SVM_9_ADDON_WRONGARMOR_MIL";	//Pracuješ pro krále, proto také máš nosit jeho zbroj! Jdi se pøevléct!
	addon_wrongarmor_kdf = "SVM_9_ADDON_WRONGARMOR_KDF";	//Tvoje obleèení není vhodné k našemu øádu. Zmìò si šaty!
	addon_noarmor_bdt = "SVM_9_ADDON_ADDON_NOARMOR_BDT";	//Vy dokonce nemáte zbroj. Tak si pro ni bìte!
	addon_diebandit = "SVM_9_ADDON_DIEBANDIT";	//Teï to dostaneš, bandito!
	addon_dirtypirate = "SVM_9_ADDON_DIRTYPIRATE";	//Nemìl jsi se zde ukazovat, piráte.
};
...
instance SVM_10(C_SVM)
{
	...
	Weather = "SVM_10_Weather";	//Zatracenı neèas!
	...
	SheepKillerMonster = "SVM_10_SheepKillerMonster";	//Ta obluda vradí naše ovce!
	...
	EnemyKilled = "SVM_10_EnemyKilled";	//Takovej hloupej bastard...
	...
	SheepAttackerDown = "SVM_10_SheepAttackerDown";	//Okamitì dej ty svoje umounìnı pracky pryè od našich ovcí!
	...
	Guards = "SVM_10_Guards";	//STRÁE!
	Help = "SVM_10_Help";	//Pomoc!
	GoodMonsterKill = "SVM_10_GoodMonsterKill";	//(volá) Jo! Takhle se na to musí!
	GoodKill = "SVM_10_GoodKill";	//(volá) To je to, co si ta svinì zaslouí!
	...
	LookingForTroubleAgain = "SVM_10_LookingForTroubleAgain";	//(agresivnì) Chceš další teèku do ksichtu?
	...
	OhMyGodItsAFight = "SVM_10_OhMyGodItsAFight";	//(vystrašenì) Boínku, boj!
	GoodVictory = "SVM_10_GoodVictory";	//(zlı smích) Dal jsi jim co proto!
	NotBad = "SVM_10_NotBad";	//(souhlasnì) To nebylo špatné.
	OhMyGodHesDown = "SVM_10_OhMyGodHesDown";	//(pro sebe) Mùj boe! Taková krutost...
	...
	sheepkiller_crime = "SVM_10_SHEEPKILLER_CRIME";	//Vradìní ovcí je u pøíliš! Ztra se!
	...
	mil_city_crime = "SVM_10_MIL_CITY_CRIME";	//Jak se nìkdo jako ty mohl dostat k mìstskım stráím? Lord Andre ti to ještì spoèítá!
	...
	Smalltalk07 = "SVM_10_Smalltalk07";	//... nemùu se z toho jen tak vyvlíknout...
	Smalltalk08 = "SVM_10_Smalltalk08";	//... nebudeš mi øíkat...
	Smalltalk09 = "SVM_10_Smalltalk09";	//... byl tam, udìlal to...
	Smalltalk10 = "SVM_10_Smalltalk10";	//... vìci, o kterıch ti mùu øíct...
	Smalltalk11 = "SVM_10_Smalltalk11";	//... na to se nemùeš spoléhat...
	...
	Smalltalk17 = "SVM_10_Smalltalk17";	//... vánì o tom mìl vìdìt víc...
	...
	Smalltalk26 = "SVM_10_Smalltalk26";	//... prostì potøebuje víc praxe...
	Smalltalk27 = "SVM_10_Smalltalk27";	//... co on ví o slubì...
	Smalltalk28 = "SVM_10_Smalltalk28";	//... Innos vymìøí spravedlivı trest...
	Smalltalk29 = "SVM_10_Smalltalk29";	//... cesta poctivosti je dlouhá a plná kamení...
	...
	NoLearnYoureBetter = "SVM_10_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_10_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_10_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_10_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_10_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_10_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_10_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_10_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_10_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_10_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_10_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_10_Aargh_1";	//Aargh
	Aargh_2 = "SVM_10_Aargh_2";	//Aargh
	Aargh_3 = "SVM_10_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_10_Addon_WrongArmor";	//Co to máš za šaty? To se k tobì nehodí. Nechej mì o samotì.
	addon_wrongarmor_sld = "SVM_10_ADDON_WRONGARMOR_SLD";	//Jestli k nám patøíš, mìl bys nosit naše šaty. Zmìò si na nì.
	addon_wrongarmor_mil = "SVM_10_ADDON_WRONGARMOR_MIL";	//Jestli jsi dostal královské brnìní, tak ho nos!
	addon_wrongarmor_kdf = "SVM_10_ADDON_WRONGARMOR_KDF";	//Jestli odmítáš šaty, odmítáš Innose. Jdi a mysli na to.
	addon_noarmor_bdt = "SVM_10_ADDON_ADDON_NOARMOR_BDT";	//Ty si nemùeš dovolit brnìní - proè bych s tebou mìl mluvit?
	addon_diebandit = "SVM_10_ADDON_DIEBANDIT";	//Banditskej mizero!
	addon_dirtypirate = "SVM_10_ADDON_DIRTYPIRATE";	//Pirátskej mizero!
};
...
instance SVM_11(C_SVM)
{
	...
	Weather = "SVM_11_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_11_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	StopMagic = "SVM_11_StopMagic";	//Nepøibliuj se ke mnì s tím magickım svinstvem!
	...
	sheepkiller_crime = "SVM_11_SHEEPKILLER_CRIME";	//(Takhle vradit naše ovce! Vypadni, vole!
	...
	mil_city_crime = "SVM_11_MIL_CITY_CRIME";	//Jsi ostudou mìstskıch stráí! Lord Andre tì ještì nauèí zpùsobùm!
	...
	Smalltalk01 = "SVM_11_Smalltalk01";	//... vánì si myslíš...
	Smalltalk02 = "SVM_11_Smalltalk02";	//... všechno je moné...
	...
	Smalltalk07 = "SVM_11_Smalltalk07";	//... drbalo se tam o všem moném...
	...
	Smalltalk29 = "SVM_11_Smalltalk29";	//... vdycky jsem konal ve jménu Innose...
	Smalltalk30 = "SVM_11_Smalltalk30";	//... nikdo se nesmí protivit vùli boí...
	...
	NoLearnYoureBetter = "SVM_11_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_11_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_11_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_11_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_11_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_11_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_11_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_11_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_11_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_11_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_11_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_11_Aargh_1";	//Aargh
	Aargh_2 = "SVM_11_Aargh_2";	//Aargh
	Aargh_3 = "SVM_11_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_11_Addon_WrongArmor";	//Co to máš za šaty? To se k tobì nehodí. Nechej mì bıt.
	addon_wrongarmor_sld = "SVM_11_ADDON_WRONGARMOR_SLD";	//Nos svou zbroj, kdy s tebou mluvím. Teï se ztra.
	addon_wrongarmor_mil = "SVM_11_ADDON_WRONGARMOR_MIL";	//Mìl bys nosit královské brnìní! Teï uhni!
	addon_wrongarmor_kdf = "SVM_11_ADDON_WRONGARMOR_KDF";	//Tvoje šaty nejsou pøimìøené k našemu øádu. Zmìò si je!
	addon_noarmor_bdt = "SVM_11_ADDON_ADDON_NOARMOR_BDT";	//Ty nemáš zbroj. Tak pro ni vyra!
...
instance SVM_12(C_SVM)
{
	...
	Weather = "SVM_12_Weather";	//Zatracenı neèas!
	...
	MonsterKilled = "SVM_12_MonsterKilled";	//Miluju tohle svinstvo!
	Addon_MonsterKilled = "SVM_12_Addon_MonsterKilled";	//Jde další monstrum!
	...
	SheepAttackerDown = "SVM_12_SheepAttackerDown";	//A u se k našim ovcím nepøibliuj!
	...
	NeverHitMeAgain = "SVM_12_NeverHitMeAgain";	//Neopovauj se na mì znovu zaútoèit!
	...
	OhMyGodItsAFight = "SVM_12_OhMyGodItsAFight";	//(vystrašenì) Ó, mùj boe...
	...
	abs_farm = "SVM_12_ABS_FARM";	//Tak ses setkal s Leem a urovnal tu záleitost.
	abs_good = "SVM_12_ABS_GOOD";	//Dobrá.
	sheepkiller_crime = "SVM_12_SHEEPKILLER_CRIME";	//Ty vradíš ovce? Pøedpokládám, e se ti nepodaøilo najít nikoho bezbrannìjšího?
	...
	mil_city_crime = "SVM_12_MIL_CITY_CRIME";	//Vánì se chceš stát èlenem mìstskıch stráí? Lord Andre tì v tom nehodlá podpoøit!
	city_crime = "SVM_12_CITY_CRIME";	//Zajdi za lordem Andrem, dokud mùeš.
	mona_crime = "SVM_12_MONA_CRIME";	//Zajdi za otcem Parlanem. Pomùe ti odèinit tvé høíchy!
	...
	Smalltalk07 = "SVM_12_Smalltalk07";	//... nemùu se z toho jen tak vyvlíknout...
	Smalltalk08 = "SVM_12_Smalltalk08";	//... nebudeš mi øíkat...
	Smalltalk09 = "SVM_12_Smalltalk09";	//... byl tam, udìlal to...
	Smalltalk10 = "SVM_12_Smalltalk10";	//... vìci, o kterıch ti mùu øíct...
	Smalltalk11 = "SVM_12_Smalltalk11";	//... na to se nemùeš spoléhat...
	...
	Smalltalk26 = "SVM_12_Smalltalk26";	//... prostì potøebuje víc praxe...
	Smalltalk27 = "SVM_12_Smalltalk27";	//... co on ví o slubì...
	Smalltalk28 = "SVM_12_Smalltalk28";	//... Innos vymìøí spravedlivı trest...
	Smalltalk29 = "SVM_12_Smalltalk29";	//... cesta poctivosti je dlouhá a plná kamení...
	...
	NoLearnYoureBetter = "SVM_12_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_12_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_12_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_12_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_12_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_12_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_12_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_12_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_12_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_12_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_12_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_12_Aargh_1";	//Aargh
	Aargh_2 = "SVM_12_Aargh_2";	//Aargh
	Aargh_3 = "SVM_12_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_12_Addon_WrongArmor";	//Tvoje šaty se k tobì jednoduše nehodí. Zmìò si je.
	addon_wrongarmor_sld = "SVM_12_ADDON_WRONGARMOR_SLD";	//Pokud chceš se mnou mluvit, nos svou zbroj.
	addon_wrongarmor_mil = "SVM_12_ADDON_WRONGARMOR_MIL";	//Vojáci nosí královské zbroje. NIC JINÉHO! Proto si ji zmìò.
	addon_wrongarmor_kdf = "SVM_12_ADDON_WRONGARMOR_KDF";	//Tvoje šaty se prostì nehodí k našemu øádu. Zmìò si je!
	addon_noarmor_bdt = "SVM_12_ADDON_ADDON_NOARMOR_BDT";	//Nemùeš si dovolit zbroj. Se slabochy nemluvím.
	addon_diebandit = "SVM_12_ADDON_DIEBANDIT";	//Já tì dostanu, bandito!
	addon_dirtypirate = "SVM_12_ADDON_DIRTYPIRATE";	//Já tì dostanu, piráte!
};
...
instance SVM_13(C_SVM)
{
	...
	Weather = "SVM_13_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_13_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	EnemyKilled = "SVM_13_EnemyKilled";	//Zaslouil sis to, nièemo!
	...
	RunCoward = "SVM_13_RunCoward";	//(køièí) Jo! Utíkej, jak nejrychleji mùeš!
	...
	ISaidStopMagic = "SVM_13_ISaidStopMagic";	//Chceš napráskat? Okamitì s tím pøestaò!!!
	...
	sheepkiller_crime = "SVM_13_SHEEPKILLER_CRIME";	//Takhle vradit naše ovce!
	...
	mil_city_crime = "SVM_13_MIL_CITY_CRIME";	//Jsi ostudou mìstskıch stráí! Poèkej, a se o tom dozví lord Andre!
	...
	toughguy_attackwon = "SVM_13_TOUGHGUY_ATTACKWON";	//U(arogantnì) Mám dojem, e u ti musí bıt jasné, kdo je tady ten silnìjší... Co chceš?
	...
	Smalltalk07 = "SVM_13_Smalltalk07";	//... nemùu se z toho jen tak vyvlíknout...
	Smalltalk08 = "SVM_13_Smalltalk08";	//... nebudeš mi øíkat...
	Smalltalk09 = "SVM_13_Smalltalk09";	//... byl tam, udìlal to...
	Smalltalk10 = "SVM_13_Smalltalk10";	//... vìci, o kterıch ti mùu øíct...
	Smalltalk11 = "SVM_13_Smalltalk11";	//... na to se nemùeš spoléhat...
	...
	Smalltalk17 = "SVM_13_Smalltalk17";	//... vánì o tom mìl vìdìt víc...
	...
	Smalltalk26 = "SVM_13_Smalltalk26";	//... prostì potøebuje víc praxe...
	Smalltalk27 = "SVM_13_Smalltalk27";	//... co on ví o slubì...
	Smalltalk28 = "SVM_13_Smalltalk28";	//... Innos vymìøí spravedlivı trest...
	Smalltalk29 = "SVM_13_Smalltalk29";	//... cesta poctivosti je dlouhá a plná kamení...
	...
	NoLearnYoureBetter = "SVM_13_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_13_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_13_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_13_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_13_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_13_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_13_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_13_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_13_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_13_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_13_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_13_Aargh_1";	//Aargh
	Aargh_2 = "SVM_13_Aargh_2";	//Aargh
	Aargh_3 = "SVM_13_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_13_Addon_WrongArmor";	//Co to máš za šaty? To se k tobì nehodí. Nechej mì o samotì!
	addon_wrongarmor_sld = "SVM_13_ADDON_WRONGARMOR_SLD";	//Ty nenosíš svou zbroj, jdi a dostaò ji.
	addon_wrongarmor_mil = "SVM_13_ADDON_WRONGARMOR_MIL";	//Mìl by jsi bıt pyšnı nosit královské brnìní a ne pobíhat v tìchto hadrech. Teï jdi!
	addon_wrongarmor_kdf = "SVM_13_ADDON_WRONGARMOR_KDF";	//Proè nenosíš zbroj našeho øádu? Jdi a mysli na to.
	addon_noarmor_bdt = "SVM_13_ADDON_ADDON_NOARMOR_BDT";	//Dokonce nemáš zbroj. Vyra pro ni!
	addon_diebandit = "SVM_13_ADDON_DIEBANDIT";	//Špinavı bandito!
	addon_dirtypirate = "SVM_13_ADDON_DIRTYPIRATE";	//Zatracenı piráte!
};
...
instance SVM_14(C_SVM)
{
	...
	Weather = "SVM_14_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_14_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	StopMagic = "SVM_14_StopMagic";	//Nepøibliuj se ke mnì s tím magickım svinstvem!
	...
	sheepkiller_crime = "SVM_14_SHEEPKILLER_CRIME";	//Takhle vradit naše ovce! Vypadni, vole!
	...
	mil_city_crime = "SVM_14_MIL_CITY_CRIME";	//Jsi ostudou mìstskıch stráí! Lord Andre tì ještì nauèí zpùsobùm!
	...
	Smalltalk04 = "SVM_14_Smalltalk04";	//... stìí vím, komu vìøit...
	...
	Smalltalk13 = "SVM_14_Smalltalk13";	//... vánì si nezaslouil, aby...
	...
	Smalltalk25 = "SVM_14_Smalltalk25";	//... bìel, jako by mu byl v patách samotnı Beliar...
	...
	Smalltalk29 = "SVM_14_Smalltalk29";	//... protoe je to vùle Innosova...
	...
	NoLearnYoureBetter = "SVM_14_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_14_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_14_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_14_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_14_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_14_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_14_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_14_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_14_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_14_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_14_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_14_Aargh_1";	//Aargh
	Aargh_2 = "SVM_14_Aargh_2";	//Aargh
	Aargh_3 = "SVM_14_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_14_Addon_WrongArmor";	//To šatstvo se k tobì nehodí. Jistì nìco skráváš. Nechej mì na pokoji.
	addon_wrongarmor_sld = "SVM_14_ADDON_WRONGARMOR_SLD";	//Jestli chceš se mnou mluvit, musíš nosit naší zbroj.
	addon_wrongarmor_mil = "SVM_14_ADDON_WRONGARMOR_MIL";	//Buï pyšnı na armádu a nepobíhej v tìchto hadrech. Teï si zmìò šaty!
	addon_wrongarmor_kdf = "SVM_14_ADDON_WRONGARMOR_KDF";	//Tvé šaty nejsou vhodné k našemu øádu. Zmìò si je!
	addon_noarmor_bdt = "SVM_14_ADDON_ADDON_NOARMOR_BDT";	//Dokonce nemáš zbroj, tak vyra na cestu!
	addon_diebandit = "SVM_14_ADDON_DIEBANDIT";	//Zemøi, bandito!
	addon_dirtypirate = "SVM_14_ADDON_DIRTYPIRATE";	//Zemøi, piráte!
};
...
instance SVM_15(C_SVM)
{
	...
	NoMorePicks = "SVM_15_NoMorePicks";	//ádné další šperháky...
	...
	picklockorkeymissing = "SVM_15_PICKLOCKORKEYMISSING";	//Hm... Nemám ani klíè, ani šperhák.
	keymissing = "SVM_15_KEYMISSING";	//Tohle nemùu bez správného klíèe nikdy odemknout!
	picklockmissing = "SVM_15_PICKLOCKMISSING";	//Hodilo by se pár šperhákù!
	...
	scopensirdorathbook = "SVM_15_SCOPENSIRDORATHBOOK";	//HXARAK BENDARDO! Ach. Kniha se otevøela. Uvnitø je schovanı dopis a klíè.
	scopenslastdoor = "SVM_15_SCOPENSLASTDOOR";	//KHADOSH EMEM KADAR! Otevøi se!
	trade_1 = "SVM_15_Addon_TRADE_1";	//Pojïme obchodovat.
	trade_2 = "SVM_15_Addon_TRADE_2";	//Uka mi svoje zboí.
	trade_3 = "SVM_15_Addon_TRADE_3";	//Uka co máš.
	verstehe = "SVM_15_Addon_VERSTEHE";	//Vidím.
	foundtreasure = "SVM_15_Addon_FOUNDTREASURE";	//Och. Doufám, našel jsem nìco.
	cantunderstandthis = "SVM_15_Addon_CANTUNDERSTANDTHIS";	//Nerozumím...
	cantreadthis = "SVM_15_Addon_CANTREADTHIS";	//To neumím èíst!
	...
	cough = "SVM_15_Addon_COUGH";	//(kašle) Óó chlape, brrr!
	hui = "SVM_15_Addon_HUI";	//Wheeee!
	attentat_addon_description = "SVM_15_ATTENTAT_ADDON_DESCRIPTION";	//Co víš o pokusu o vradu Estebana?
	attentat_addon_description2 = "SVM_15_ATTENTAT_ADDON_DESCRIPTION2";	//O pokusu o vradu na Estebana ...
	attentat_addon_pro = "SVM_15_ATTENTAT_ADDON_PRO";	//Chci zabít tyto zrádce.
	attentat_addon_contra = "SVM_15_ATTENTAT_ADDON_CONTRA";	//Hledám tyto chlapy k jednání proti Estebanovi.
	mine_addon_description = "SVM_15_MINE_ADDON_DESCRIPTION";	//Potøebují tì v dole.
	addon_summonancientghost = "SVM_15_ADDON_SUMMONANCIENTGHOST";	//Ighoriat Thorul. Zdá se mi to, Quarhodron, starı vùdce váleèné pevnosti!
	addon_ancientghost_notnear = "SVM_15_ADDON_ANCIENTGHOST_NOTNEAR";	//Mmh ... nepracuje zde.
	addon_gold_description = "SVM_15_ADDON_GOLD_DESCRIPTION";	//Co potøebuji vìdìt o zlatém dolu?
	Addon_ThisLittleBastard = "SVM_15_Addon_ThisLittleBastard";	//Aha. Francisova úèetní kniha. Zdá se e si nechává hodnì zlatıch vloudit do své vlastní kapsy.
...
instance SVM_16(C_SVM)
{
	...
	Weather = "SVM_16_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_16_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	ISaidStopMagic = "SVM_16_ISaidStopMagic";	//(Chceš do zubù? Okamitì s tím pøestaò!!!
	...
	sheepkiller_crime = "SVM_16_SHEEPKILLER_CRIME";	//Nemùeš prostì takhle zabíjet naše ovce! Padej odsud!
	...
	mil_city_crime = "SVM_16_MIL_CITY_CRIME";	//Tvé chování je ostudou mìstskıch stráí! Lord Andre po tobì bude chtít vysvìtlení!
	city_crime = "SVM_16_CITY_CRIME";	//Lord Andre se dozví o tom, cos provedl!
	mona_crime = "SVM_16_MONA_CRIME";	//Zachoval sis špatnì. Jdi za otcem Parlanem a kaj se.
	...
	Smalltalk01 = "SVM_16_Smalltalk01";	//... vánì? Zajímavé...
	Smalltalk02 = "SVM_16_Smalltalk02";	//... tomu nevìøím...
	Smalltalk03 = "SVM_16_Smalltalk03";	//... tak to mùj manel nemyslel...
	...
	Smalltalk08 = "SVM_16_Smalltalk08";	//... jsou to teï tìké èasy...
	...
	Smalltalk13 = "SVM_16_Smalltalk13";	//... teï je to bìné, nebo ne...
	Smalltalk14 = "SVM_16_Smalltalk14";	//... sám nedosáhne nièeho...
	Smalltalk15 = "SVM_16_Smalltalk15";	//... udìlal by líp, kdyby drel zobák...
	Smalltalk16 = "SVM_16_Smalltalk16";	//... a pracuje celé dny, pøíliš...
	Smalltalk17 = "SVM_16_Smalltalk17";	//... nemùu se starat o všechno pro kadého...
	...
	Smalltalk24 = "SVM_16_Smalltalk24";	//... to jsem vdycky øíkal...
	...
	NoLearnYoureBetter = "SVM_16_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_16_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_16_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_16_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_16_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_16_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_16_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_16_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_16_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_16_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
	Dead = "SVM_16_Dead";	//Aaaaaargh!
	Aargh_1 = "SVM_16_Aargh_1";	//Aargh
	Aargh_2 = "SVM_16_Aargh_2";	//Aargh
	Aargh_3 = "SVM_16_Aargh_3";	//Aargh
	addon_wrongarmor = "SVM_16_Addon_WrongArmor";	//Oblékej se poøádnì. Nechci aby mì vidìli s tebou, kdy jsi takto obleèenı.
...
instance SVM_17(C_SVM)
{
	...
	Weather = "SVM_17_Weather";	//Zatracenı neèas!
	...
	SheepKiller = "SVM_17_SheepKiller";	//Ten kıbl hnusu vradí naše ovce!
	...
	ISaidStopMagic = "SVM_17_ISaidStopMagic";	//(Chceš do zubù? Okamitì s tím pøestaò!!!
	...
	sheepkiller_crime = "SVM_17_SHEEPKILLER_CRIME";	//Nemùeš prostì takhle zabíjet naše ovce! Padej odsud!
	...
	mil_city_crime = "SVM_17_MIL_CITY_CRIME";	//Tvé chování je ostudou mìstskıch stráí! Lord Andre po tobì bude chtít vysvìtlení!
	city_crime = "SVM_17_CITY_CRIME";	//Lord Andre se dozví o tom, cos provedl!
	mona_crime = "SVM_17_MONA_CRIME";	//Zachoval sis špatnì. Jdi za otcem Parlanem a kaj se.
	...
	Smalltalk01 = "SVM_17_Smalltalk01";	//... vánì? Zajímavé...
	Smalltalk02 = "SVM_17_Smalltalk02";	//... tomu nevìøím...
	Smalltalk03 = "SVM_17_Smalltalk03";	//... tak to mùj manel nemyslel...
	Smalltalk04 = "SVM_17_Smalltalk04";	//... jdi pryè, neøíkej mi, e...
	...
	Smalltalk08 = "SVM_17_Smalltalk08";	//... jsou to teï tìké èasy...
	...
	Smalltalk13 = "SVM_17_Smalltalk13";	//... teï je to bìné, nebo ne...
	Smalltalk14 = "SVM_17_Smalltalk14";	//... sám nedosáhne nièeho...
	Smalltalk15 = "SVM_17_Smalltalk15";	//... udìlal by líp, kdyby drel zobák...
	Smalltalk16 = "SVM_17_Smalltalk16";	//... a pracuje celé dny, pøíliš...
	Smalltalk17 = "SVM_17_Smalltalk17";	//... nemùu se starat o všechno pro kadého...
	...
	Smalltalk24 = "SVM_17_Smalltalk24";	//... to jsem vdycky øíkal...
	...
	NoLearnYoureBetter = "SVM_17_NoLearnYoureBetter";	//Není nic, co bych tì ještì mohl nauèit. ák pøekonal svého uèitele.
	...
	markt = "SVM_17_MARKT";	//Právì jsi na trišti.
	...
	unterstadt_2_oberstadt = "SVM_17_UNTERSTADT_2_OBERSTADT";	//Schodištì vede od jiní mìstské brány ke vnitøní mìstské bránì. Tam zaèíná horní èást mìsta.
	unterstadt_2_tempel = "SVM_17_UNTERSTADT_2_TEMPEL";	//Podchodem se mùeš dostat od kovárny na chrámové námìstí.
	...
	tempel_2_markt = "SVM_17_TEMPEL_2_MARKT";	//A budeš pøed chrámem, pokraèuj doleva a podél hradeb. Tak se dostaneš na trištì.
	...
	markt_2_tempel = "SVM_17_MARKT_2_TEMPEL";	//Pokud pùjdeš od trištì podél vysokıch hradeb, dostaneš se ke chrámu.
	...
	galgen_2_markt = "SVM_17_GALGEN_2_MARKT";	//A mineš velká kasárna, dostaneš se na trištì.
	galgen_2_kaserne = "SVM_17_GALGEN_2_KASERNE";	//Ta obrovská budova jsou kasárna. Staèí vyjít nahoru po schodech.
	kaserne_2_markt = "SVM_17_KASERNE_2_MARKT";	//Staèí sejít po schodech nalevo od hlavního vchodu a dostaneš se na trištì.
	...
	hafen_2_unterstadt = "SVM_17_HAFEN_2_UNTERSTADT";	//Pokud se dáš pøístavní ulicí od pobøení hráze, dostaneš se do dolní èásti mìsta.
