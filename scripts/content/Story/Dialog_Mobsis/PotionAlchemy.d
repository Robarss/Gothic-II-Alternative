...
instance PC_COOKWIN(C_Info)
{
	...
	permanent = TRUE;
	description = "Víno poznání(5x Hrozen a 1 Ohnivý koøen)";
};


func int pc_cookwin_condition()
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_PotionAlchemy) && (PLAYER_TALENT_ALCHEMY[POTION_Mana_04] == TRUE) && (SpecialStart == TRUE))
	{
		return TRUE;
	};
};
