...
func void ta_stand_halberd2(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_stand_halberd2,waypoint);
};
...
func void ta_buchschreiben(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_buchschreiben,waypoint);
};

func void ta_malen(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_malen,waypoint);
};

func void ta_woodchoppin(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_woodchoppin,waypoint);
};

func void ta_angeln(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_angeln,waypoint);
};
...
func void ta_smoke_pipe(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_smoke_pipe,waypoint);
};
...
func void ta_stand_summon(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_summon_raven,waypoint);
};
