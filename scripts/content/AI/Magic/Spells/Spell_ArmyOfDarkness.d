...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_COST_SCROLL_ARMYOFDARKNESS))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_ArmyOfDarkness(var int spellLevel)
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_COST_SCROLL_ARMYOFDARKNESS;
	}
	else
	{
