...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_COST_SCROLL_SUMMONGOLEM))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_SummonGolem()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_COST_SCROLL_SUMMONGOLEM;
	}
	else
	{
