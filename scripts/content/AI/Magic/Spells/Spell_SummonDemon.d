...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_COST_SCROLL_SUMMONDEMON))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_SummonDemon()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_COST_SCROLL_SUMMONDEMON;
	}
	else
	{
