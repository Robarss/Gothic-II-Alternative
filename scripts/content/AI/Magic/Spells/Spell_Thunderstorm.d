...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_COST_SCROLL_THUNDERSTORM))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Thunderstorm()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_COST_SCROLL_THUNDERSTORM;
	}
	else
	{
