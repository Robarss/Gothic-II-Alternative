...
const string MOB_SIT = "LAVICE,ŽIDLE,ZEMÌ,TRÙN";
const string MOB_LIE = "POSTEL,LOŽE,LÙŽKO";
const string MOB_CLIMB = "LÉZT,STOUPAT,ŠPLHAT";
const string MOB_NOTINTERRUPTABLE = "DVEØE,PÁKA,TLAÈÍTKO,SPÍNAÈ,KOLO,TRUHLICE,TRUHLA,BYLINA,SOCHA,PÁNEV,KOUØ,INNOS";
