...
instance PC_TORCH(C_Info)
{
	...
	permanent = 1;
	description = "Pochodeò (1x Døevo ze stromu, 1x Pryskyøice)";
};
...
func void pc_torch_info()
{
	if((Npc_HasItems(hero,itmi_woodbasic) >= 1) && (Npc_HasItems(hero,ItMi_Pitch) >= 1))
	{
		...
		PrintScreen("Vyrobil jsi: Pochodeò!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
...
instance PC_PICKLOC(C_Info)
{
	...
	permanent = 1;
	description = "Paklíè (1x Døevo ze stromu, 1x Surová ocel)";
};
...
func void pc_pickloc_info()
{
	if((Npc_HasItems(hero,itmi_woodbasic) >= 1) && (Npc_HasItems(hero,ItMiSwordraw) >= 1))
	{
		...
		PrintScreen("Vyrobil jsi: Paklíèe!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_ARROWMAKER(C_Info)
{
	...
	permanent = 1;
	description = "Šíp (1x Døevo na výrobu, 1x Surová ocel)";
};
...
func void pc_arrowmaker_info()
{
	if((Npc_HasItems(hero,itmi_woodmaker01) >= 1) && (Npc_HasItems(hero,ItMiSwordraw) >= 1))
	{
		...
		PrintScreen("Vyrobil jsi: Šípy!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_ARROWMAKERFIRE(C_Info)
{
	...
	permanent = 1;
	description = "Ohnivé šípy (1x Døevo na výrobu, 1x Surová ocel 1x Pryskyøice)";
};
...
func void pc_arrowmakerfire_info()
{
	if((Npc_HasItems(hero,itmi_woodmaker01) >= 1) && (Npc_HasItems(hero,ItMiSwordraw) >= 1) && (Npc_HasItems(hero,ItMi_Pitch) >= 1))
	{
		...
		PrintScreen("Vyrobil jsi: Ohnivé šípy!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_ARROWMAKERMAGIC(C_Info)
{
	...
	permanent = 1;
	description = "Magické šípy (1x Døevo na výrobu, 1x Surová ocel 1x Magický nugget)";
};
...
func void pc_arrowmakermagic_info()
{
	if((Npc_HasItems(hero,itmi_woodmaker01) >= 1) && (Npc_HasItems(hero,ItMiSwordraw) >= 1) && (Npc_HasItems(hero,ItMi_Nugget) >= 1))
	{
		...
		PrintScreen("Vyrobil jsi: Magické šípy!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_BOLTMAKER(C_Info)
{
	...
	permanent = 1;
	description = "Støela (1x Døevo na výrobu, 1x Surová ocel)";
};
...
func void pc_boltmaker_info()
{
	if((Npc_HasItems(hero,itmi_woodmaker01) >= 1) && (Npc_HasItems(hero,ItMiSwordraw) >= 1))
	{
		...
		PrintScreen("Vyrobil jsi: Støeli!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_BOLTMAKERMAGIC(C_Info)
{
	...
	permanent = 1;
	description = "Magická støela (1x Døevo na výrobu, 1x Surová ocel, 1x Magický nugget)";
};
...
func void pc_boltmakermagic_info()
{
	if((Npc_HasItems(hero,itmi_woodmaker01) >= 1) && (Npc_HasItems(hero,ItMiSwordraw) >= 1) && (Npc_HasItems(hero,ItMi_Nugget) >= 1))
	{
		...
		PrintScreen("Vyrobil jsi: Magické støeli!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_WOODMAK(C_Info)
{
	...
	permanent = 1;
	description = "Døevo na výrobu (1x Døevo ze stromu)";
};
...
func void pc_woodmak_info()
{
	if(Npc_HasItems(hero,itmi_woodbasic) >= 1)
	{
		...
		PrintScreen("Vyrobil jsi: Døevo na výrobu!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_LIANMAKER(C_Info)
{
	...
	permanent = 1;
	description = "Tìtiva (1x Døevo na výrobu)";
};
...
func void pc_lianmaker_info()
{
	if(Npc_HasItems(hero,itmi_woodmaker01) >= 1)
	{
		...
		PrintScreen("Vyrobil jsi: Tìtivu!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nemáš potøebný material!",-1,-1,"font_old_20_white.tga",1);
