...
instance ITWR_TRAKTAT1(C_Item)
{
	...
	scemeName = "MAPSEALED";
	description = name;
	text[0] = "Požadavky: 35% boj s jednoruèními zbranìmi, cena 5 LP";
...
func void use_traktat1()
{
	...
	{
		PrintScreen("Nejsem pøipraven!",-1,-1,FONT_Screen,3);
		CreateInvItems(hero,itwr_traktat1,1);
	};
};
...
instance ITWR_TRAKTAT2(C_Item)
{
	...
	scemeName = "MAPSEALED";
	description = name;
	text[0] = "Požadavky: 65% boj s jednoruèními zbranìmi, cena 10 LP";
...
func void use_traktat2()
{
	if((SCATTY_TEACH_PERM2 == FALSE) && (SCATTY_TEACH_PERM1 == TRUE) && (hero.lp >= 10) && (hero.aivar[REAL_TALENT_1H] >= 65))
	{
		...
		B_TeachThiefTalent(other,self,NPC_TALENT_SHIELDD);
		PrintScreen("Nauèil ses lépe bojovat se štítem",-1,-1,FONT_Screen,3);
...
instance ITWR_TRAKTAT3(C_Item)
{
	...
	scemeName = "MAPSEALED";
	description = name;
	text[0] = "Požadavky: 90% boj s jednoruèními zbranìmi, cena 15 LP";
	text[2] = "Umožní lépe bojovat se štítem.";
...
func void use_traktat3()
{
	if((SCATTY_TEACH_PERM3 == FALSE) && (SCATTY_TEACH_PERM2 == TRUE) && (SCATTY_TEACH_PERM1 == TRUE) && (hero.lp >= 15) && (hero.aivar[REAL_TALENT_1H] >= 90))
	{
		...
		AI_UnequipWeapons(hero);
		B_TeachThiefTalent(other,self,NPC_TALENT_SHIELDD);
		PrintScreen("Nauèil ses mistrovsky bojovat se štítem",-1,-1,FONT_Screen,3);
...
instance IT_2X2(C_Item)
{
	...
	on_state[0] = use_2x22;
	scemeName = "MAP";
	description = "Jižanské umìní dvou zbraní";
...
func void use_2x22()
{
	...
	Doc_PrintLines(nDocID,0,"Jižanské umìní dvou zbraní");
	Doc_SetFont(nDocID,0,FONT_Book);
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"K pochopení tohoto umìní musí uživatel znát Jižanské umìní obrany a být naprostý MISTR v jednoruèními a obouruèními zbranìmi.");
...
func void equip_twoh2()
{
	...
	{
		AI_UnequipWeapons(hero);
		PrintScreen("Neumím používat dvì zbranì!",-1,-1,FONT_Screen,3);
	};
};
