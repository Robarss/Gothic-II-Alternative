...
func void pc_fishing_n_info()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(he))
	{
		...
		if(anzahl == 0)
		{
			PrintScreen("Neulovil jsem nic!",-1,10,"font_old_20_white.tga",1);
		};
		if(anzahl == 0)
		{
			PrintScreen("",-1,30,"font_old_20_white.tga",1);
		};
		if(anzahl == 0)
		{
			PrintScreen("",-1,30,"font_old_20_white.tga",1);
		...
		if(anzahl == 1)
		{
			PrintScreen("Ulovil jsem rybu!",-1,30,"font_old_20_white.tga",1);
		};
	};
};
