...
{
	name = "Opotøebovaný paladinský štít";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SHIELD;
	material = MAT_METAL;
	value = 900;
...
{
	name = "Starý okovaný rytíøský štít";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SHIELD;
	material = MAT_METAL;
	value = 300;
...
{
	name = "Vylepšený trojúhelníkový štít";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SHIELD;
	material = MAT_METAL;
	value = 350;
...
instance ITSH_11SHIELD(C_Item)
{
	...
	visual = "tarcza_lowcy2.3DS";
	description = name;
	text[0] = "Musel se znièit bìhem boje.";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
...
{
	name = "Prastarý Velký mìè váleèníkù";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_SWD;
	material = MAT_METAL;
