...
func void pc_fishsoup_info()
{
	if((Npc_HasItems(hero,ItFo_Fish) >= 1) && (Npc_HasItems(hero,ItFo_Fish) >= 1))
	{
		...
		PrintScreen("Uvaøil jsi: Rybí polévku!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
...
func void pc_cookhpi_info()
{
	if(Npc_HasItems(hero,ItPl_Forestberry) >= 20)
	{
		...
		PrintScreen("Uvaøil jsi: Kompot z lesních bobulí!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nedostatek ingrediencí!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_COOKHPII(C_Info)
{
	...
	permanent = 1;
	description = "Kompot z luèních bobulí (20x lesní bobule)";
};
...
func void pc_cookhpii_info()
{
	if(Npc_HasItems(hero,ItPl_Planeberry) >= 20)
	{
		...
		PrintScreen("Uvaøil jsi: Kompot z luèních bobulí!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nedostatek ingrediencí!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_COOKSTR(C_Info)
{
	...
	permanent = 1;
	description = "Specialní pokrm ze žravých štìnic (3x žravé štìnice, 20x boruvky, 1x draèí koøen)";
};
...
func void pc_cookstr_info()
{
	if((Npc_HasItems(hero,ItAt_Meatbugflesh) >= 3) && (Npc_HasItems(hero,ItPl_Blueplant) >= 20) && (Npc_HasItems(hero,ItPl_Strength_Herb_01) >= 1))
	{
		...
		PrintScreen("Uvaøil jsi: Specialní pokrm ze žravých štìnic!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nedostatek ingrediencí!",-1,-1,"font_old_20_white.tga",1);
...
instance PC_COOKDEX(C_Info)
{
	...
	permanent = 1;
	description = "Specialní polévka z ústøic (2x Maso ze škeble, 10x Chòapavèí býlí, 1x Gobliní bobule)";
};
...
func void pc_cookdex_info()
{
	if((Npc_HasItems(hero,ItFo_Addon_Shellflesh) >= 2) && (Npc_HasItems(hero,ItPl_Speed_Herb_01) >= 10) && (Npc_HasItems(hero,ItPl_Dex_Herb_01) >= 1))
	{
		...
		PrintScreen("Uvaøil jsi: Specialní polévka z ústøic!",-1,-1,"font_old_20_white.tga",1);
	}
	else
	{
		PrintScreen("Nedostatek ingrediencí!",-1,-1,"font_old_20_white.tga",1);
