...
{
	name = "Lovecká zbroj z trollí kùže";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 35;
	protection[PROT_BLUNT] = 35;
...
{
	name = "Stará obøadní zbroj královské stráže";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
...
{
	name = "Stará obøadní zbroj krále";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 85;
	protection[PROT_BLUNT] = 85;
...
{
	name = "Paladinská posvìcená zbroj";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
