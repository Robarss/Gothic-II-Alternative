...
instance ItAr_PAL_M(C_Item)
{
	...
	description = name;
	text[0] = "Paladin˘m regeneruje ûivot (1 bod za 5 sek.)";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
...
instance ItAr_PAl_H(C_Item)
{
	...
	description = name;
	text[0] = "Paladin˘m regeneruje ûivot (1 bod za 3 sek.)";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
...
instance ItAr_NOV_L(C_Item)
{
	...
	description = name;
	text[0] = "Regeneruje novicovy 1 manu za 10 sek.";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
...
instance ItAr_KDF_L(C_Item)
{
	...
	description = name;
	text[0] = "Regeneruje m·govy 1 manu za 3 sek.";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
...
instance ItAr_KDF_H(C_Item)
{
	...
	description = name;
	text[0] = "Regeneruje m·govy 1 manu za 1 sek.";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
...
instance ITAR_Xardas(C_Item)
{
	...
	description = name;
	text[0] = "Regeneruje m·govy 1 manu a ûivot za 1 sek.";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
