...
instance ITMI_WOODBASIC(C_Item)
{
	...
	text[3] = "";
	text[4] = "Možná z toho nìco vyrobím.";
	text[5] = NAME_Value;
	count[5] = value;
};
...
instance ITMI_WOODMAKER01(C_Item)
{
	...
	material = MAT_LEATHER;
	description = name;
	text[2] = "Pøipraveno na výrobu støelných zbraní a munice.";
	text[3] = "";
	text[4] = "";
	text[5] = NAME_Value;
	count[5] = value;
...
instance ITMI_WOODMAKER02(C_Item)
{
	...
	material = MAT_LEATHER;
	description = name;
	text[2] = "Pøipraveno na výrobu støelných zbraní,";
	text[3] = "";
	text[4] = "";
	text[5] = NAME_Value;
	count[5] = value;
