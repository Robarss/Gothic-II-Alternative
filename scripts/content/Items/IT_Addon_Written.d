...
instance ITWr_Addon_Health_04(C_Item)
{
	...
	scemeName = "MAP";
	description = "Èistý lektvar života";
...
instance ITWr_Addon_Mana_04(C_Item)
{
	...
	scemeName = "MAP";
	description = "Èistý lektvar many";
...
func void use_winerrezept()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(PLAYER_TALENT_ALCHEMY[POTION_Mana_03] == TRUE)
		{
			PLAYER_TALENT_ALCHEMY[POTION_Mana_04] = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_TalentAlchemy,"Na výrobu Vína poznání je potøeba 5x Hrozen a 1 Ohnivý koøen.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_SetFont(nDocID,0,FONT_Book);
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"K vytvoøení Vína poznání:");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Jsou potøebné tyto pøísady: 5x Hrozen a 1 Ohnivý koøen.");
	Doc_PrintLines(nDocID,0,"Smícháme podle receptu na výrobu lektvaru many.");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Tento lektvar mùže udìlat pouze alchymista, který umí pøipravit elixír many.");
...
func void UseLouRezept()
{
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Prvnì si vezmeš láhev vody a 2x tuøín a trávu z bažin.");
...
func void use_bow1()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSI == TRUE)
		{
			KNOWS_BOW1 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Mìsíc - 1x Døevo na výrobu, 1x Tìtiva, 2x priskyøice");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_SetFont(nDocID,0,FONT_Book);
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Výroba luku Mìsíc:");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 1x Døevo na výrobu, 1x Tìtiva, 2x priskyøice");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit ZÁKLADNÍ výrobu loveckých zbraní. ");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_Show(nDocID);
...
func void use_bow2()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSI == TRUE)
		{
			KNOWS_BOW2 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Vítr - 1x Døevo na výrobu, 1x Tìtiva, 2x zuby.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 1x Døevo na výrobu, 1x Tìtiva, 2x zuby");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit ZÁKLADNÍ výrobu loveckých zbraní. ");
...
func void use_bow3()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSII == TRUE)
		{
			KNOWS_BOW3 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Ultimatum - 2x Døevo na výrobu, 2x Tìtiva, 3x Perla.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 2x Døevo na výrobu, 2x Tìtiva, 3x Perla");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit POKROÈILOU výrobu loveckých zbraní. ");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_Show(nDocID);
...
func void use_bow4()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSII == TRUE)
		{
			KNOWS_BOW4 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Úsvit - 2x Døevo na výrobu, 2x Tìtiva, 1x Èerná perla.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 2x Døevo na výrobu, 2x Tìtiva, 1x Èerná perla");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit POKROÈILOU výrobu loveckých zbraní. ");
...
func void use_bow5()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSIII == TRUE)
		{
			KNOWS_BOW5 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Tichá smrt - 3x Døevo na výrobu, 3x Tìtiva, 1x Smaragd.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 3x Døevo na výrobu, 3x Tìtiva, 1x Smaragd");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit MISTROVSKOU výrobu loveckých zbraní. ");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_Show(nDocID);
...
func void use_bow6()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSIII == TRUE)
		{
			KNOWS_BOW6 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Soumrak - 3x Døevo na výrobu, 3x Tìtiva, 1x Rubín.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 3x Døevo na výrobu, 3x Tìtiva, 1x Rubín");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit MISTROVSKOU výrobu loveckých zbraní. ");
...
func void use_crossbow1()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSI == TRUE)
		{
			...
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Ochrana - 1x Døevo na výrobu, 1x Tìtiva, 2x Drápy.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 1x Døevo na výrobu, 1x Tìtiva, 2x Drápy");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit ZÁKLADNÍ výrobu loveckých zbraní. ");
...
func void use_crossbow2()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSII == TRUE)
		{
			...
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Záblesk - 2x Døevo na výrobu, 2x Tìtiva, 2x Èerná perla.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 2x Døevo na výrobu, 2x Tìtiva, 2x Èerná perla");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit POKROÈILOU výrobu loveckých zbraní. ");
...
func void use_crossbow3()
{
	...
	if(Npc_IsPlayer(self))
	{
		if(KNOWS_BOWSCROLLSIII == TRUE)
		{
			...
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_BOWHUNT,"Nièitel - 3x Døevo na výrobu, 3x Tìtiva, 2x Diamant.");
		};
	};
	nDocID = Doc_Create();
	Doc_SetPages(nDocID,1);
	...
	Doc_SetFont(nDocID,0,FONT_Book);
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Výroba kuše Nièitel:");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Material: 3x Døevo na výrobu, 3x Tìtiva, 2x Diamant");
	Doc_PrintLines(nDocID,0,"Na výrobnì støelných zbraní použijeme material a postupujem podle nákresu. ");
	Doc_PrintLines(nDocID,0,"Tìtiva a døevo na výrobu jde vyrobyt na truhlaøské dílnì");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"Je nutné se nauèit MISTROVSKOU výrobu loveckých zbraní. ");
