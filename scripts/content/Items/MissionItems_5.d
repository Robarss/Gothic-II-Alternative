...
instance ITWR_ARMORBLESS(C_Item)
{
	...
	description = name;
	text[0] = "Zajímavé, ale neumím to pøeèíst, možná bude vìdìt Pyrokar.";
	text[1] = "";
	text[5] = NAME_Value;
	count[5] = value;
};
...
instance ITWR_ARMORBLESS2(C_Item)
{
	...
	scemeName = "MAP";
	description = name;
	text[3] = "Pøeložená modlitba od Pyrokara";
	text[4] = "S tímto mohu posvìtit zbroj paladina.";
};
...
func void useitwr_armorbless2()
{
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0," Nezapomenout jakoukoli svìcenou vodu od Innose!");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_SetMargins(nDocID,-1,200,50,50,50,1);
