...
instance ITFO_COOKHPI(C_Item)
{
	...
	text[1] = NAME_Bonus_HP;
	count[1] = HP_COOKHPI;
	text[4] = "Kompot z lesnÌch bobulÌ";
	text[5] = NAME_Value;
...
instance ITFO_COOKHPII(C_Item)
{
	...
	text[1] = NAME_Bonus_HP;
	count[1] = HP_COOKHPII;
	text[4] = "Kompot z luËnÌch bobulÌ";
	text[5] = NAME_Value;
...
{
	name = "SpecialnÌ pokrm ze ûrav˝ch ötÏnic";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI;
	value = VALUE_STR;
...
instance ITFO_COOKWIN(C_Item)
{
	...
	text[4] = "Tohle vÌno je opravdu speci·lnÌ";
	text[5] = NAME_Value;
...
{
	name = "SpecialnÌ polÈvka z ˙st¯ic";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI;
	value = VALUE_DEX;
